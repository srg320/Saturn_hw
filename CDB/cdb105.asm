...
000626 C00A     	MOV.B   	R0,@(#00A,GBR)	;SCR1 = 0x00;
000628 000B     	RTS     				;
00062A 0009     	NOP     				;
...
L0006F8:							;
0006F8 6016     	MOV.L   	@R1+,R0		;do {
0006FA 330C     	ADD     	R0,R3			;  crc += *ptr; 
0006FC 3122     	CMP/HS 	R2,R1			;  ptr++;
...
000716 C117     	MOV.W   	R0,@(#02E,GBR)	;SH.BSC.RTCSR = 0xA508;
...
L00072E:							;dram_check()
00072E ED00     	MOV     	#00,R13		;u32 check = 0x00000000;
...
000750 2D0B     	OR      	R0,R13		;  if (patt != res) check |= patt;
L000752:
...
000784 2D3B     	OR      	R3,R13		;  check |= 0x00010000;
L000786:
...
0007D0 2D0B     	OR      	R0,R13		;check |= 0x00020000;
...
0007F4 8114     	MOV.W   	R0,@(#08,R1)	;YGR.CDMSKL = 0x0000;
0007F6 8115     	MOV.W   	R0,@(#0A,R1)	;YGR.CDMSKU = 0x0000;
0007F8 8112     	MOV.W   	R0,@(#04,R1)	;YGR.CDIRQL = 0x0000;
0007FA 8113     	MOV.W   	R0,@(#06,R1)	;YGR.CDIRQU = 0x0000;
...
000810 8114     	MOV.W   	R0,@(#08,R1)	;YGR.CDMSKL = 0x0003;
000812 8514     	MOV.W   	@(#08,R1),R0	;
000814 2029     	AND     	R2,R0			;
000816 3200     	CMP/EQ 	R0,R2			;
000818 8B14     	BF      	L000844		;if (YGR.CDMSKL & 0x0003 != 0x0003) goto L000844;
00081A E000     	MOV     	#00,R0		;
00081C 8114     	MOV.W   	R0,@(#08,R1)	;YGR.CDMSKL = 0x0000;
00081E 8514     	MOV.W   	@(#08,R1),R0	;
000820 2029     	AND     	R2,R0			;
000822 2008     	TST     	R0,R0			;
000824 8B0E     	BF      	L000844		;if (YGR.CDMSKL & 0x0003 != 0x0000) goto L000844;
...
000842 ED00     	MOV     	#00,R13		;check = 0x00000000
L000844:
000844 ED04     	MOV     	#04,R13		;check = 0x00000004
L000846:
...
0008B4 2D0B     	OR      	R0,R13		;check |= 0x00000008;
L0008B6:
...
0009DE 80AA     	MOV.B   	R0,@(#0A,R10)	;SH1.SCI.SCR1 |= 0x20;
0009E0 DD2B     	MOV.L   	@(#0AC,PC),R13	;
0009E2 60D2     	MOV.L   	@R13,R0		;
0009E4 80AB     	MOV.B   	R0,@(#0B,R10)	;SH1.SCI.TDR1 = ((u8*)rom_crc)[0];
0009E6 84AC     	MOV.B   	@(#0C,R10),R0	;
0009E8 C97F     	AND     	#7F,R0		;
0009EA 80AC     	MOV.B   	R0,@(#0C,R10)	;SH1.SCI.SSR1 &= 0x7F;
...
000A2C 80AB     	MOV.B   	R0,@(#0B,R10)	;SH1.SCI.TDR1 = temp;
000A2E 84AC     	MOV.B   	@(#0C,R10),R0	;
000A30 C97F     	AND     	#7F,R0		;
000A32 80AC     	MOV.B   	R0,@(#0C,R10)	;SH1.SCI.SSR1 &= 0x7F;
...
000A50 80A8     	MOV.B   	R0,@(#08,R10)	;SH1.SCI.SMR1 = 0x00;
000A52 E030     	MOV     	#30,R0		;
000A54 80AA     	MOV.B   	R0,@(#0A,R10)	;SH1.SCI.SCR1 = 0x30;
000A56 E041     	MOV     	#41,R0		;
000A58 80A9     	MOV.B   	R0,@(#09,R10)	;SH1.SCI.BRR1 = 0x41;
000A5A 84AC     	MOV.B   	@(#0C,R10),R0	;SH1.SCI.SSR1;
000A5C E000     	MOV     	#00,R0		;
000A5E 80AC     	MOV.B   	R0,@(#0C,R10)	;SH1.SCI.SSR1 = 0x00;
000A60 D110     	MOV.L   	@(#040,PC),R1	;
000A62 6010     	MOV.B   	@R1,R0		;
000A64 C9CF     	AND     	#CF,R0		;
000A66 CB20     	OR      	#20,R0		;
000A68 2100     	MOV.B   	R0,@R1		;SH1.SCI.RDR1 = (SH1.SCI.RDR1 & ~0x30) | 0x20;
000A6A E000     	MOV     	#00,R0		;
000A6C 2B02     	MOV.L   	R0,@R11		;rom_crc = 0x00000000;
000A6E B141     	BRS     	L000CF4		;L000CF4(0x3A,&rom_crc);
000A70 E03A     	MOV     	#3A,R0		;
L000A72:							;
000A72 B01B     	BRS     	L000AAC		;L000AAC(&rom_crc);
000A74 0009     	NOP     				;
...
000AB4 8929     	BT      	L000B0A		;if ((SH1.SCI.SSR1 & 0x40) == 0) goto L000B0A;
000AB6 C9BF     	AND     	#BF,R0		;
000AB8 6203     	MOV     	R0,R2			;
000ABA 84AD     	MOV.B   	@(#0D,R10),R0	;temp = SH1.SCI.RDR1;
000ABC 6103     	MOV     	R0,R1			;
000ABE 6023     	MOV     	R2,R0			;
000AC0 80AC     	MOV.B   	R0,@(#0C,R10)	;SH1.SCI.SSR1 &= 0xBF;
...
L000B06:
000B06 B0F5     	BRS     	L000CF4		;L000CF4(i,arg1);
...
000D4C DCEE     	MOV.L   	@(#3B8,PC),R12	;void* queue = &task_queue[0];
000D4E DDEF     	MOV.L   	@(#3BC,PC),R13	;
000D50 2AAA     	XOR     	R10,R10		;
L000D52:							;do {
000D52 2CA2     	MOV.L   	R10,@R12		;  *queue = 0x00000000;
000D54 7C04     	ADD     	#04,R12		;  queue++;
000D56 3CD2     	CMP/HS 	R13,R12		;
000D58 8BFB     	BF      	L000D52		;} while (ptr <= task_queue[11]);
000D5A D235     	MOV.L   	@(#0D4,PC),R2	;u8* num_ptr = task_num_tbl;
000D5C D335     	MOV.L   	@(#0D4,PC),R3	;
L000D5E:							;
000D5E 6024     	MOV.B   	@R2+,R0		;
000D60 610C     	EXTU.B   	R0,R1			;for (u8 n=0; n<13; n++)
000D62 B179     	BRS     	L001058		;  task_init(task_num_tbl[n]);
000D64 0009     	NOP     				;
000D66 3232     	CMP/HS 	R3,R2			;
000D68 8BF9     	BF      	L000D5E		;
...
000D78 064E     	MOV.L   	@(R0,R4),R6		;task_entry* entry = task_entry_tbl[task_num_tbl[0]];
000D7A 2562     	MOV.L   	R6,@R5		;task_queue[0] = entry;
L000D7C:							;
000D7C 6024     	MOV.B   	@R2+,R0		;for (u8 n=1; n<12; n++) {
000D7E 600C     	EXTU.B   	R0,R0			;
000D80 4008     	SHLL2   	R0			;
000D82 054E     	MOV.L   	@(R0,R4),R5		;  task_entry* next = task_entry_tbl[task_num_tbl[n]];
000D84 1654     	MOV.L   	R5,@(#10,R6)	;  entry->next = next;
000D86 6653     	MOV     	R5,R6			;  entry = next;
000D88 3232     	CMP/HS 	R3,R2			;
000D8A 8BF7     	BF      	L000D7C		;}
000D8C B18C     	BRS     	L0010A8		;entry = get_next_entry();
000D8E 0009     	NOP     				;
000D90 A1C2     	BRA     	L001118		;run_task(entry);
000D92 0009     	NOP     				;
...
000DEA 064E     	MOV.L   	@(R0,R4),R6		;task_entry* entry = task_entry_tbl[num];
000DEC 2562     	MOV.L   	R6,@R5		;task_queue[0] = entry;
L000DEE:
000DEE 6024     	MOV.B   	@R2+,R0		;do {
000DF0 600C     	EXTU.B   	R0,R0			;  num = *num_ptr; ptr++;
000DF2 4008     	SHLL2   	R0			;
000DF4 054E     	MOV.L   	@(R0,R4),R5		;  task_entry* next = task_entry_tbl[num];
000DF6 1654     	MOV.L   	R5,@(#10,R6)	;  entry->next = next;
000DF8 6653     	MOV     	R5,R6			;  entry = next;
...
L000E1A:							;for (int i=0; i<7; i++)
000E1A 23A2     	MOV.L   	R10,@R3		;  task_args_6[i] = 0x00000000;
000E1C 7304     	ADD     	#04,R3		;
000E1E 3322     	CMP/HS 	R2,R3			;
000E20 8BFB     	BF      	L000E1A		;
000E22 B141     	BRS     	L0010A8		;entry = get_next_entry();
000E24 0009     	NOP     				;
000E26 A177     	BRA     	L001118		;run_task(entry);
000E28 0009     	NOP     				;
000E2A 0009     	NOP     				;
000E2C 05FFFF00
000E30 00001340
...
TRAP_35:							;u32 switch_task()
000E80 E060     	MOV     	#60,R0		;
000E82 400E     	LDC     	R0,SR			;SH1.SR = 0x00000060;
000E84 D715     	MOV.L   	@(#054,PC),R7	;
000E86 6372     	MOV.L   	@R7,R3		;task_entry* entry = current_task_entry;
000E88 8437     	MOV.B   	@(#07,R3),R0	;
000E8A 2008     	TST     	R0,R0			;
000E8C 890B     	BT      	L000EA6		;if (entry->m07 != 0) {
000E8E 8430     	MOV.B   	@(#00,R3),R0	;  u8 tn = entry->header.tn;
000E90 4008     	SHLL2   	R0			;
000E92 D22B     	MOV.L   	@(#0AC,PC),R2	;
000E94 042E     	MOV.L   	@(R0,R2),R4		;  u32* queue_ptr = task_queue_tbl[tn];
000E96 8036     	MOV.B   	R0,@(#06,R3)	;  entry->m06 = tn*4;
L000E98:							;  while (1) {
000E98 6542     	MOV.L   	@R4,R5		;    u32* node = *queue_ptr;
000E9A 2558     	TST     	R5,R5			;
000E9C 8902     	BT      	L000EA4		;    if (node == 0) break;
...
L000EA6:							;}
000EA6 5235     	MOV.L   	@(#14,R3),R2	;task_entry* temp = entry->m14;
000EA8 2228     	TST     	R2,R2			;u32* next_entry;
000EAA 890F     	BT      	L000ECC		;
000EAC 8434     	MOV.B   	@(#04,R3),R0	;
000EAE 6120     	MOV.B   	@R2,R1		;
000EB0 3010     	CMP/EQ 	R1,R0			;
000EB2 8B02     	BF      	L000EBA		;if (temp != 0 && entry->m04 == temp->header.tn) {
000EB4 200A     	XOR     	R0,R0			;  entry->m04 = 0x00; 
000EB6 A005     	BRA     	L000EC4		;  entry->m14 = 0x00000000;
000EB8 8034     	MOV.B   	R0,@(#04,R3)	;  next_entry = temp;
L000EBA:							;}
000EBA 8435     	MOV.B   	@(#05,R3),R0	;
000EBC 3010     	CMP/EQ 	R1,R0			;
000EBE 8B05     	BF      	L000ECC		;else if (temp != 0 && entry->m05 == temp->header.tn) {
000EC0 200A     	XOR     	R0,R0			;
000EC2 8035     	MOV.B   	R0,@(#05,R3)	;  entry->m05 = 0x00;
L000EC4:							;  entry->m14 = 0x00000000;
000EC4 6D23     	MOV     	R2,R13		;  next_entry = temp;
000EC6 222A     	XOR     	R2,R2			;    
000EC8 A003     	BRA     	L000ED2		;
000ECA 1325     	MOV.L   	R2,@(#14,R3)	;}
L000ECC:							;else {
000ECC 200A     	XOR     	R0,R0			;  entry->m04 = 0x00;
000ECE B0EB     	BRS     	L0010A8		;  next_entry = get_next_entry();
000ED0 8034     	MOV.B   	R0,@(#04,R3)	;}
L000ED2:
000ED2 13F2     	MOV.L   	R15,@(#8,R3)	;entry->stack = SH1.SP;
000ED4 E001     	MOV     	#01,R0		;entry->fn = 0x01;
000ED6 A11F     	BRA     	L001118		;return run_task(next_entry);
...
000F9E 80A6     	MOV.B   	R0,@(#06,R10)	;    entry->m06 = handle->tn*4;
000FA0 DCE1     	MOV.L   	@(#384,PC),R12	;
000FA2 0DCE     	MOV.L   	@(R0,R12),R13	;    u32* queue = task_queue_tbl[handle->tn];
L000FA4:							;    while (1) {
...
001030 6162     	MOV.L   	@R6,R1		;task_entry* current_entry = current_task_entry;
001032 8410     	MOV.B   	@(#00,R1),R0	;u8 tn = current_entry->header.tn;
001034 4008     	SHLL2   	R0			;
001036 D2BC     	MOV.L   	@(#2F0,PC),R2	;
001038 042E     	MOV.L   	@(R0,R2),R4		;u32* queue = task_queue_tbl[tn];
00103A 8016     	MOV.B   	R0,@(#06,R1)	;current_entry->m06 = tn*4;
00103C E004     	MOV     	#04,R0		;
00103E 8011     	MOV.B   	R0,@(#01,R1)	;current_entry->header.fn = 0x04;
001040 E010     	MOV     	#10,R0		;
L001042:							;while (1) {
001042 6542     	MOV.L   	@R4,R5		;  task_entry* node = *queue;
...
L00104E:
00104E 2412     	MOV.L   	R1,@R4		;*queue = current_entry;
001050 B02A     	BRS     	L0010A8		;task_entry* entry = get_next_entry();
001052 0009     	NOP     				;
001054 A060     	BRA     	L001118		;run_task(entry);
001056 0009     	NOP     				;
...
001076 2CB6     	MOV.L   	R11,@-R12		;  stack--; *stack = task_thread_tbl[tn];
...
L0010A8:							;task_entry* get_next_entry()
0010A8 DD17     	MOV.L   	@(#05C,PC),R13	;void* queue = &task_queue[0];
0010AA 6CD6     	MOV.L   	@R13+,R12		;task_entry* entry = *queue++;
...
0010F4 C32B     	TRAPA   	#43			;TRAP_43(0x06);
...
L001118:							;u32 run_task(task_entry* entry)	//entry-R13
...
001124 80D1     	MOV.B   	R0,@(#01,R13)	;entry->header.fn = 0x05;
001126 200A     	XOR     	R0,R0			;
001128 80D6     	MOV.B   	R0,@(#06,R13)	;entry->m06 = 0x00;
00112A 2AD2     	MOV.L   	R13,@R10		;current_task_entry = entry;
00112C 4B2B     	JMP     	@R11			;SH1.SP = entry->stack; 
00112E 5FD2     	MOV.L   	@(#08,R13),R15	;return func(entry);

L001130:							;u32 task_pre_func_1130(task_entry* entry)	//entry-R13
001130 60D0     	MOV.B   	@R13,R0		;u8 tn = entry->header.tn;
001132 4008     	SHLL2   	R0			;
001134 DC20     	MOV.L   	@(#080,PC),R12	;
001136 0CCE     	MOV.L   	@(R0,R12),R12	;
001138 2CC8     	TST     	R12,R12		;
00113A 8900     	BT      	L00113E		;if (((u32*)0x09075800)[tn] != 0)
00113C 2FC2     	MOV.L   	R12,@R15		;  SH1.SP = ((u32*)0x09075800)[tn];
L00113E:
...
001150 8B07     	BF      	L001162		;if (((u8*)task_args)[0] == entry->header.tn) {
...
001160 2CD2     	MOV.L   	R13,@R12		;  return arg;
L001162:							;}
001162 E007     	MOV     	#07,R0		;else {
001164 C32B     	TRAPA   	#43			;  TRAP_43(0x07)
001166 EB00     	MOV     	#00,R11		;  
001168 002B     	RTE     				;  return 0x00000000;
00116A E0FF     	MOV     	#FF,R0		;}

L00116C:							;int task_pre_func_116C(task_entry* entry)	//entry-R13
...
L00117C:							;int task_pre_func_117C(task_entry* entry)	//entry-R13
...
L0011AA:							;int task_pre_func_11AA(task_entry* entry)	//entry-R13
0011AA 002B     	RTE     				;
0011AC 0009     	NOP     				;
0011AE 0009     	NOP     				;
0011B0 05FF
...
L0011BE:							;int task_create(u32 h)	//h-R11
0011BE 60B9     	SWAP.W   	R11,R0		;
0011C0 6008     	SWAP.B   	R0,R0			;handle_t* handle = (handle_t*)&h;
0011C2 DC5A     	MOV.L   	@(#168,PC),R12	;
0011C4 C9FF     	AND     	#FF,R0		;
0011C6 DD5A     	MOV.L   	@(#168,PC),R13	;
0011C8 4008     	SHLL2   	R0			;
0011CA 0ACE     	MOV.L   	@(R0,R12),R10	;u32* entry = task_entry_tbl[handle->tn];
0011CC 0CDE     	MOV.L   	@(R0,R13),R12	;u32* map = task_map_tbl[handle->tn];
0011CE 84A3     	MOV.B   	@(#03,R10),R0	;
0011D0 6D0C     	EXTU.B   	R0,R13		;
0011D2 60B9     	SWAP.W   	R11,R0		;
0011D4 C9FF     	AND     	#FF,R0		;
0011D6 C880     	TST     	#80,R0		;
0011D8 8B06     	BF      	L0011E8		;if (handle->fn & 0x80 != 0 ||
0011DA 2DD8     	TST     	R13,R13		;
0011DC 8904     	BT      	L0011E8		;     entry->m03 == 0 ||
0011DE 3D00     	CMP/EQ 	R0,R13		;
0011E0 8902     	BT      	L0011E8		;     handle->fn == entry->m03 ||
0011E2 6DA0     	MOV.B   	@R10,R13		;
0011E4 3D00     	CMP/EQ 	R0,R13		;
0011E6 8B12     	BF      	L00120E		;     handle->fn == entry->tn) {
L0011E8:
0011E8 C880     	TST     	#80,R0		;
0011EA 8903     	BT      	L0011F4		;
0011EC C97F     	AND     	#7F,R0		;
0011EE 4008     	SHLL2   	R0			;
0011F0 A001     	BRA     	L0011F6		;  u8 mn = (handle->fn & 0x80) == 0 ?
0011F2 7038     	ADD     	#38,R0		;          handle->fn :
0011F4 4008     	SHLL2   	R0			;          (handle->fn & 0x7F) + 14;
...
L001208:							;  }
001208 2DB2     	MOV.L   	R11,@R13		;  *ptr = h;
...
00122E 0CDE     	MOV.L   	@(R0,R13),R12	;task_entry* entry = task_entry_tbl[arg1[31:24]];
001230 7C02     	ADD     	#02,R12		;
001232 4C1B     	TAS.B   	@R12			;
001234 8B02     	BF      	L00123C		;if (entry->header.m02 != 0) {
001236 7C01     	ADD     	#01,R12		;
001238 A007     	BRA     	L00124A		;
00123A 2CA0     	MOV.B   	R10,@R12		;  entry->header.m03 = arg1[23:15];
L00123C:							;  return 0;
...
L00124C:
00124C 002B     	RTE     				;  return (entry->header.m03 == arg1[23:15]) ? 0 : -1;
00124E 0009     	NOP     				;}

TRAP_39:							;(u32 handle)	//arg1-R11
...
00125E 0CDE     	MOV.L   	@(R0,R13),R12	;task_entry* entry = task_entry_tbl[handle[31:24]];
001260 6AB9     	SWAP.W   	R11,R10		;
001262 84C3     	MOV.B   	@(#03,R12),R0	;
001264 20AA     	XOR     	R10,R0		;
001266 C8FF     	TST     	#FF,R0		;
001268 8B2F     	BF      	L0012CA		;if (entry->header.m03 ^ handle[23:15] == 0) {
...
001272 80C3     	MOV.B   	R0,@(#03,R12)	;    entry->header.m03 = n;
...
0012D8 6008     	SWAP.B   	R0,R0			;handle_t handle;
0012DA C9FF     	AND     	#FF,R0		;handle.h = h();
0012DC 4008     	SHLL2   	R0			;
0012DE DD13     	MOV.L   	@(#04C,PC),R13	;
0012E0 0CDE     	MOV.L   	@(R0,R13),R12	;task_entry* entry = task_entry_tbl[handle.fn];
0012E2 EA02     	MOV     	#02,R10		;
0012E4 3ACC     	ADD     	R12,R10		;
0012E6 4A1B     	TAS.B   	@R10			;
0012E8 8B03     	BF      	L0012F2		;if (entry->header.m02 == 0) {
0012EA 60B9     	SWAP.W   	R11,R0		;  entry->header.m02 |= 0x80;
0012EC 80C3     	MOV.B   	R0,@(#03,R12)	;  entry->header.m03 = handle[23:15];
0012EE 002B     	RTE     				;
0012F0 200A     	XOR     	R0,R0			;
L0012F2:
0012F2 84C3     	MOV.B   	@(#03,R12),R0	;} else if (entry->header.m03 != handle[23:15]) {
...
001306 6AD2     	MOV.L   	@R13,R10		;  task_entry* ptr2 = current_task_entry;
L001308:							;  while (1) {
...
001318 80A1     	MOV.B   	R0,@(#01,R10)	;  ptr2->header.fn = 0x06;
...
task_stack_tbl:						;L001374
	...
	dc.l	0x00000000					;task 10
	dc.l	0x00000000					;task 11
	dc.l	0x0F000F10					;task 12
	dc.l	0x0F000F98					;task 13
	dc.l	0x0F001000					;task 14

task_thread_tbl:						;L0013B0
	dc.l 	0x00000000
	dc.l 	L0063DC					;task1_thread()
	dc.l 	L005E68					;task2_thread()
	dc.l 	0x00000000
	dc.l 	L0056F8					;task4_thread()
	dc.l 	L004594					;task5_thread()
	dc.l 	L002718					;task6_thread()
	dc.l 	L0077B2					;task7_thread()
	dc.l 	L00A010					;task8_thread()
	dc.l 	L00BA46					;task9_thread()
	dc.l 	0x00000000
	dc.l 	0x00000000
	dc.l 	L006990					;task12_thread()
	dc.l 	L006FC8					;task13_thread()
	dc.l 	L001BE0					;task14_thread()

task_queue_tbl:						;void* task_queue_tbl[] = {
	dc.l 	task_queue+0				;  &task_queue[0],
	dc.l 	task_queue+32				;  &task_queue[8],
	dc.l 	task_queue+28				;  &task_queue[7],
	dc.l 	0x00000000					;  0,
	dc.l 	task_queue+4				;  &task_queue[1],
	dc.l 	task_queue+12				;  &task_queue[3],
	dc.l 	task_queue+8				;  &task_queue[2],
	dc.l 	task_queue+20				;  &task_queue[5],
	dc.l 	task_queue+24				;  &task_queue[6],
	dc.l 	task_queue+40				;  &task_queue[10],
	dc.l 	0x00000000					;  0,
	dc.l 	0x00000000					;  0,
	dc.l 	task_queue+16				;  &task_queue[4],
	dc.l 	task_queue+36				;  &task_queue[9],
	dc.l 	task_queue+44				;  &task_queue[11]};
...
0019F8 8919     	BT      	L001A2E		;
0019FA 5011     	MOV.L   	@(#04,R1),R0	;
0019FC 2008     	TST     	R0,R0			;
0019FE 8916     	BT      	L001A2E		;
001A00 D264     	MOV.L   	@(#190,PC),R2	;
001A02 6222     	MOV.L   	@R2,R2		;
001A04 4218     	SHLL8   	R2			;
001A06 4219     	SHLR8   	R2			;if (*(u32*)(0x0F000208+0x08) != 0 &&
001A08 3026     	CMP/HI 	R2,R0			;    *(u32*)(0x0F000208+0x04) != 0 &&
...
L001BE0:							;task14_thread()//idle task
001BE0 D003     	MOV.L   	@(#00C,PC),R0	;
001BE2 400B     	JSR     	@R0			;L001EFC();
001BE4 0009     	NOP     				;
L001BE6:							;task14_thread_loop
001BE6 0009     	NOP     				;
001BE8 0009     	NOP     				;
001BEA 0009     	NOP     				;
001BEC AFFB     	BRA     	L001BE6		;goto task14_thread_loop;
001BEE 0009     	NOP     				;
001BF0 00001EFC
001BF4 05FF
001BF6 FFC2
...
001C0A CDEF     	AND.B   	#EF,@(R0,GBR)	;SH1.ITU.TSNC &= ~0x10;
001C0C E002     	MOV     	#02,R0		;
001C0E CDEF     	AND.B   	#EF,@(R0,GBR)	;SH1.ITU.TMDR &= ~0x10;
001C10 E003     	MOV     	#03,R0		;
001C12 CDF3     	AND.B   	#F3,@(R0,GBR)	;SH1.ITU.TFCR &= ~0x0C;
...
001C2A 2302     	MOV.L   	R0,@R3		;delayed_handles[0] = 0x00000000;
001C2C 1301     	MOV.L   	R0,@(#4,R3)		;delayed_handles[1] = 0x00000000;
...
001C68 2302     	MOV.L   	R0,@R3		;delayed_handles[0] = 0x00000000;
001C6A 1301     	MOV.L   	R0,@(#4,R3)		;delayed_handles[1] = 0x00000000;
001C6C 000B     	RTS     				;
001C6E 0009     	NOP     				;
...
001C7A CDFB     	AND.B   	#FB,@(R0,GBR)	;SH1.ITU.TSR4 &= ~0x02;
...
001C9E CDFE     	AND.B   	#FE,@(R0,GBR)	;SH1.ITU.TSR4 &= ~0x01;
...
001CDA 6CD2     	MOV.L   	@R13,R12		;task_entry* entry = current_task_entry;
...
001D24 CDFE     	AND.B   	#FE,@(R0,GBR)	;SH1.ITU.TIER4 &= ~0x01;
...
001D6A CDFD     	AND.B   	#FD,@(R0,GBR)	;SH1.ITU.TSR4 &= ~0x02;
...
001D7A 6B12     	MOV.L   	@R1,R11		;u32 handle0 = delayed_handles[0];
001D7C 2162     	MOV.L   	R6,@R1		;delayed_handles[0] = 0x00000000;
001D7E 5211     	MOV.L   	@(#04,R1),R2	;u32 handle1 = delayed_handles[1];
001D80 1161     	MOV.L   	R6,@(#4,R1)		;delayed_handles[1] = 0x00000000
001D82 CDFD     	AND.B   	#FD,@(R0,GBR)	;SH1.ITU.TIER4 &= ~0x02;
001D84 440E     	LDC     	R4,SR			;
001D86 C321     	TRAPA   	#33			;add_task_to_queue(handle0);
001D88 6B23     	MOV     	R2,R11		;
001D8A 2BB8     	TST     	R11,R11		;
001D8C 8900     	BT      	L001D90		;
001D8E C321     	TRAPA   	#33			;if (handle1) add_task_to_queue(handle1);
L001D90:
001D90 D052     	MOV.L   	@(#148,PC),R0	;
001D92 402B     	JMP     	@R0			;add_task13_to_queue();
001D94 0009     	NOP     				;

TRAP_36:							;(u32 arg1, u32 h)	//arg1-R10,h-R11
L001D96:
...
001DAE 39CC     	ADD     	R12,R9		;u32 temp = (old_cnt<<8) + (tcnt>>8);
...
001DC0 39DC     	ADD     	R13,R9		;temp += (arg1 - (arg1 * 10 / 256));
...
001E26 C103     	MOV.W   	R0,@(#006,GBR)	;SH1.ITU.GRA4 = (temp<<8) | 0x007F;
001E28 E003     	MOV     	#03,R0		;
001E2A CDFE     	AND.B   	#FE,@(R0,GBR)	;SH1.ITU.TSR4 &= ~0x01;
001E2C E002     	MOV     	#02,R0		;
001E2E CF01     	OR .B   	#01,@(R0,GBR)	;SH1.ITU.TSR4 |= 0x01;
001E30 4C1E     	LDC     	R12,GBR		;
L001E32:
001E32 7D08     	ADD     	#08,R13		;
001E34 2DB2     	MOV.L   	R11,@R13		;
001E36 1D91     	MOV.L   	R9,@(#4,R13)	;
001E38 002B     	RTE     				;return 0;
001E3A E000     	MOV     	#00,R0		;
L001E3C:
001E3C E009     	MOV     	#09,R0		;
001E3E C32B     	TRAPA   	43			;TRAP_43(0);
001E40 E0FF     	MOV     	#FF,R0		;
001E42 002B     	RTE     				;return 0xFFFFFFFF;
001E44 0009     	NOP     				;
...
001E8E CDFE     	AND.B   	#FE,@(R0,GBR)	;  SH1.ITU.TIER4 &= ~0x01;
...
TRAP_45:							;void add_delayed_task_to_queue(u32 h)	//h-R11
001EAC DD11     	MOV.L   	@(#044,PC),R13	;u32* ptr = &delayed_handles[0];
001EAE 60D2     	MOV.L   	@R13,R0		;
001EB0 2008     	TST     	R0,R0			;
001EB2 8900     	BT      	L001EB6		;if (delayed_handles[0] == 0)
001EB4 7D04     	ADD     	#04,R13		;  delayed_handles[0] = h;
001EB6 2DB2     	MOV.L   	R11,@R13		;else
001EB8 0D12     	STC     	GBR, R13		;  delayed_handles[1] = h;
...
001EC8 CDFD     	AND.B   	#FD,@(R0,GBR)	;SH1.ITU.TSR4 &= ~0x02;
...
001F00 8112     	MOV.W   	R0,@(#04,R1)	;YGR.CDIRQL = 0x0000;
001F02 D50C     	MOV.L   	@(#030,PC),R5	;
001F04 6051     	MOV.W   	@R5,R0		;
001F06 9214     	MOV.W   	@(#028,PC),R2	;
001F08 202B     	OR      	R2,R0			;
001F0A 2501     	MOV.W   	R0,@R5		;SH1.INTC.IPRB |= 0x0060;
001F0C 900F     	MOV.W   	@(#01E,PC),R0	;
001F0E 8114     	MOV.W   	R0,@(#08,R1)	;YGR.CDMSKL = 0x0001;
001F10 900E     	MOV.W   	@(#01C,PC),R0	;
001F12 811F     	MOV.W   	R0,@(#1E,R1)	;YGR.HIRQ = HIRQ_MPED | HIRQ_EFLS | HIRQ_ECPY | HIRQ_EHST |
001F14 D308     	MOV.L   	@(#020,PC),R3	;           HIRQ_ESEL | HIRQ_DCHG | HIRQ_CMOK;
...
001F70 2101     	MOV.W   	R0,@R1		;YGR.CDIRQL = 0x0000;
...
001F8E 6008     	SWAP.B   	R0,R0			;u32 h;
001F90 600E     	EXTS.B   	R0,R0			;u16 rr1,rr2,rr3,rr4;
001F92 8805     	CMP/EQ  	#05,R0		;
001F94 8903     	BT      	L001F9E		;if (auth_device_flag & 0x01 != 0 && cr1>>8 != 0x05) {
001F96 B186     	BRS     	L0022A6		;  make_cd_status_err(cr1,cr2,cr3,cr4,&rr1,&rr2,&rr3,&rr4);
001F98 0009     	NOP     				;
...
001FAE 4A0B     	JSR     	@R10			;  command_group_tbl[cmd>>4](cr1,cr2,cr3,cr4,cmd,&h,&rr1,&rr2,&rr3,&rr4);
...
001FC8 2101     	MOV.W   	R0,@R1		;YGR.HIRQ = HIRQ_CMOK;
001FCA 2BB8     	TST     	R11,R11		;
001FCC 8900     	BT      	#000			;
001FCE C321     	TRAPA   	#33			;if (h) add_task_to_queue(h);
...
L002020:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
00202C 442B     	JMP     	@R4			;if (cmd <= 0x06) command_0x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00202E 0009     	NOP     				;
L002030:
002030 A139     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002032 0009     	NOP     				;
...
L002050:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
00205E 442B     	JMP     	@R4			;if (cmd <= 0x06) command_1x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
002060 0009     	NOP     				;
L002062:
002062 A120     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002064 0009     	NOP     				;
002066 0009
...
L002074:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
002082 442B     	JMP     	@R4			;if (cmd <= 0x20) command_2x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
002084 0009     	NOP     				;
L002086:
002086 A10E     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002088 0009     	NOP     				;
00208A 0009     	NOP     				;
...
L002090:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
00209E 442B     	JMP     	@R4			;if (cmd <= 0x32) command_3x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
0020A0 0009     	NOP     				;
0020A2 A100     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0020A4 0009     	NOP     				;
0020A6 0009     	NOP     				;
...
L0020B4:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
0020C2 442B     	JMP     	@R4			;if (cmd <= 0x48) command_4x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
0020C4 0009     	NOP     				;
0020C6 A0EE     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0020C8 0009     	NOP     				;
0020CA 442B     	JMP     	@R4			;
0020CC 0009     	NOP     				;
0020CE 0009     	NOP     				;
...
L0020F4:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
002102 442B     	JMP     	@R4			;if (cmd <= 0x56) command_5x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
002104 0009     	NOP     				;
002106 A0CE     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002108 0009     	NOP     				;
00210A 0009
...
L002128:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
002136 442B     	JMP     	@R4			;if (cmd <= 0x67) command_6x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
002138 0009     	NOP     				;
00213A A0B4     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00213C 0009     	NOP     				;
00213E 0009
...
L002160:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
00216E 442B     	JMP     	@R4			;if (cmd <= 0x75) command_7x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4)
002170 0009     	NOP     				;
002172 A098     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002174 0009     	NOP     				;
002176 0009
...
L002190:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
0021B6 442B     	JMP     	@R4			;  command_9x_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0021B8 0009     	NOP     				;}
L0021BA:
0021BA A074     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0021BC 0009     	NOP     				;
0021BE 0009     	NOP     				;
...
L002200:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
002214 8906     	BT      	L002224		;    (*(u8*)0x0F000892 & 0x80) != 0x00) {
002216 C704     	MOVA    	@(#10,PC),R0	;
002218 E40F     	MOV     	#0F,R4		;
00221A 2349     	AND     	R4,R3			;
00221C 4308     	SHLL2   	R3			;
00221E 043E     	MOV.L   	@(R0,R3),R4		;
002220 442B     	JMP     	@R4			;  command_Ax_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002222 0009     	NOP     				;}
L002224:
002224 A03F     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002226 0009     	NOP     				;
...
L002270:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) //cr1/cr2-R1,cr3/cr4-R2,cmd-R3,rr1/rr2-R12,rr3/rr4-R13
...
002280 442B     	JMP     	@R4			;if (cmd <= 0xE2) command_Ex_tbl[cmd&0x0F](cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002282 0009     	NOP     				;
L002284:
002284 A00F     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
002286 0009     	NOP     				;
command_Ex_tbl:						;
...
L002294:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) //cr1/cr2-R1,cr3/cr4-R2,cmd-R3,rr1/rr2-R12,rr3/rr4-R13
002294 A007     	BRA     	L0022A6		;
002296 0009     	NOP     				;return make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);

								;cdb command Fx
L002298:							;(u16 cr1,cr2,cr3,cr4,u8 cmd,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) //cr1/cr2-R1,cr3/cr4-R2,cmd-R3,rr1/rr2-R12,rr3/rr4-R13
002298 E0FF     	MOV     	#FF,R0		;
00229A 3300     	CMP/EQ 	R0,R3			;
00229C 8B01     	BF      	L0022A2		;
00229E A055     	BRA     	L00234C		;if (cmd == 0xFF) L00234C(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0022A0 0009     	NOP     				;
L0022A2:
0022A2 A000     	BRA     	L0022A6		;else make_cd_status_err(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0022A4 0009     	NOP     				;

L0022A6:							;make_cd_status_err(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) //cr1/cr2-R1,cr3/cr4-R2,cmd-R3,rr1/rr2-R12,rr3/rr4-R13
0022A6 D007     	MOV.L   	@(#01C,PC),R0	;*h = 0x00000000;
...
L0022CC:							;cmd_end_data_transfer(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022CC D91E     	MOV.L   	@(#078,PC),R9	;
0022CE E000     	MOV     	#00,R0		;data_transfer_flag = 0;
0022D0 D416     	MOV.L   	@(#058,PC),R4	;
0022D2 442B     	JMP     	@R4			;return stop_data_transfer(rr1,rr2,rr3,rr4);//L002568
0022D4 2900     	MOV.B   	R0,@R9		;

;cdb command 02 "Get TOC"
L0022D6:							;get_toc(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022D6 D414     	MOV.L   	@(#050,PC),R4	;
0022D8 A00F     	BRA     	L0022FA		;return get_put_data_common(L009292,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022DA 0009     	NOP     				;

;cdb command 20 "Get Subcode QRW"
L0022DC:							;get_subcode(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022DC D414     	MOV.L   	@(#050,PC),R4	;
0022DE A00C     	BRA     	L0022FA		;return get_put_data_common(L009430,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022E0 0009     	NOP     				;

;cdb command 61 "Get Sector Data"
L0022E2:							;get_sector_data(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022E2 D414     	MOV.L   	@(#050,PC),R4	;
0022E4 A009     	BRA     	L0022FA		;return get_put_data_common(L00689C,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022E6 0009     	NOP     				;

;cdb command 63 "Get Then Delete Sector Data"
L0022E8:							;get_del_sector_data(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022E8 D413     	MOV.L   	@(#04C,PC),R4	;
0022EA A006     	BRA     	L0022FA		;return get_put_data_common(L00689C,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022EC 0009     	NOP     				;

;cdb command 64 "Put Sector Data"
L0022EE:							;put_sector_data(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022EE D413     	MOV.L   	@(#04C,PC),R4	;
0022F0 A003     	BRA     	L0022FA		;return get_put_data_common(L0068D0,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022F2 0009     	NOP     				;

;cdb command 73 "Get File Info"
L0022F4:							;get_file_info(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0022F4 D412     	MOV.L   	@(#048,PC),R4	;
0022F6 A000     	BRA     	L0022FA		;return get_put_data_common(L0095B8,cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0022F8 0009     	NOP     				;

L0022FA:							;get_put_data_common(void* func,u16 cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4)	//func-R4
0022FA D913     	MOV.L   	@(#04C,PC),R9	;
0022FC 6090     	MOV.B   	@R9,R0		;
0022FE 2008     	TST     	R0,R0			;
002300 8B0E     	BF      	L002320		;if (!data_transfer_flag) {
002302 4F22     	STS.L   	PR,@-R15		;
002304 440B     	JSR     	@R4			;  func(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
002306 0009     	NOP     				;
002308 4F26     	LDS.L   	@R15+,PR		;
00230A 4C11     	CMP/PZ  	R12			;  u8 status = *rr1>>8;
00230C 8B06     	BF      	L00231C		;
00230E 60C9     	SWAP.W   	R12,R0		;
002310 6008     	SWAP.B   	R0,R0			;
002312 C840     	TST     	#40,R0		;
002314 8902     	BT      	L00231C		;  if ((status & STAT_WAIT) == 0 && (status & STAT_TRNS) != 0) {
002316 D90C     	MOV.L   	@(#030,PC),R9	;
002318 E001     	MOV     	#01,R0		;
00231A 2900     	MOV.B   	R0,@R9		;    data_transfer_flag = 1;
L00231C:							;  }
...
00238C 8117     	MOV.W   	R0,@(#0E,R1)	;SH1.DMAC.CHR1 = 0x1258;
...
0023A0 1102     	MOV.L   	R0,@(#8,R1)		;data_transfer_src = 0x00000000;
0023A2 8116     	MOV.W   	R0,@(#0C,R1)	;data_transfer_len = 0x0000;
...
0023AE 8015     	MOV.B   	R0,@(#05,R1)	;data_transfer_flag = 0;
...
L0023BA:							;void data_transfer_enable(u32 h)	//h-R11
0023BA 4F22     	STS.L   	PR,@-R15		;handle_t* handle = (handle_t*)&h;
...
0023C4 8010     	MOV.B   	R0,@(#00,R1)	;*(u8*)(0x0F000256+0x00) = handle->fn;
0023C6 9862     	MOV.W   	@(#0C4,PC),R8	;
0023C8 4029     	SHLR16  	R0			;
0023CA 6703     	MOV     	R0,R7			;
0023CC 3870     	CMP/EQ 	R7,R8			;
0023CE 8938     	BT      	L002442		;handle->arg == 0x0000
...
00245E 2982     	MOV.L   	R8,@R9		;*(u32*)0x0F000248 = data_transfer_len;
...
002470 1930     	MOV.L   	R3,@(#0,R9)		;SH1.DMAC.SAR1 = data_transfer_src;
002472 1941     	MOV.L   	R4,@(#4,R9)		;SH1.DMAC.DAR1 = 0x0A000000;
002474 6083     	MOV     	R8,R0			;
002476 8195     	MOV.W   	R0,@(#0A,R9)	;SH1.DMAC.TCR1 = data_transfer_len;
...
002486 817F     	MOV.W   	R0,@(#1E,R7)	;YGR.HIRQ = HIRQ_DRDY;
...
00249C 801F     	MOV.B   	R0,@(#0F,R1)	;DMAC.CHCR1 &= ~0x0007;
...
0024CA 8935     	BT      	L002538		;if (*(u8*)(0x0F000256+0x01) != 0x00) {
0024CC 8422     	MOV.B   	@(#02,R2),R0	;
0024CE 690C     	EXTU.B   	R0,R9			;
0024D0 88FF     	CMP/EQ  	#FF,R0		;
0024D2 892C     	BT      	L00252E		;  if (*(u8*)(0x0F000256+0x02) != 0xFF) {
0024D4 8531     	MOV.W   	@(#02,R3),R0	;
0024D6 C801     	TST     	#01,R0		;    u32 addr; u16 size;
0024D8 8B0E     	BF      	L0024F8		;    if (YGR.TRCTL & 0x0001 == 0) {
0024DA D480     	MOV.L   	@(#200,PC),R4	;
0024DC 6442     	MOV.L   	@R4,R4		;      u8* ptr = *(u32*)0x0F00024C;
0024DE 6040     	MOV.B   	@R4,R0		;
0024E0 8888     	CMP/EQ  	#88,R0		;
0024E2 8B24     	BF      	L00252E		;      if (*ptr != 0x88) goto L00252E;
0024E4 D484     	MOV.L   	@(#210,PC),R4	;
0024E6 440B     	JSR     	@R4			;      L006E18(&addr,&size);
0024E8 0009     	NOP     				;
0024EA 1170     	MOV.L   	R7,@(#0,R1)		;      DMAC.SAR1 = addr;
0024EC 6083     	MOV     	R8,R0			;
0024EE 8115     	MOV.W   	R0,@(#0A,R1)	;      DMAC.TCR1 = size;
0024F0 9039     	MOV.W   	@(#072,PC),R0	;
0024F2 8117     	MOV.W   	R0,@(#0E,R1)	;      DMAC.CHCR1 = 0x125D;
0024F4 A00D     	BRA     	L002512		;
0024F6 0009     	NOP     				;    }
L0024F8:
0024F8 D478     	MOV.L   	@(#1E0,PC),R4	;    else {
0024FA 6442     	MOV.L   	@R4,R4		;      u8* ptr = *(u32*)0x0F00024C;
0024FC 6040     	MOV.B   	@R4,R0		;
0024FE 8888     	CMP/EQ  	#88,R0		;
002500 8B15     	BF      	L00252E		;      if (*ptr != 0x88) goto L00252E;
002502 D47E     	MOV.L   	@(#1F8,PC),R4	;
002504 440B     	JSR     	@R4			;      L006E76(&addr,&size);
002506 0009     	NOP     				;
002508 1171     	MOV.L   	R7,@(#4,R1)		;      DMAC.DAR1 = addr;
00250A 6083     	MOV     	R8,R0			;
00250C 8115     	MOV.W   	R0,@(#0A,R1)	;      DMAC.TCR1 = size;
00250E 9029     	MOV.W   	@(#052,PC),R0	;
002510 8117     	MOV.W   	R0,@(#0E,R1)	;      DMAC.CHCR1 = 0x435D;
L002512:							;    }
002512 D977     	MOV.L   	@(#1DC,PC),R9	;
002514 8422     	MOV.B   	@(#02,R2),R0	;
002516 600C     	EXTU.B   	R0,R0			;    u8 n = *(u8*)(0x0F000256+0x02);
002518 009C     	MOV.B   	@(R0,R9),R0		;
00251A 8022     	MOV.B   	R0,@(#02,R2)	;    *(u8*)(0x0F000256+0x02) = block_chain[n];
00251C 8421     	MOV.B   	@(#01,R2),R0	;
00251E 70FF     	ADD     	#FF,R0		;
002520 8021     	MOV.B   	R0,@(#01,R2)	;    *(u8*)(0x0F000256+0x01)--;
002522 D472     	MOV.L   	@(#1C8,PC),R4	;
002524 6042     	MOV.L   	@R4,R0		;
002526 308C     	ADD     	R8,R0			;
002528 2402     	MOV.L   	R0,@R4		;    *(u32*)0x0F000248 += size;
00252A A009     	BRA     	L002540		;    return;
00252C 0009     	NOP     				;  }
L00252E:
00252E D478     	MOV.L   	@(#1E0,PC),R4	;
002530 E0FF     	MOV     	#FF,R0		;
002532 2400     	MOV.B   	R0,@R4		;  *(u8*)0x0F00025A = 0xFF;
002534 E000     	MOV     	#00,R0		;  *(u8*)(0x0F000256+0x01) = 0x00;
002536 8021     	MOV.B   	R0,@(#01,R2)	;}
L002538:
002538 8531     	MOV.W   	@(#02,R3),R0	;
00253A C901     	AND     	#01,R0		;
00253C CB08     	OR      	#08,R0		;
00253E 8131     	MOV.W   	R0,@(#02,R3)	;YGR.TRCTL = (YGR.TRCTL & 0x0001) | 0x0008;
L002540:
...
L002568:							;void stop_data_transfer(*rr1,*rr2,*rr3,*rr4)//rr1/rr2-R12,rr3/rr4-R13

002568 4F22     	STS.L   	PR,@-R15		;
00256A D159     	MOV.L   	@(#164,PC),R1	;
00256C 8517     	MOV.W   	@(#0E,R1),R0	;DMAC.CHCR1;
00256E 90A8     	MOV.W   	@(#150,PC),R0	;
002570 8117     	MOV.W   	R0,@(#0E,R1)	;DMAC.CHCR1 = 0x1258;
002572 D156     	MOV.L   	@(#158,PC),R1	;
002574 8410     	MOV.B   	@(#00,R1),R0	;
002576 2008     	TST     	R0,R0			;
002578 8959     	BT      	L00262E		;if (*(u8*)0x0F000256) goto L00262E;
00257A 8414     	MOV.B   	@(#04,R1),R0	;
00257C 2008     	TST     	R0,R0			;
00257E 8B54     	BF      	L00262A		;if (*(u8*)0x0F00025A) goto L00262A;
002580 D253     	MOV.L   	@(#14C,PC),R2	;05FFFF50
002582 D154     	MOV.L   	@(#150,PC),R1	;
002584 8525     	MOV.W   	@(#0A,R2),R0	;u16 tcr1 = DMAC.TCR1;
002586 630D     	EXTU.W   	R0,R3			;
002588 8511     	MOV.W   	@(#02,R1),R0	;
00258A C801     	TST     	#01,R0		;
00258C 8939     	BT      	L002602		;if (YGR_TRCTL & 1)
00258E 2338     	TST     	R3,R3			;
002590 8953     	BT      	L00263A		;if (tcr1)
...
002604 8111     	MOV.W   	R0,@(#02,R1)	;YGR_TRCTL = 0x08;
002606 D439     	MOV.L   	@(#0E4,PC),R4	;
002608 6C42     	MOV.L   	@R4,R12		;u32 temp = *(u32*)0x0F000248 - tcr1;
00260A 3C38     	SUB     	R3,R12		;*rr1 = temp>>16; *rr2 = temp & 0xFFFF;
L00260C:
00260C D141     	MOV.L   	@(#104,PC),R1	;*rr3 = 0x0000; *rr4 = 0x0000;
00260E 410B     	JSR     	@R1			;get_rr1_status(rr1);//L0091A8
...
00261E 2B0B     	OR      	R0,R11		;*h = *(u8*)0x0F000256 << 24 | 0x00030001;
002620 E000     	MOV     	#00,R0		;
002622 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F000256 = 0x00;
L002624:
002624 4F26     	LDS.L   	@R15+,PR		;
002626 000B     	RTS     				;
002628 0009     	NOP     				;
L00262A:
00262A AFEF     	BRA     	L00260C		;
00262C ECFF     	MOV     	#FF,R12		;*rr1 = 0xFFFF; *rr2 = 0xFFFF;
L00262E:
00262E D139     	MOV.L   	@(#0E4,PC),R1	;*rr1 = 0xFFFF; *rr2 = 0xFFFF;
002630 410B     	JSR     	@R1			;get_rr1_status(rr1);//L0091A8
002632 ECFF     	MOV     	#FF,R12		;
002634 ED00     	MOV     	#00,R13		;*rr3 = 0x0000; *rr4 = 0x0000;
002636 AFF5     	BRA     	L002624		;*h = 0x00000000;
002638 EB00     	MOV     	#00,R11		;return;
L00263A:
00263A D524     	MOV.L   	@(#090,PC),R5	;
00263C 8451     	MOV.B   	@(#01,R5),R0	;
00263E 8800     	CMP/EQ  	#00,R0		;
002640 89DF     	BT      	L002602		;if (*(u8*)(0x0F000256+0x01) == 0x00) goto L002602;
002642 8452     	MOV.B   	@(#02,R5),R0	;
002644 690C     	EXTU.B   	R0,R9			;
002646 88FF     	CMP/EQ  	#FF,R0		;
002648 89EF     	BT      	L00262A		;if (*(u8*)(0x0F000256+0x02) == 0xFF) goto L00262A;
00264A D524     	MOV.L   	@(#090,PC),R5	;
00264C 6552     	MOV.L   	@R5,R5		;u8* ptr = *(u32*)0x0F00024C;
00264E 6050     	MOV.B   	@R5,R0		;
002650 8888     	CMP/EQ  	#88,R0		;
002652 8BEA     	BF      	L00262A		;if (*ptr != 0x88) goto L00262A;
002654 D529     	MOV.L   	@(#0A4,PC),R5	;
002656 450B     	JSR     	@R5			;L006E76
002658 0009     	NOP     				;
...
002664 2402     	MOV.L   	R0,@R4		;*(u32*)0x0F000248 += 
...
00273A C204     	MOV.L   	R0,@(#010,GBR)	;memset(cd_status_buf1,0xFF,8);
00273C C205     	MOV.L   	R0,@(#014,GBR)	;
00273E C206     	MOV.L   	R0,@(#018,GBR)	;memset(cd_status_buf2,0xFF,8);
002740 C207     	MOV.L   	R0,@(#01C,GBR)	;
...
002764 2106     	MOV.L   	R0,@-R1		;memset(data,0xFF,12);
002766 2136     	MOV.L   	R3,@-R1		;
002768 2136     	MOV.L   	R3,@-R1		;
...
00277E 2101     	MOV.W   	R0,@R1		;YGR.REG1A = (YGR.REG1A & ~0x0010) | 0x0040;
...
L002796:							;task6_thread_loop: 
002796 C323     	TRAPA   	#35			;h = switch_task();
002798 6CB3     	MOV     	R11,R12		;handle_t* handle = (handle_t*)&h;
...
0027AA 8B10     	BF      	L0027CE		;if (handle->fn == 0x81) {
0027AC 60B3     	MOV     	R11,R0		;
0027AE 880C     	CMP/EQ  	#0C,R0		;
0027B0 890B     	BT      	L0027CA		;  if ((u8)handle->arg == 0x0C) goto task6_func_81_0C;
0027B2 880D     	CMP/EQ  	#0D,R0		;
0027B4 8907     	BT      	L0027C6		;  if ((u8)handle->arg == 0x0D) goto L00360E;
0027B6 8800     	CMP/EQ  	#00,R0		;
0027B8 8B0B     	BF      	L0027D2		;  if ((u8)handle->arg != 0x00) goto L0027D2;
0027BA 4F22     	STS.L   	PR,@-R15		;
0027BC B2A3     	BRS     	L002D06		;  L002D06();
0027BE 0009     	NOP     				;
0027C0 4F26     	LDS.L   	@R15+,PR		;
0027C2 AFE8     	BRA     	L002796		;  goto task6_thread_loop;
0027C4 0009     	NOP     				;
L0027C6:
...
0027D0 8949     	BT      	L002866		;else if (handle->fn == 0x03) goto task6_func_03;
L0027D2:
0027D2 6083     	MOV     	R8,R0			;
0027D4 8883     	CMP/EQ  	#83,R0		;
0027D6 8B0B     	BF      	L0027F0		;if (handle->fn == 0x83 &&
...
00282C 00002C58						;16
002830 09000230
L002834:							;else {	//cd_state < 0x11 || cd_state > 0x16
002834 6083     	MOV     	R8,R0			;
002836 8804     	CMP/EQ  	#04,R0		;  switch (handle->fn) {
002838 892D     	BT      	L002896		;    case 0x04: goto task6_func_04;
00283A 8805     	CMP/EQ  	#05,R0		;
00283C 891F     	BT      	L00287E		;    case 0x05: goto task6_func_05;
00283E 8806     	CMP/EQ  	#06,R0		;
002840 8907     	BT      	L002852		;    case 0x06: goto task6_func_06;
002842 8807     	CMP/EQ  	#07,R0		;
002844 8920     	BT      	L002888		;    case 0x07: goto task6_func_07;
002846 8881     	CMP/EQ  	#81,R0		;
002848 8914     	BT      	L002874		;    case 0x81: goto task6_func_81;
00284A 8883     	CMP/EQ  	#83,R0		;
00284C 8BA3     	BF      	L002796		;    case 0x83: goto task6_func_83;
00284E A027     	BRA     	L0028A0		;    default: goto task6_thread_loop;}
002850 0009     	NOP     				;}

L002852:							;task6_func_06:
...
00285C 400B     	JSR     	@R0			;task6_func_06_tbl[(u8)handle->arg]();
00285E 0009     	NOP     				;
002860 4F26     	LDS.L   	@R15+,PR		;
002862 A016     	BRA     	L002892		;
002864 0009     	NOP     				;

L002866:							;task6_func_03:
...
L002874:							;goto task6_func_81:
002874 E00E     	MOV     	#0E,R0		;
002876 3B06     	CMP/HI 	R0,R11		;
002878 890B     	BT      	L002892		;if ((u8)handle->arg <= 0x0E) 
00287A C75F     	MOVA    	@(#17C,PC),R0	;  task6_func_81_tbl[(u8)handle->arg]();
00287C 8BEA     	BF      	L002854		;goto task6_thread_loop;

L00287E:							;task6_func_05:
00287E E004     	MOV     	#04,R0		;
002880 3B06     	CMP/HI 	R0,R11		;
002882 8906     	BT      	L002892		;if ((u8)handle->arg <= 0x04) 
002884 C752     	MOVA    	@(#148,PC),R0	;  task6_func_05_tbl[(u8)handle->arg]();
002886 8BE5     	BF      	L002854		;goto task6_thread_loop;

L002888:							;task6_func_07:
002888 E004     	MOV     	#04,R0		;
00288A 3B06     	CMP/HI 	R0,R11		;
00288C 8901     	BT      	#002			;if ((u8)handle->arg <= 0x04) 
00288E C755     	MOVA    	@(#154,PC),R0	;  task6_func_07_tbl[(u8)handle->arg]();
002890 8BE0     	BF      	L002854		;goto task6_thread_loop;

L002892:
002892 AF80     	BRA     	L002796		;
002894 0009     	NOP     				;

L002896:							;task6_func_04:
002896 E001     	MOV     	#01,R0		;
002898 3B06     	CMP/HI 	R0,R11		;
00289A 89FA     	BT      	#1F4			;if ((u8)handle->arg > 0x01) 
00289C C764     	MOVA    	@(#190,PC),R0	;  task6_func_04_tbl[(u8)handle->arg]();
00289E 8BD9     	BF      	L002854		;goto task6_thread_loop;

L0028A0:							;task6_func_83:
0028A0 C749     	MOVA    	@(#124,PC),R0	;
0028A2 4B08     	SHLL2   	R11			;
0028A4 30BC     	ADD     	R11,R0		;
0028A6 6002     	MOV.L   	@R0,R0		;
0028A8 4F22     	STS.L   	PR,@-R15		;
0028AA 400B     	JSR     	@R0			;task6_func_83_tbl[(u8)handle->arg]();//L0029C8
0028AC 0009     	NOP     				;
...
0028BE 890D     	BT      	L0028DC		;if (*(u8*)0x0F000894 & 0x10 != 0) {
...
0028D0 8B1B     	BF      	L00290A		;  SH1.PFC.PBDR[6] = *(u8*)0x0F000894 & 0x80 == 0 ? 0 : 1; //DEMP
0028D2 A01F     	BRA     	L002914		;
0028D4 0009     	NOP     				;
0028D6 0009     	NOP     				;}
0028D8 0F000894
L0028DC:
0028DC E5EF     	MOV     	#EF,R5		;else {
0028DE 430E     	LDC     	R3,SR			;  SH1.SR |= 0x000000F0;
0028E0 6011     	MOV.W   	@R1,R0		;
0028E2 2059     	AND     	R5,R0			;
0028E4 2101     	MOV.W   	R0,@R1		;  YGR.REG1A &= ~0x0010;
...
002926 8904     	BT      	L002932		;if (auth_device_flag & 0x01 != 0) {
002928 954A     	MOV.W   	@(#094,PC),R5	;
00292A E6FF     	MOV     	#FF,R6		;  rr1 = 0x20FF; rr2 = 0xFFFF;
00292C E7FF     	MOV     	#FF,R7		;  rr3 = 0xFFFF; rr4 = 0xFFFF;
00292E A01C     	BRA     	L00296A		;  goto L00296A
...
002980 8903     	BT      	L00298A		;if (YGR.CDIRQL & 0x02 != 0) {
002982 2451     	MOV.W   	R5,@R4		;  YGR.RR1 = rr1;
002984 2961     	MOV.W   	R6,@R9		;  YGR.RR2 = rr2;
002986 2A71     	MOV.W   	R7,@R10		;  YGR.RR3 = rr3;
002988 2B81     	MOV.W   	R8,@R11		;  YGR.RR4 = rr4;
L00298A:							;}
00298A 410E     	LDC     	R1,SR			;//restore SR
00298C D108     	MOV.L   	@(#020,PC),R1	;
00298E E004     	MOV     	#04,R0		;
002990 4018     	SHLL8   	R0			;
002992 2101     	MOV.W   	R0,@R1		;YGR.HIRQ = HIRQ_SCDQ;
...
L0029C8:							;task6_func_83_tbl:
	dc.l	L003AA8					;task6_func_83_00()
L0029CC:							;:task6_func_06_tbl
	dc.l	L0031C4					;task6_func_83_01()

L0029D0:							;task6_func_05_tbl:
	dc.l	L003650					;task6_func_05_00()
	dc.l	L003680					;task6_func_05_01()
	dc.l	L00368E					;task6_func_05_02()
	dc.l	L0036C0					;task6_func_05_03()
	dc.l	L0036DC					;task6_func_05_04()

L0029E4:							;task6_func_07_tbl:
	dc.l	L0036FE					;
	dc.l	L003728					;task6_func_07_01()
	dc.l	L003730					;task6_func_07_02()
	dc.l	L003754					;task6_func_07_03()
	dc.l	L003778					;task6_func_07_04()

L0029F8:							;task6_func_81_tbl:
	dc.l	L002D06					;task6_func_81_00()
	dc.l	L002D7A					;task6_func_81_01()
	dc.l	L002D7E					;task6_func_81_02()
	dc.l	L002DC8					;task6_func_81_03()
	dc.l	L003004					;task6_func_81_04()
	dc.l	L002EBC					;task6_func_81_05()
	dc.l	L003084					;task6_func_81_06()
	dc.l	L0030A0					;task6_func_81_07()
	dc.l	L0030B8					;task6_func_81_08()
	dc.l	L003178					;task6_func_81_09()
	dc.l	L003208					;task6_func_81_0A()
	dc.l	L003250					;task6_func_81_0B()
	dc.l	L0035E4					;task6_func_81_0C()
	dc.l	L00360E					;task6_func_81_0D()

L002A30:							;task6_func_04_tbl:
	dc.l	L0037C4					;task6_func_04_00()
	dc.l	L0037FE					;task6_func_04_01()

L002A38:							;void init_toc()
...
002A48 CD7F     	AND.B   	#7F,@(R0,GBR)	;cdd_cmd_flags &= 0x7F;
...
002A92 B3E0     	BRS     	L003256		;check_and_schedule_task5();//L00418C
002A94 0009     	NOP     				;
002A96 4F26     	LDS.L   	@R15+,PR		;
002A98 4F22     	STS.L   	PR,@-R15		;
002A9A BFCD     	BRS     	L002A38		;init_toc();//L002A38
002A9C 0009     	NOP     				;
...
002AA8 2101     	MOV.W   	R0,@R1		;YGR.HIRQ = HIRQ_DCHG;
002AAA E04A     	MOV     	#4A,R0		;
002AAC CD3A     	AND.B   	#3A,@(R0,GBR)	;cd_flags &= 0x3A;
002AAE E04B     	MOV     	#4B,R0		;
002AB0 CD10     	AND.B   	#10,@(R0,GBR)	;cd_flags2 &= 0x10;
002AB2 E003     	MOV     	#03,R0		;
002AB4 CD3F     	AND.B   	#3F,@(R0,GBR)	;cdd_cmd_flags &= ~0xC0;
...
L002B1E:							;(u8 fn,u8 arg)	//fn-R0,arg-R11
002B1E 8881     	CMP/EQ  	#81,R0		;
002B20 8B12     	BF      	L002B48		;if (fn == 0x81) {
002B22 60B3     	MOV     	R11,R0		;
002B24 8802     	CMP/EQ  	#02,R0		;
002B26 8B07     	BF      	L002B38		;  if (arg == 0x02) {
...
002B3E B02F     	BRS     	L002BA0		;  make_readtoc_cmd(0x01);
002B40 E001     	MOV     	#01,R0		;
002B42 4F26     	LDS.L   	@R15+,PR		;
002B44 A04E     	BRA     	L002BE4		;  goto L002BE4;
002B46 0009     	NOP     				;}
L002B48:
002B48 8807     	CMP/EQ  	#07,R0		;if (fn == 0x07) {
002B4A 8B04     	BF      	L002B56		;
002B4C 60B3     	MOV     	R11,R0		;
002B4E 8800     	CMP/EQ  	#00,R0		;
002B50 89F2     	BT      	L002B38		;  if (arg == 0x00) goto L002B38;
002B52 A023     	BRA     	L002B9C		;  goto task6_thread_loop;
002B54 0009     	NOP     				;}
L002B56:
002B56 8883     	CMP/EQ  	#83,R0		;
002B58 8B20     	BF      	L002B9C		;if (fn != 0x83) goto L002796;
...
002B86 B00B     	BRS     	L002BA0		;make_readtoc_cmd(0x01);
...
L002BA0:							;make_readtoc_cmd(u8 sesn)	//arg1-R0
002BA0 C02D     	MOV.B   	R0,@(#02D,GBR)	;session_num = sesn;
002BA2 D106     	MOV.L   	@(#018,PC),R1	;u8 cmd[12] = {CDD_COMM_TOC,0x00,0x00,0x00,
...
002BAE CF20     	OR .B   	#20,@(R0,GBR)	;cdd_cmd_flags |= 0x20;
...
002C46 CDEF     	AND.B   	#EF,@(R0,GBR)	;cd_flags2 &= ~0x10;
...
L002C58:							;(u8 fn,u8 arg)//fn-R0,arg-R11
002C58 8881     	CMP/EQ  	#81,R0		;
002C5A 8B10     	BF      	L002C7E		;if (fn == 0x81) {
...
002C80 8B04     	BF      	L002C8C		;else if (fn == 0x07) {
002C82 60B3     	MOV     	R11,R0		;
002C84 8800     	CMP/EQ  	#00,R0		;
002C86 89EC     	BT      	L002C62		;  if (arg == 0x00) goto L002C62;
002C88 A021     	BRA     	L002CCE		;  goto task6_thread_loop;
002C8A 0009     	NOP     				;}
L002C8C:
002C8C 8883     	CMP/EQ  	#83,R0		;
002C8E 8B1E     	BF      	L002CCE		;else if (fn == 0x83) {
...
L002CF0:							;(u8 fn,u8 arg)//fn-R0,arg-R11
002CF0 8881     	CMP/EQ  	#81,R0		;
002CF2 89BB     	BT      	L002C6C		;if (fn == 0x81) goto L002C6C;
002CF4 8807     	CMP/EQ  	#07,R0		;
002CF6 8B04     	BF      	L002D02		;else if (fn != 0x07) goto L002C8C;
002CF8 60B3     	MOV     	R11,R0		;
002CFA 8800     	CMP/EQ  	#00,R0		;
002CFC 89B6     	BT      	L002C6C		;else if (arg == 0x00) goto L002C6C;
002CFE AD4A     	BRA     	L002796		;goto task6_thread_loop;
002D00 0009     	NOP     				;
L002D02:
...
002D0A C001     	MOV.B   	R0,@(#001,GBR)	;*(u8*)(0x0F00025C+0x01) = 0x00;
...
002D12 C202     	MOV.L   	R0,@(#008,GBR)	;start_play_pos = 0x00000000;
002D14 C203     	MOV.L   	R0,@(#00C,GBR)	;end_play_pos = 0x00000000;
002D16 C02F     	MOV.B   	R0,@(#02F,GBR)	;*(u8*)(0x0F00025C+0x2F) = 0x00;
002D18 E04A     	MOV     	#4A,R0		;
002D1A CD28     	AND.B   	#28,@(R0,GBR)	;cd_flags &= 0x28;
002D1C E04B     	MOV     	#4B,R0		;
002D1E CD10     	AND.B   	#10,@(R0,GBR)	;cd_flags2 &= 0x10;
...
002D30 C602     	MOV.L   	@(#008,GBR),R0	;u16 iprb = SH1.INTC.IPRB;
002D32 2F06     	MOV.L   	R0,@-R15		;u16 iprc = SH1.INTC.IPRC;
002D34 E000     	MOV     	#00,R0		;u16 iprd = SH1.INTC.IPRD;
...
002D42 C202     	MOV.L   	R0,@(#008,GBR)	;SH1.INTC.IPRD = iprd;
002D44 60F6     	MOV.L   	@R15+,R0		;SH1.INTC.IPRC = iprc;
002D46 C201     	MOV.L   	R0,@(#004,GBR)	;SH1.INTC.IPRB = iprb;
002D48 4F26     	LDS.L   	@R15+,PR		;SH1.INTC.IPRA = ipra;
...
002D54 2101     	MOV.W   	R0,@R1		;YGR.HRIQ = HIRQ_MPED | HIRQ_EFLS | HIRQ_ECPY | 
002D56 C42E     	MOV.B   	@(#02E,GBR),R0	;           HIRQ_EHST | HIRQ_ESEL | HIRQ_CMOK;
...
002D98 D107     	MOV.L   	@(#01C,PC),R1	;u8 cmd[12] = {0x0C,0x00,0x00,0x00,
002D9A D208     	MOV.L   	@(#020,PC),R2	;              0x00,0x00,0x00,0x00,
002D9C D308     	MOV.L   	@(#020,PC),R3	;              0x00,0x00,0x00,0x01};
002D9E 4F22     	STS.L   	PR,@-R15		;
002DA0 B25B     	BRS     	#04B6			;make_cdd_cmd(cmd);
002DA2 0009     	NOP     				;
002DA4 4F26     	LDS.L   	@R15+,PR		;
002DA6 E011     	MOV     	#11,R0		;
002DA8 C049     	MOV.B   	R0,@(#049,GBR)	;cd_state = 0x01;
...
002DCC C401     	MOV.B   	@(#001,GBR),R0	;play_mode
...
002DE2 C03C     	MOV.B   	R0,@(#03C,GBR)	;start_play_pos_buf = (0x01<<24) | (start_play_pos & 0x00FFFFFF);
002DE4 C440     	MOV.B   	@(#040,GBR),R0	;
002DE6 C00C     	MOV.B   	R0,@(#00C,GBR)	;
002DE8 C603     	MOV.L   	@(#00C,GBR),R0	;
002DEA A047     	BRA     	L002E7C		;end_play_pos_buf = (end_play_pos_buf & 0xFF000000) | (end_play_pos & 0x00FFFFFF);
002DEC C210     	MOV.L   	R0,@(#040,GBR)	;goto L002E7C;

L002DEE:
002DEE E800     	MOV     	#00,R8		;
002DF0 A007     	BRA     	L002E02		;
002DF2 277A     	XOR     	R7,R7		;

L002DF4:							;(u32 fad)//fad-R3
002DF4 643C     	EXTU.B   	R3,R4			;
002DF6 4319     	SHLR8   	R3			;
002DF8 4F22     	STS.L   	PR,@-R15		;
002DFA B236     	BRS     	L00326A		;u32 get_track_info(fad>>8,fad&0xFF,u32* ret);//track-R3,arg1-R4,ret-R4
002DFC 0009     	NOP     				;
...
L002E2C:							;void (u32 fad,u32 arg2,u8 arg3)//fad-R6,arg2-R7,arg3-R8
002E2C E04A     	MOV     	#4A,R0		;
002E2E CF08     	OR .B   	#08,@(R0,GBR)	;cd_flags |= 0x08;
002E30 4F22     	STS.L   	PR,@-R15		;
002E32 B405     	BRS     	L003640		;L004300();
002E34 0009     	NOP     				;
002E36 4F26     	LDS.L   	@R15+,PR		;
002E38 4828     	SHLL16  	R8			;
002E3A D10B     	MOV.L   	@(#02C,PC),R1	;u8 cmd[12] = {CDD_COMM_SEEK,0x00,0x00,0x00,
002E3C 4818     	SHLL8   	R8			;              0x00,0x00,0x00,0x00,
002E3E 6273     	MOV     	R7,R2			;              0x00,0x00,0xFF,0x01};
002E40 D30A     	MOV.L   	@(#028,PC),R3	;*(u32*)&cmd[0] |= fad;
002E42 216B     	OR      	R6,R1			;*(u32*)&cmd[4] = arg2;
002E44 238B     	OR      	R8,R3			;cmd[8] = arg3;
002E46 4F22     	STS.L   	PR,@-R15		;
002E48 B205     	BRS     	L003256		;make_cdd_cmd(cmd);
002E4A 0009     	NOP     				;
...
002E58 C049     	MOV.B   	R0,@(#049,GBR)	;cd_state = 0x00;
002E5A DB05     	MOV.L   	@(#014,PC),R11	;
002E5C C325     	TRAPA   	#37			;TRAP_37(0x06060000);
002E5E E04A     	MOV     	#4A,R0		;
002E60 CF80     	OR .B   	#80,@(R0,GBR)	;cd_flags |= 0x80;
002E62 CDBE     	AND.B   	#BE,@(R0,GBR)	;cd_flags &= ~0x41;
002E64 000B     	RTS     				;
002E66 0009     	NOP     				;
002E68 09000000
002E6C 0000FF01
...
002E80 4019     	SHLR8   	R0		;u32 end_pos = end_play_pos_buf & 0x00FFFFFF;
002E82 8800     	CMP/EQ  	#00,R0		;
002E84 8B04     	BF      	L002E90		;if (!end_pos) {
...
L002E90:
002E90 C43C     	MOV.B   	@(#03C,GBR),R0	;u32 start_pos = start_play_pos_buf;
002E92 8800     	CMP/EQ  	#00,R0		;
002E94 8901     	BT      	#002		;u32 temp = 0xFFFFFFFF;
002E96 A007     	BRA     	L002EA8		;if (!start_pos) {
...
L002EA8:
002EA8 C20A     	MOV.L   	R0,@(#028,GBR)	;*(u32*)(0x0F00025C+0x28) = temp;
002EAA E0FF     	MOV     	#FF,R0		;
002EAC C220     	MOV.L   	R0,@(#080,GBR)	;*(u32*)(0x0F00025C+0x80) = 0xFFFFFFFF;
002EAE E001     	MOV     	#01,R0		;
002EB0 CC80     	TST.B   	#80,@(R0,GBR)	;
002EB2 8925     	BT      	L002F00		;if (!(play_mode & 0x80)) goto L002F00;
002EB4 8B0F     	BF      	L002ED6		;goto L002ED6;
002EB6 0009     	NOP     			;
002EB8 0900
002EBA 01FC
002EBC E04B     	MOV     	#4B,R0		;
002EBE CDD3     	AND.B   	#D3,@(R0,GBR)	;
002EC0 C401     	MOV.B   	@(#001,GBR),R0	;play_mode
...
002F02 CD7F     	AND.B   	#7F,@(R0,GBR)	;play_mode &= ~0x80;
002F04 C60F     	MOV.L   	@(#03C,GBR),R0	;
002F06 4F22     	STS.L   	PR,@-R15	;
002F08 B312     	BRS     	L003530		;check_track_pos(start_play_pos_buf);
002F0A 0009     	NOP     			;
002F0C 4F26     	LDS.L   	@R15+,PR	;
002F0E E0FF     	MOV     	#FF,R0		;
002F10 C220     	MOV.L   	R0,@(#080,GBR)	;*(u32*)(0x0F00025C+0x80) = 0xFFFFFFFF;
002F12 E000     	MOV     	#00,R0		;
002F14 C002     	MOV.B   	R0,@(#002,GBR)	;*(u8*)(0x0F00025C+0x02) = 0x00;
002F16 C444     	MOV.B   	@(#044,GBR),R0	;
002F18 8801     	CMP/EQ  	#01,R0		;
002F1A C611     	MOV.L   	@(#044,GBR),R0	;
002F1C 8905     	BT      	L002F2A		;if (start_play_pos_work >> 24 != 0x01) {
002F1E 8800     	CMP/EQ  	#00,R0		;
002F20 8B06     	BF      	#00C		;
002F22 E096     	MOV     	#96,R0		;
002F24 600C     	EXTU.B   	R0,R0		;
002F26 A003     	BRA     	L002F30		;
002F28 C211     	MOV.L   	R0,@(#044,GBR)	;}
L002F2A:
002F2A C032     	MOV.B   	R0,@(#032,GBR)	;else {
002F2C 4019     	SHLR8   	R0		;  play_idx = start_play_pos_work & 0xFF;
002F2E C031     	MOV.B   	R0,@(#031,GBR)	;  play_tno = (start_play_pos_work >> 8) & 0xFF;
L002F30:						;}
002F30 C444     	MOV.B   	@(#044,GBR),R0	;
002F32 6103     	MOV     	R0,R1		;
002F34 C43C     	MOV.B   	@(#03C,GBR),R0	;
002F36 3100     	CMP/EQ 		R0,R1		;
002F38 8B10     	BF      	L002F5C		;if (start_play_pos_work >> 24 == start_play_pos_buf >> 24) {
002F3A 4F22     	STS.L   	PR,@-R15	;
002F3C B1C2     	BRS     	L0032C4		;  bool check = L0032C4();
002F3E 0009     	NOP     			;
002F40 4F26     	LDS.L   	@R15+,PR	;
002F42 890B     	BT      	L002F5C		;  if (check) {
002F44 E001     	MOV     	#01,R0		;
002F46 CC80     	TST.B   	#80,@(R0,GBR)	;
002F48 8B01     	BF      	#002		;
002F4A A0CA     	BRA     	L0030E2		;    if () goto L0030E2;
002F4C 0009     	NOP     			;
002F4E 4F22     	STS.L   	PR,@-R15	;
002F50 B72C     	BRS     	#0E58		;
002F52 0009     	NOP     			;
002F54 4F26     	LDS.L   	@R15+,PR	;
002F56 8BD3     	BF      	L002F00		;    if () goto L002F00;
002F58 A0AE     	BRA     	L0030B8		;    goto L0030B8;
002F5A 0009     	NOP     			;  }
L002F5C:						;}
002F5C E0FF     	MOV     	#FF,R0		;
002F5E C220     	MOV.L   	R0,@(#080,GBR)	;*(u32*)(0x0F00025C+0x80) = 0xFFFFFFFF;
002F60 C444     	MOV.B   	@(#044,GBR),R0	;
002F62 8801     	CMP/EQ  	#01,R0		;u8 idx_out = 0;
002F64 E800     	MOV     	#00,R8		;u32 track_out = 0;
002F66 277A     	XOR     	R7,R7		;u32 fad_end = 0;
002F68 C611     	MOV.L   	@(#044,GBR),R0	;
002F6A 8B0F     	BF      	L002F8C		;if (start_play_pos_work == 0x01) {
002F6C 630D     	EXTU.W   	R0,R3		;
002F6E 643C     	EXTU.B   	R3,R4		;  u8 idx = (start_play_pos_work >> 0) & 0xFF
002F70 4319     	SHLR8   	R3		;  u8 tno = (start_play_pos_work >> 8) & 0xFF;
002F72 4F22     	STS.L   	PR,@-R15	;
002F74 B179     	BRS     	L00326A		;  u32 fad_start = get_track_info(tno,idx,&idx_out,&fad_end,&track_out);
002F76 0009     	NOP     			;
002F78 4F26     	LDS.L   	@R15+,PR	;
002F7A 6743     	MOV     	R4,R7		;
002F7C 2778     	TST     	R7,R7		;
002F7E 8B00     	BF      	#000		;  if (fad_end == 0)
002F80 C211     	MOV.L   	R0,@(#044,GBR)	;    start_play_pos_work = fad_start;
002F82 D11F     	MOV.L   	@(#07C,PC),R1	;
002F84 3010     	CMP/EQ 		R1,R0		;
002F86 8B01     	BF      	L002F8C		;
002F88 AF31     	BRA     	L002DEE		;  if (fad_start == 0x00FFFFFF) goto L002DEE;
002F8A 0009     	NOP     			;}
L002F8C:
...
002F94 8B00     	BF      	L002F98		;
002F96 E004     	MOV     	#04,R0		;
002F98 C02E     	MOV.B   	R0,@(#02E,GBR)	;cd_status = cd_flags2 & 0x04 == 0 ? 0x04 : 0x08;
002F9A E04A     	MOV     	#4A,R0		;
002F9C CF08     	OR .B   	#08,@(R0,GBR)	;cd_flags |= 0x08;
002F9E 4F22     	STS.L   	PR,@-R15	;
002FA0 B34E     	BRS     	L004300		;L004300();
002FA2 0009     	NOP     			;
002FA4 4F26     	LDS.L   	@R15+,PR	;
002FA6 E04B     	MOV     	#4B,R0		;
002FA8 CC20     	TST.B   	#20,@(R0,GBR)	;
002FAA 8B02     	BF      	L002FB2		;
002FAC E030     	MOV     	#30,R0		;
002FAE CC40     	TST.B   	#40,@(R0,GBR)	;
002FB0 8905     	BT      	L002FBE		;
002FB2 C444     	MOV.B   	@(#044,GBR),R0	;
002FB4 8801     	CMP/EQ  	#01,R0		;if ((!(cd_flags2 & 0x20) || (play_ctrl_adr & 0x40)) && 
002FB6 8902     	BT      	L002FBE		;    (start_play_pos_work >> 24) != 0x01) {
002FB8 C448     	MOV.B   	@(#048,GBR),R0	;
002FBA 360C     	ADD     	R0,R6		;
002FBC 76FF     	ADD     	#FF,R6		;  fad_start += *(u8*)(0x0F00025C+0x48) - 1;
L002FBE:						;}
002FBE 4828     	SHLL16  	R8		;
002FC0 D10D     	MOV.L   	@(#034,PC),R1	;u8 cmd[12] = {CDD_COMM_READ,0x00,0x00,0x00,
002FC2 4818     	SHLL8   	R8		;              0x00,0x00,0x00,0x00,
002FC4 6273     	MOV     	R7,R2		;              0x00,0x00,0xFF,0x01};
002FC6 D30D     	MOV.L   	@(#034,PC),R3	;*(u32*)&cmd[0] |= fad_start;
002FC8 216B     	OR      	R6,R1		;*(u32*)&cmd[4] = (idx_out << 24) | (fad_end & 0x00FFFFFF);
002FCA 238B     	OR      	R8,R3		;cmd[8] = track_out;
002FCC C402     	MOV.B   	@(#002,GBR),R0	;
002FCE 8806     	CMP/EQ  	#06,R0		;
002FD0 8903     	BT      	#006		;
002FD2 4F22     	STS.L   	PR,@-R15	;
002FD4 B13F     	BRS     	L003256		;check_and_schedule_task5();//L00418C
002FD6 0009     	NOP     			;
002FD8 4F26     	LDS.L   	@R15+,PR	;
002FDA 4F22     	STS.L   	PR,@-R15	;
002FDC B13D     	BRS     	L004148		;make_cdd_cmd();
002FDE 0009     	NOP     			;
...
003008 C401     	MOV.B   	@(#001,GBR),R0	;play_mode
...
003048 C603     	MOV.L   	@(#00C,GBR),R0	;end_play_pos
...
003088 C602     	MOV.L   	@(#008,GBR),R0	;start_play_pos
...
003098 AEAC     	BRA     	L002DF4		;return L002DF4();
...
003108 CC40     	TST.B   	#40,@(R0,GBR)	;if (cd_flags2 & 0x40 != 0) {
00310A 8907     	BT      	L00311C		;
00310C E00A     	MOV     	#0A,R0		;
00310E C049     	MOV.B   	R0,@(#049,GBR)	;  cd_state = 0x0A;
003110 E04B     	MOV     	#4B,R0		;
003112 CD3F     	AND.B   	#3F,@(R0,GBR)	;  cd_flags2 &= ~0xC0;
003114 DB16     	MOV.L   	@(#058,PC),R11	;
003116 C321     	TRAPA   	#33			;  add_task_to_queue(0x05060003);
003118 A007     	BRA     	L00312A		;
00311A 0009     	NOP     				;}
L00311C:
00311C CC02     	TST.B   	#02,@(R0,GBR)	;else {
00311E 8902     	BT      	L003126		;  if (cd_flags2 & 0x02 != 0) {
003120 CDFD     	AND.B   	#FD,@(R0,GBR)	;    cd_flags2 &= ~0x02;
003122 DB14     	MOV.L   	@(#050,PC),R11	;
003124 C321     	TRAPA   	#33			;    add_task_to_queue(0x05060007);
L003126:							;  }
003126 E005     	MOV     	#05,R0		;
003128 C049     	MOV.B   	R0,@(#049,GBR)	;  cd_state = 0x05;
L00312A:							;}
00312A E001     	MOV     	#01,R0		;
00312C C02E     	MOV.B   	R0,@(#02E,GBR)	;cd_status = 0x01;
00312E E04A     	MOV     	#4A,R0		;
003130 CF08     	OR .B   	#08,@(R0,GBR)	;cd_flags |= 0x08;
003132 4F22     	STS.L   	PR,@-R15		;
003134 B288     	BRS     	L003648		;set_cd_status();
003136 0009     	NOP     				;
003138 4F26     	LDS.L   	@R15+,PR		;
00313A D109     	MOV.L   	@(#024,PC),R1	;u8 cmd[12] = {CDD_COMM_PAUSE,0x00,0x00,0x00,//Pause
00313C D209     	MOV.L   	@(#024,PC),R2	;              0x00,0x00,0x00,0x00,
00313E D30A     	MOV.L   	@(#028,PC),R3	;              0x00,0x00,0xFF,0x01};
003140 4F22     	STS.L   	PR,@-R15		;
003142 B08A     	BRS     	L00325A		;make_cdd_cmd(cmd);//L004148
003144 0009     	NOP     				;
003146 4F26     	LDS.L   	@R15+,PR		;
003148 DB08     	MOV.L   	@(#020,PC),R11	;
00314A C325     	TRAPA   	#37			;TRAP_37(0x06060000);
00314C E04A     	MOV     	#4A,R0		;
00314E CF80     	OR .B   	#80,@(R0,GBR)	;cd_flags |= 0x80;
003150 CDBA     	AND.B   	#BA,@(R0,GBR)	;cd_flags &= ~0x45;
003152 C449     	MOV.B   	@(#049,GBR),R0	;
003154 8805     	CMP/EQ  	#05,R0		;
003156 8B01     	BF      	#002			;if (cd_state == 0x05)
003158 A75B     	BRA     	L004012		;  return L004012();
00315A 0009     	NOP     				;
00315C 000B     	RTS     				;
00315E 0009     	NOP     				;
003160 08000000
...
0031EC DB05     	MOV.L   	@(#014,PC),R11	;06060000
...
L003256:
003256 A799     	BRA     	L00418C		;
003258 0009     	NOP     				;
L00325A:
00325A A775     	BRA     	L004148		;
00325C 0009     	NOP     				;
...
L00326A:						;u32 get_track_info(u8 track,u8 idx,u8* idx_out,u32* fad_end,u32* track_out)//track-R3,idx-R4,idx_out:fad_end-R4
00326A 4F22     	STS.L   	PR,@-R15	;
00326C B7CD     	BRS     	L00420A		;u32 toc_data = get_toc_data(track);
00326E 6133     	MOV     	R3,R1		;
003270 4F26     	LDS.L   	@R15+,PR	;
003272 6803     	MOV     	R0,R8		;track_t* track_data = (track_t*)&toc_data;
003274 4029     	SHLR16  	R0		;
003276 4019     	SHLR8   	R0		;
003278 C840     	TST     	#40,R0		;
00327A 8908     	BT      	L00328E		;
00327C 6043     	MOV     	R4,R0		;  
00327E 8800     	CMP/EQ  	#00,R0		;
003280 8901     	BT      	L003286		;*idx_out = idx;
003282 8801     	CMP/EQ  	#01,R0		;if (track_data->ctrl_adr & 0x40 != 0 &&
003284 8B06     	BF      	L003294		;    (idx == 0x00 || idx == 0x01)) {
L003286:
003286 6083     	MOV     	R8,R0		;  *idx_out = 0x00;
003288 E400     	MOV     	#00,R4		;  *fad_end = 0;
00328A A018     	BRA     	L0032BE		;  *track_out = 0;
00328C E800     	MOV     	#00,R8		;  return track_data->fad;
L00328E:						;}
00328E 2448     	TST     	R4,R4		;
003290 8B00     	BF      	L003294		;else if (idx == 0x00)
003292 E401     	MOV     	#01,R4		;  *idx_out = 0x01;
L003294:
003294 6133     	MOV     	R3,R1		;
003296 7101     	ADD     	#01,R1		;
003298 D09B     	MOV.L   	@(#26C,PC),R0	;
00329A 6200     	MOV.B   	@R0,R2		;
00329C 622C     	EXTU.B   	R2,R2		;info_track_t* trackA0_data = (info_track_t*)&toc_dram_buf[100-1];
00329E 3126     	CMP/HI 		R2,R1		;
0032A0 8B02     	BF      	L0032A8		;if (track + 1 > trackA0_data->fad) {
0032A2 D29A     	MOV.L   	@(#268,PC),R2	;  track_t* trackA1_data = (info_track_t*)&toc_dram_buf[101-1];
0032A4 A004     	BRA     	L0032B0		;  fad = trackA1_data->fad;
0032A6 6022     	MOV.L   	@R2,R0		;}
L0032A8:
0032A8 4F22     	STS.L   	PR,@-R15	;else 
0032AA B1C7     	BRS     	L00420A		;  fad = get_toc_data(track + 1);
0032AC 0009     	NOP     			;
...
0032B8 240B     	OR      	R0,R4		;*fad_end = fad & 0x00FFFFFF;
0032BA 6083     	MOV     	R8,R0		;
0032BC 6833     	MOV     	R3,R8		;*track_out = track;
L0032BE:
0032BE 4018     	SHLL8   	R0		;
0032C0 000B     	RTS     			;return track_data->fad;
0032C2 4019     	SHLR8   	R0		;

L0032C4:						;
0032C4 E003     	MOV     	#03,R0		;
0032C6 CC40     	TST.B   	#40,@(R0,GBR)	;
0032C8 8901     	BT      	L0032CE		;if (cdd_cmd_flags & 0x40) 
0032CA A0CD     	BRA     	L003468		;  return 1;
0032CC 0018     	SETT    			;
L0032CE:
0032CE C43C     	MOV.B   	@(#03C,GBR),R0	;
0032D0 600C     	EXTU.B   	R0,R0		;
0032D2 8800     	CMP/EQ  	#00,R0		;
0032D4 8B25     	BF      	L003322		;if (start_play_pos_buf >> 24 == 0x00) {
...
003326 8B36     	BF      	L003396		;if (start_play_pos_work >> 24 == 0x00) {
...
0033A4 8B03     	BF      	L0033AE		;if ((start_play_pos_buf >> 8) & 0xFF == 0) {
...
0033B4 E000     	MOV     	#00,R0		;if ((start_play_pos_buf >> 0) & 0xFF == 0x00)
0033B6 310E     	ADDC    	R0,R1		;  start_play_pos_buf |= 0x01;
0033B8 D052     	MOV.L   	@(#148,PC),R0	;
0033BA 6000     	MOV.B   	@R0,R0		;
0033BC 4018     	SHLL8   	R0		;
0033BE 3016     	CMP/HI 		R1,R0		;
0033C0 8B02     	BF      	L0033C8		;if ((start_play_pos_buf >> 8) & 0xFF >= *(u8*)0x090001F5) {
...
0033D2 8B04     	BF      	L0033DE		;if ((start_play_pos_buf >> 8) & 0xFF <= *(u8*)0x090001F9) {
...
0033E4 3012     	CMP/HS 		R1,R0		;if (play_tno <= (start_play_pos_buf >> 8) & 0xFF && 
0033E6 8B41     	BF      	L00346C		;    play_idx <= (start_play_pos_buf >> 0) & 0xFF) {
0033E8 C444     	MOV.B   	@(#044,GBR),R0	;
0033EA 8800     	CMP/EQ  	#00,R0		;
0033EC 8B14     	BF      	L003418		;  if ((start_play_pos_work >> 24) == 0x00) {
0033EE C610     	MOV.L   	@(#040,GBR),R0	;
0033F0 4018     	SHLL8   	R0		;
0033F2 4019     	SHLR8   	R0		;
0033F4 8800     	CMP/EQ  	#00,R0		;
0033F6 8B0A     	BF      	#014		;
0033F8 C430     	MOV.B   	@(#030,GBR),R0	;play_ctrl_adr
...
003426 8B03     	BF      	L003430		;  if ((end_play_pos_buf >> 8) & 0xFF == 0x00) {
...
003436 8B00     	BF      	L00343A		;  if ((end_play_pos_buf >> 0) & 0xFF == 0x00)
003438 7163     	ADD     	#63,R1		;    end_play_pos_buf |= 99;
00343A D032     	MOV.L   	@(#0C8,PC),R0	;
00343C 6000     	MOV.B   	@R0,R0		;
00343E 4018     	SHLL8   	R0		;
003440 3016     	CMP/HI 		R1,R0		;
003442 8B02     	BF      	L00344A		;  if ((end_play_pos_buf >> 8) & 0xFF >= *(u8*)0x090001F5) {
003444 6103     	MOV     	R0,R1		;
003446 A00B     	BRA     	L003460		;
...
003454 8B04     	BF      	L003460		;  else if ((end_play_pos_buf >> 8) & 0xFF <= *(u8*)0x090001F9 + 1) {
...
003464 4029     	SHLR16  	R0		;  if ((end_play_pos_buf >> 8) & 0xFF > play_tno && 
003466 3102     	CMP/HS 		R0,R1		;      (end_play_pos_buf >> 0) & 0xFF > play_idx) return 1;
L003468:
003468 000B     	RTS     			;  return 0;
...
003508 090001F9
00350C 090001FC
003510 C602     	MOV.L   	@(#008,GBR),R0	;start_play_pos
...
L003530:						;void check_track_pos(u32 pos)
003530 6203     	MOV     	R0,R2		;
003532 4018     	SHLL8   	R0		;
003534 8800     	CMP/EQ  	#00,R0		;
003536 8B02     	BF      	#004		;if (pos & 0x00FFFFFF == 0) {
003538 E096     	MOV     	#96,R0		;  *(u32*)(0x0F00025C+0x44) = 150;
00353A A03C     	BRA     	L0035B6		;  return;
...
003548 8B0A     	BF      	L003560		;if ((pos >> 24) == 0) {
...
003558 0009     	NOP     			;
00355A 4F26     	LDS.L   	@R15+,PR	;  *(u32*)(0x0F00025C+0x40) = ;
00355C A02B     	BRA     	L0035B6		;  return;
00355E 0009     	NOP     			;}
L003560:
003560 D017     	MOV.L   	@(#05C,PC),R0	;
003562 2029     	AND     	R2,R0		;u8 idx = pos & 0xFF;
003564 E163     	MOV     	#63,R1		;
003566 3016     	CMP/HI 		R1,R0		;
003568 8B03     	BF      	L003572		;if (idx > 99) 
00356A 4219     	SHLR8   	R2		;
00356C 4218     	SHLL8   	R2		;
00356E A003     	BRA     	L003578		;  idx = 99;
003570 221B     	OR      	R1,R2		;
L003572:
003572 8800     	CMP/EQ  	#00,R0		;else if (idx == 0)
003574 E000     	MOV     	#00,R0		;  idx = 1;
003576 320E     	ADDC    	R0,R2		;
L003578:
003578 D010     	MOV.L   	@(#040,PC),R0	;
00357A 2029     	AND     	R2,R0		;u8 tno = (pos >> 8) & 0xFF;
00357C 8800     	CMP/EQ  	#00,R0		;
00357E 8B04     	BF      	L00358A		;if (tno == 0) {
003580 D110     	MOV.L   	@(#040,PC),R1	;
003582 6010     	MOV.B   	@R1,R0		;
003584 4018     	SHLL8   	R0		;
003586 A012     	BRA     	#0024		;  tno = *(u8*)0x090001F5;
...
003592 8B03     	BF      	L00359C		;if (*(u8*)0x090001F5 > tno) {
003594 6013     	MOV     	R1,R0		;
003596 4018     	SHLL8   	R0		;  tno = *(u8*)0x090001F5;
003598 A009     	BRA     	L0035AE		;  idx = 1;
...
0035A2 8B01     	BF      	#002		;
0035A4 A003     	BRA     	L0035AE		;else if (*(u8*)0x090001F9 < tno) {
0035A6 6023     	MOV     	R2,R0		;
0035A8 6013     	MOV     	R1,R0		;  tno = *(u8*)0x090001F9;
0035AA 4018     	SHLL8   	R0		;  idx = 1;
0035AC 7001     	ADD     	#01,R0		;}
L0035AE:
0035AE E201     	MOV     	#01,R2		;
0035B0 4228     	SHLL16  	R2		;
0035B2 4218     	SHLL8   	R2		;
0035B4 202B     	OR      	R2,R0		;*(u32*)(0x0F00025C+0x44) = (0x01<<24) | (tno << 8) | (idx << 0);
L0035B6:
0035B6 000B     	RTS     			;
...
003604 400B     	JSR     	@R0			;data_transfer_enable(0x03060000);//L0023BA
003606 0009     	NOP     				;
003608 4F26     	LDS.L   	@R15+,PR		;
00360A A8C4     	BRA     	L002796		;goto task6_thread_loop;
00360C 0009     	NOP     				;
...
00363A 0068
L00363C:
00363C A5E5     	BRA     	L00420A		;
00363E 0009     	NOP     				;
L003640:
003640 A65E     	BRA     	L004300		;
003642 0009     	NOP     				;

003644 A6BE     	BRA     	#0D7C			;
003646 0009     	NOP     				;
L003648:
003648 A754     	BRA     	L0044F4		;L0044F4
00364A 0009     	NOP     				;
...
0036B2 C321     	TRAPA   	#21			;add_task_to_queue(0x07060003);
...
L003728:							;void task6_func_07_01()
003728 E04B     	MOV     	#4B,R0		;
00372A CDD3     	AND.B   	#D3,@(R0,GBR)	;cd_flags2 &= ~0x2C;
00372C ACEB     	BRA     	L003106		;goto L003106;
00372E 0009     	NOP     				;

L003730:							;void task6_func_07_02()
...
L003778:							;void task6_func_07_04()
003778 E003     	MOV     	#03,R0		;
00377A CF40     	OR .B   	#40,@(R0,GBR)	;cdd_cmd_flags |= 0x40;
00377C E000     	MOV     	#00,R0		;
00377E C09E     	MOV.B   	R0,@(#09E,GBR)	;*(u8*)0x0F0002FA = 0x00;
003780 E021     	MOV     	#21,R0		;
003782 C049     	MOV.B   	R0,@(#049,GBR)	;cd_state = 0x21;
003784 C618     	MOV.L   	@(#060,GBR),R0	;
003786 C211     	MOV.L   	R0,@(#044,GBR)	;*(u32*)(0x0F00025C+0x44) = FAD_02BC;
003788 E000     	MOV     	#00,R0		;
00378A C111     	MOV.W   	R0,@(#022,GBR)	;*(u16*)(0x0F00025C+0x22) = 0x0000;
00378C 4F22     	STS.L   	PR,@-R15		;
00378E B4FD     	BRS     	L00418C		;check_and_schedule_task5();
003790 0009     	NOP     				;
003792 4F26     	LDS.L   	@R15+,PR		;
003794 E003     	MOV     	#03,R0		;
003796 CF20     	OR .B   	#20,@(R0,GBR)	;cdd_cmd_flags |= 0x20;
003798 C611     	MOV.L   	@(#044,GBR),R0	;
00379A D106     	MOV.L   	@(#018,PC),R1	;u8 cmd[12] = {CDD_COMM_SEEK_RING,0x00,0x00,0x00,//seeking ring 
00379C D206     	MOV.L   	@(#018,PC),R2	;              0x00,0x00,0x00,0x00,
00379E D307     	MOV.L   	@(#01C,PC),R3	;              0x00,0x00,0xFF,0x01};
0037A0 4F22     	STS.L   	PR,@-R15		;*((u32*)&cmd[0]) |= FAD_02BC;
0037A2 B4D1     	BRS     	L004148		;make_cdd_cmd(cmd);
0037A4 210B     	OR      	R0,R1			;
0037A6 4F26     	LDS.L   	@R15+,PR		;
0037A8 DB05     	MOV.L   	@(#014,PC),R11	;
0037AA C325     	TRAPA   	#37			;TRAP_37(0x06060000);
0037AC E04A     	MOV     	#4A,R0		;
0037AE CD3A     	AND.B   	#3A,@(R0,GBR)	;cd_flags &= ~0xC5;
0037B0 000B     	RTS     				;
0037B2 0009     	NOP     				;
0037B4 02000000
0037B8 00000000
...
0037C8 890E     	BT      	L0037E8		;
0037CA CC80     	TST.B   	#80,@(R0,GBR)	;
0037CC 890C     	BT      	L0037E8		;
...
003822 C321     	TRAPA   	#33			;TRAPA_33(0x05060009);
003824 AC81     	BRA     	L00312A		;goto L00312A;
003826 0009     	NOP     				;
003828 05060009
...
003868 8B32     	BF      	L0038D0		;    cdd_rx_data.track != 0) goto L0028B0;
...
0038EC 895E     	BT      	L0039AC		;if (toc_dram_buf[101] == 0xFFFFFFFF ||
0038EE D158     	MOV.L   	@(#160,PC),R1	;
0038F0 6012     	MOV.L   	@R1,R0		;
0038F2 88FF     	CMP/EQ  	#FF,R0		;
0038F4 895A     	BT      	L0039AC		;    toc_dram_buf[99] == 0xFFFFFFFF ||
...
003902 8953     	BT      	L0039AC		;    toc_dram_buf[100] == 0xFFFFFFFF ||
003904 4029     	SHLR16  	R0			;
003906 630C     	EXTU.B   	R0,R3			;
003908 3322     	CMP/HS 	R2,R3			;
00390A 8B4F     	BF      	L0039AC		;    (toc_dram_buf[100]>>16)&0xFF >= (toc_dram_buf[99]>>16)&0xFF) goto L003262;
00390C D156     	MOV.L   	@(#158,PC),R1	;u8 temp3 = (toc_dram_buf[99]>>16)&0xFF;
00390E 6010     	MOV.B   	@R1,R0		;u8 temp4 = (toc_dram_buf[99]>>16)&0xFF;
003910 8810     	CMP/EQ  	#10,R0		;u8 temp5 = (toc_dram_buf[100]>>16)&0xFF;
003912 8B10     	BF      	L003936		;(toc_dram_buf[99]>>8)&0xFF != 0x10
...
003924 6210     	MOV.B   	@R1,R2		;u8 temp4 = (toc_dram_buf[100]>>16)&0xFF;
003926 D152     	MOV.L   	@(#148,PC),R1	;
003928 6310     	MOV.B   	@R1,R3		;u8 temp5 = (toc_dram_buf[99]>>16)&0xFF;
00392A 3320     	CMP/EQ 	R2,R3			;
00392C 8B03     	BF      	L003936		;
00392E D151     	MOV.L   	@(#144,PC),R1	;
003930 6010     	MOV.B   	@R1,R0		;
003932 C840     	TST     	#40,R0		;
003934 8B09     	BF      	L00394A		;if (temp4 != temp5 || (toc_dram_buf[100]>>24) & 0x40 == 0x00) {
L003936:
003936 4208     	SHLL2   	R2			;
003938 4308     	SHLL2   	R3			;
00393A D144     	MOV.L   	@(#110,PC),R1	;
00393C 321C     	ADD     	R1,R2			;  u32* ptr1 = &toc_dram_buf[temp4];
00393E 331C     	ADD     	R1,R3			;  u32* ptr2 = &toc_dram_buf[temp5];
L003940:
003940 6026     	MOV.L   	@R2+,R0		;  do {
003942 88FF     	CMP/EQ  	#FF,R0		;
003944 8932     	BT      	L0039AC		;    if(*ptr1++) == 0xFFFFFFFF) goto L003262;
003946 3236     	CMP/HI 	R3,R2			;
003948 8BFA     	BF      	#L003940		;  } while (ptr1 <= ptr2);
L00394A:							;}
00394A C42D     	MOV.B   	@(#02D,GBR),R0	;
00394C 0944     	MOV.B   	R4,@(R0,R9)		;*(u8*)(arg1+session_num) = temp3;
00394E 6403     	MOV     	R0,R4			;
003950 7001     	ADD     	#01,R0		;
003952 C02D     	MOV.B   	R0,@(#02D,GBR)	;session_num++;
003954 E003     	MOV     	#03,R0		;
003956 CC80     	TST.B   	#80,@(R0,GBR)	;
003958 8901     	BT      	L00395E		;
00395A AF67     	BRA     	L00382C		;if (cdd_cmd_flags & 0x80 != 0x00) goto L00382C;
00395C 0009     	NOP     				;
L00395E:
...
003968 320C     	ADD     	R0,R2			;u32* ptr2 = &toc_dram_buf[103];
00396A 310C     	ADD     	R0,R1			;u32* ptr1 = &toc_dram_buf[103];
...
003988 0926     	MOV.L   	R2,@(R0,R9)		;  *(u32*)(arg1+0x64) = toc_dram_buf[101];
L00398A:
00398A E064     	MOV     	#64,R0		;
00398C 0944     	MOV.B   	R4,@(R0,R9)		;*(u8*)(arg1+0x64) = ses_num;
...
003A06 8B1A     	BF      	L003A3E		;if (cdd_rx_data.index == 0xA0 || cdd_rx_data.index == 0xA1) {
003A08 D612     	MOV.L   	@(#048,PC),R6	;  u32* info_ptr = cdd_rx_data.index == 0xA0 ? &toc_dram_buf[99] :
L003A0A:							;                                              &toc_dram_buf[100];
...
003A26 220B     	OR      	R0,R2			;  u32 tocdata = cdd_rx_data.qcode<<24 | (mm<<16) | (cdd_rx_data.abs_ss<<8) | cdd_rx_data.abs_ff;
L003A28:
003A28 2622     	MOV.L   	R2,@R6		;  *info_ptr = tocdata;
003A2A 760C     	ADD     	#0C,R6		;  info_ptr += 3;
003A2C D00B     	MOV.L   	@(#02C,PC),R0	;
003A2E 3600     	CMP/EQ 	R0,R6			;
003A30 8B02     	BF      	L003A38		;
003A32 6062     	MOV.L   	@R6,R0		;
003A34 88FF     	CMP/EQ  	#FF,R0		;
003A36 8BE3     	BF      	L003A00		;  if (info_ptr != &first_info_track || *info_ptr == 0xFFFFFFFF) {
L003A38:
003A38 2622     	MOV.L   	R2,@R6		;    *info_ptr = tocdata;
...
L003A46:
003A46 D604     	MOV.L   	@(#010,PC),R6	;u32* ptr3 = &toc_dram_buf[101];
...
L003AA8:							;void task6_func_83_00()
003AA8 4F22     	STS.L   	PR,@-R15		;
003AAA B8CB     	BRS     	L002C44		;
003AAC 0009     	NOP     				;
003AAE 4F26     	LDS.L   	@R15+,PR		;
003AB0 8901     	BT      	L003AB6		;if (!cdd_rx_done()) return;
003AB2 000B     	RTS     				;
003AB4 0009     	NOP     				;
L003AB6:
...
003AC2 8B41     	BF      	L003B48		;if (cdd_rx_data.stat & 0xF0 != 0x80) goto L003B48;
003AC4 4F22     	STS.L   	PR,@-R15		;
003AC6 B361     	BRS     	L00418C		;L00418C();
003AC8 0009     	NOP     				;
003ACA 4F26     	LDS.L   	@R15+,PR		;
003ACC E003     	MOV     	#03,R0		;
003ACE CC40     	TST.B   	#40,@(R0,GBR)	;
003AD0 8905     	BT      	L003ADE		;if (cdd_cmd_flags & 0x40 != 0) {
003AD2 CDBF     	AND.B   	#BF,@(R0,GBR)	;  cdd_cmd_flags &= ~0x40;
003AD4 E000     	MOV     	#00,R0		;
003AD6 C20F     	MOV.L   	R0,@(#03C,GBR)	;  *(u32*)(0x0F00025C+0x3C) = 0x00000000;
003AD8 C210     	MOV.L   	R0,@(#040,GBR)	;  *(u32*)(0x0F00025C+0x40) = 0x00000000;
003ADA DB17     	MOV.L   	@(#05C,PC),R11	;
003ADC C321     	TRAPA   	#33			;  add_task_to_queue(0x07060003);
L003ADE:							;}
003ADE 6013     	MOV     	R1,R0			;
003AE0 C90F     	AND     	#0F,R0		;
003AE2 8800     	CMP/EQ  	#00,R0		;
003AE4 890A     	BT      	L003AFC		;if ((cdd_rx_data.stat & 0x0F != 0x00 &&
003AE6 8801     	CMP/EQ  	#01,R0		;
003AE8 8908     	BT      	L003AFC		;     cdd_rx_data.stat & 0x0F != 0x01 &&
003AEA 8802     	CMP/EQ  	#02,R0		;
003AEC 8906     	BT      	L003AFC		;     cdd_rx_data.stat & 0x0F != 0x02 &&
003AEE 8803     	CMP/EQ  	#03,R0		;
003AF0 8901     	BT      	L003AF6		;     cdd_rx_data.stat & 0x08 != 0x00) ||
003AF2 C808     	TST     	#08,R0		;
003AF4 8902     	BT      	L003AFC		;    cdd_rx_data.stat & 0x0F == 0x03) {
L003AF6:
003AF6 E099     	MOV     	#99,R0		;  new_state = 0x99;
003AF8 A00D     	BRA     	L003B16		;  new_status = 0x0A;
003AFA E10A     	MOV     	#0A,R1		;}
L003AFC:							;else {
003AFC 4F22     	STS.L   	PR,@-R15		;
003AFE BBB2     	BRS     	L003266		;  L003266();
003B00 0009     	NOP     				;
003B02 4F26     	LDS.L   	@R15+,PR		;
003B04 D10D     	MOV.L   	@(#034,PC),R1	;  u8 cmd[12] = {0x00,0x00,0x00,0x00,
003B06 D20E     	MOV.L   	@(#038,PC),R2	;                0x00,0x00,0x00,0x00,
003B08 D30E     	MOV.L   	@(#038,PC),R3	;                0x00,0x00,0x00,0x00};
003B0A 4F22     	STS.L   	PR,@-R15		;
003B0C B31C     	BRS     	L004148		;  make_cdd_cmd(cmd);
003B0E 0009     	NOP     				;
003B10 4F26     	LDS.L   	@R15+,PR		;
003B12 E012     	MOV     	#12,R0		;  new_state = 0x12;
003B14 E106     	MOV     	#06,R1		;  new_status = 0x06;
L003B16:							;}
003B16 C049     	MOV.B   	R0,@(#049,GBR)	;cd_state = new_state;
003B18 6013     	MOV     	R1,R0			;
003B1A C02E     	MOV.B   	R0,@(#02E,GBR)	;cd_status = new_status;
003B1C E04B     	MOV     	#4B,R0		;
003B1E CDF7     	AND.B   	#F7,@(R0,GBR)	;cd_flags2 &= ~0x08;
003B20 DB04     	MOV.L   	@(#010,PC),R11	;
003B22 C325     	TRAPA   	#37			;TRAP_37(0x06060000);
003B24 E04A     	MOV     	#4A,R0		;
003B26 CDBF     	AND.B   	#BF,@(R0,GBR)	;cd_flags &= ~0x40;
003B28 E000     	MOV     	#00,R0		;*(u32*)(0x0F00025C+0x44) = 0x00000000;
003B2A A4EE     	BRA     	L00450A		;return init_cd_status();
...
003B56 8B0A     	BF      	L003B6E		;
003B58 E10C     	MOV     	#0C,R1		;
003B5A 3102     	CMP/HS 	R0,R1			;
003B5C 8B07     	BF      	L003B6E		;
003B5E 70FC     	ADD     	#FC,R0		;
003B60 6103     	MOV     	R0,R1			;
003B62 C706     	MOVA    	@(#18,PC),R0	;
003B64 4108     	SHLL2   	R1			;
003B66 310C     	ADD     	R0,R1			;
003B68 6012     	MOV.L   	@R1,R0		;if (cd_state >= 0x04 && cd_state <= 0x0C)
003B6A 402B     	JMP     	@R0			;  return L003B7C[cd_state - 0x04]();
003B6C 0009     	NOP     				;
L003B6E:
003B6E 8821     	CMP/EQ  	#21,R0		;
003B70 8B01     	BF      	#002			;
003B72 A2AD     	BRA     	L0040D0		;else if (cd_state == 0x21) return L0040D0();
003B74 0009     	NOP     				;
003B76 000B     	RTS     				;
003B78 0009     	NOP     				;
003B7A 0009     	NOP     				;
...
003C30 C217     	MOV.L   	R0,@(#05C,GBR)	;FAD_02B8 = *(u32*)(0x0F00025C+0x44);
003C32 C214     	MOV.L   	R0,@(#050,GBR)	;FAD = *(u32*)(0x0F00025C+0x44);
003C34 E000     	MOV     	#00,R0		;
003C36 C215     	MOV.L   	R0,@(#054,GBR)	;FAD_task6 = 0;
003C38 DB0C     	MOV.L   	@(#030,PC),R11	;
003C3A C402     	MOV.B   	@(#002,GBR),R0	;
003C3C 3B0C     	ADD     	R0,R11		;
003C3E C321     	TRAPA   	#33			;add_task_to_queue(0x05060000 | *(u8*)(0x0F00025C+0x02));
003C40 E04B     	MOV     	#4B,R0		;
003C42 CF40     	OR .B   	#40,@(R0,GBR)	;cd_flags2 |= 0x40;
003C44 C402     	MOV.B   	@(#002,GBR),R0	;
003C46 8806     	CMP/EQ  	#06,R0		;
003C48 8B01     	BF      	L003C4E		;
003C4A E04B     	MOV     	#4B,R0		;if (*(u8*)(0x0F00025C+0x02) == 0x06)
003C4C CD7F     	AND.B   	#7F,@(R0,GBR)	;  cd_flags2 &= ~0x80;
L003C4E:
...
003C9A 8905     	BT      	L003CA8		;
003C9C 8801     	CMP/EQ  	#01,R0		;
003C9E 8901     	BT      	L003CA4		;
003CA0 000B     	RTS     				;
003CA2 0009     	NOP     				;
L003CA4:
...
003E20 C430     	MOV.B   	@(#030,GBR),R0	;play_ctrl_adr
...
003ED6 6903     	MOV     	R0,R9			;u32 fad = *(u32*)(0x0F00025C+0x38);
...
003EF8 B1E0     	BRS     	L0042BC		;L0042BC();
003EFA 0009     	NOP     				;
003EFC 4F26     	LDS.L   	@R15+,PR		;
003EFE E04B     	MOV     	#4B,R0		;
003F00 CC40     	TST.B   	#40,@(R0,GBR)	;
003F02 8922     	BT      	L003F4A		;
003F04 CC80     	TST.B   	#80,@(R0,GBR)	;if (cd_flags2 & 0x40 == 0 || cd_flags2 & 0x80 != 0)
003F06 8B20     	BF      	L003F4A		;  goto L003F4A;
...
003F26 CF08     	OR .B   	#08,@(R0,GBR)	;cd_flags |= 0x08;
003F28 E04B     	MOV     	#4B,R0		;
003F2A CF08     	OR .B   	#08,@(R0,GBR)	;cd_flags2 |= 0x08;
003F2C CD1B     	AND.B   	#1B,@(R0,GBR)	;cd_flags2 &= ~0xE4;
003F2E E003     	MOV     	#03,R0		;
003F30 CC40     	TST.B   	#40,@(R0,GBR)	;
003F32 8903     	BT      	#006			;
003F34 DB45     	MOV.L   	@(#114,PC),R11	;
003F36 C321     	TRAPA   	#33			;add_task_to_queue(0x05060003);
...
003F5A CF04     	OR .B   	#04,@(R0,GBR)	;  cd_flags2 |= 0x04;
...
003F6A 8902     	BT      	#004			;
003F6C D107     	MOV.L   	@(#01C,PC),R1	;  u8 cmd[12] = {0x00,0x00,0x00,0x00,
003F6E A001     	BRA     	#0002			;                0x00,0x00,0x00,0x00,
003F70 0009     	NOP     				;                0x00,0x00,0xFF,0x01};
003F72 D107     	MOV.L   	@(#01C,PC),R1	;  cmd[0] = cd_state == 0x0C ? CDD_COMM_READ : CDD_COMM_SEEK;
003F74 D207     	MOV.L   	@(#01C,PC),R2	;
003F76 D308     	MOV.L   	@(#020,PC),R3	;
003F78 791E     	ADD     	#1E,R9		;
003F7A 219B     	OR      	R9,R1			;  *((u32*)&cmd[0]) |= fad + 30;
...
004016 8903     	BT      	L004020		;if (cd_flags2 & 0x01 != 0) {
004018 CDFE     	AND.B   	#FE,@(R0,GBR)	;  cd_flags2 &= ~0x01;
00401A D10B     	MOV.L   	@(#02C,PC),R1	;
00401C E010     	MOV     	#10,R0		;
00401E 2101     	MOV.W   	R0,@R1		;  YGR.HIRQ = HIRQ_PEND;
L004020:							;}
004020 E04A     	MOV     	#4A,R0		;
004022 CC40     	TST.B   	#40,@(R0,GBR)	;
004024 8B0B     	BF      	L00403E		;if (cd_flags & 0x40 == 0) {
...
004034 0A1A     	STS     	MACL, R10		;  u32 t = (init_cd_stby ? init_cd_stby : 180) * 10000
004036 DB03     	MOV.L   	@(#00C,PC),R11	;
004038 C324     	TRAPA   	#36			;  TRAP_36(t,0x06060000);
00403A E04A     	MOV     	#4A,R0		;
00403C CF40     	OR .B   	#40,@(R0,GBR)	;  cd_flags |= 0x40;
L00403E:
00403E 000B     	RTS     				;}
004040 0009     	NOP     				;
004042 0009     	NOP     				;
...
L004148:							;void make_cdd_cmd(u8* cmd)	//cmd-R1,R2,R3
...
004156 D00C     	MOV.L   	@(#030,PC),R0	;u8 mask = 0x02;
004158 8B0C     	BF      	L004174		;if (cdd_cmd_flags & 0x20 == 0) {
00415A E000     	MOV     	#00,R0		;
00415C CC10     	TST.B   	#10,@(R0,GBR)	;
00415E 8B08     	BF      	L004172		;  if (init_cd_flags & 0x10 != 0) mask = 0x01;
004160 E04B     	MOV     	#4B,R0		;
004162 CC20     	TST.B   	#20,@(R0,GBR)	;
004164 8B02     	BF      	L00416C		;
004166 E030     	MOV     	#30,R0		;
004168 CC40     	TST.B   	#40,@(R0,GBR)	;  else if (cd_flags2 & 0x20 != 0 || 
00416A 8902     	BT      	L004172		;           *(u8*)(0x0F00025C+0x30) & 0x40 != 0) mask = 0x02;
L00416C:
00416C D006     	MOV.L   	@(#018,PC),R0	;
00416E A001     	BRA     	L004174		;  else mask = 0x01;
004170 0009     	NOP     				;}
004172 D004     	MOV.L   	@(#010,PC),R0	;cdd_cmd_flags &= ~0x20;
L004174:							;
004174 2309     	AND     	R0,R3			;cmd[10] &= mask;
004176 0412     	STC     	GBR, R4		;
004178 7468     	ADD     	#68,R4		;
00417A 2412     	MOV.L   	R1,@R4		;memcpy(cdd_comm,cmd,12);
00417C 1421     	MOV.L   	R2,@(#4,R4)		;
00417E 1432     	MOV.L   	R3,@(#8,R4)		;
004180 000B     	RTS     				;
004182 0009     	NOP     				;
004184 FFFF01FF
004188 FFFF02FF

L00418C:							;void check_and_schedule_task5()
00418C E04B     	MOV     	#4B,R0		;
00418E CC40     	TST.B   	#40,@(R0,GBR)	;
004190 8902     	BT      	L004198		;if (cd_flags2 & 0x40 != 0) {
004192 DB05     	MOV.L   	@(#014,PC),R11	;  cd_flags2 &= ~0xC0;
004194 A004     	BRA     	L0041A0		;  add_task_to_queue(0x05060003);
004196 CD3F     	AND.B   	#3F,@(R0,GBR)	;}
L004198:
004198 CC02     	TST.B   	#02,@(R0,GBR)	;
00419A 8902     	BT      	L0041A2		;else if (cd_flags2 & 0x02 != 0) {
00419C CDFD     	AND.B   	#FD,@(R0,GBR)	;  cd_flags2 &= ~0x02;
00419E DB03     	MOV.L   	@(#00C,PC),R11	;  add_task_to_queue(0x05060007);
L0041A0:							;}
...
L00420A:							;u32 get_toc_data(u8 pos)	//pos-R1
00420A D027     	MOV.L   	@(#09C,PC),R0	;
00420C 4108     	SHLL2   	R1			;
00420E 001E     	MOV.L   	@(R0,R1),R0		;
004210 000B     	RTS     				;return toc_dram_buf[pos];
004212 4109     	SHLR2   	R1			;

L004214:							;void save_toc_data(u8 pos, u32 data)	//pos-R1,data-R2
...
004304 8B26     	BF      	L004354		;if ((start_play_pos_work >> 24) != 0x01) {
...
004352 0000
L004354:
004354 C447     	MOV.B   	@(#047,GBR),R0	;else {
004356 C032     	MOV.B   	R0,@(#032,GBR)	;  play_idx = (start_play_pos_work >> 0) & 0xFF;
004358 C446     	MOV.B   	@(#046,GBR),R0	;
00435A C031     	MOV.B   	R0,@(#031,GBR)	;  play_tno = (start_play_pos_work >> 8) & 0xFF;
00435C 4F22     	STS.L   	PR,@-R15	;
00435E BF54     	BRS     	L00420A		;  u32 toc_data = get_toc_data(play_tno);
004360 610C     	EXTU.B   	R0,R1		;
004362 4F26     	LDS.L   	@R15+,PR	;
004364 6103     	MOV     	R0,R1		;  track_t* track_data = (track_t*)&toc_data;
004366 4018     	SHLL8   	R0		;
004368 4019     	SHLR8   	R0		;
00436A C20E     	MOV.L   	R0,@(#038,GBR)	;  start_play_fad = track_data.fad;
00436C E000     	MOV     	#00,R0		;
00436E C20D     	MOV.L   	R0,@(#034,GBR)	;  unknown_290 = 0;
004370 6013     	MOV     	R1,R0		;}
L004372:
004372 4029     	SHLR16  	R0		;
004374 4019     	SHLR8   	R0		;
004376 C030     	MOV.B   	R0,@(#030,GBR)	;play_ctrl_adr = track_data.ctrl_adr;
004378 E000     	MOV     	#00,R0		;
00437A C033     	MOV.B   	R0,@(#033,GBR)	;unknown_28F = 0x00;
00437C C42C     	MOV.B   	@(#02C,GBR),R0	;
00437E 8801     	CMP/EQ  	#01,R0		;
004380 8B01     	BF      	L004386		;
004382 D959     	MOV.L   	@(#164,PC),R9	;
004384 8900     	BT      	L004388		;
004386 D959     	MOV.L   	@(#164,PC),R9	;u32* buf = *(u8*)(0x0F00025C+0x2C) == 0x01 ? 0x09000218 : 0x09000224;
004388 C430     	MOV.B   	@(#030,GBR),R0	;
00438A 8092     	MOV.B   	R0,@(#02,R9)	;
00438C C431     	MOV.B   	@(#031,GBR),R0	;
00438E 8093     	MOV.B   	R0,@(#03,R9)	;buf[0] = (play_ctrl_adr << 8) | play_tno;
...
00439C 1901     	MOV.L   	R0,@(#4,R9)	;buf[1] = (play_idx << 24) | unknown_290;
00439E C60E     	MOV.L   	@(#038,GBR),R0	;
0043A0 1902     	MOV.L   	R0,@(#8,R9)	;buf[2] = start_play_fad;
0043A2 E02C     	MOV     	#2C,R0		;
0043A4 A07F     	BRA     	#00FE		;*(u8*)(0x0F00025C+0x2C) ^= 0x01;
0043A6 CE01     	XOR.B   	#01,@(R0,GBR)	;goto L0044A6;
...
00444E C030     	MOV.B   	R0,@(#030,GBR)	;play_ctrl_adr
...
0044B6 210B     	OR      	R0,R1		;u32 stat0 = (cd_status << 24) | (unknown_28F << 16) | (play_ctrl_adr << 8) | play_tno;
0044B8 C432     	MOV.B   	@(#032,GBR),R0	;
0044BA 4028     	SHLL16  	R0		;
0044BC 4018     	SHLL8   	R0		;
0044BE 6203     	MOV     	R0,R2		;u32 stat1 = (play_idx << 24);
0044C0 C444     	MOV.B   	@(#044,GBR),R0	;
0044C2 8801     	CMP/EQ  	#01,R0		;
0044C4 C611     	MOV.L   	@(#044,GBR),R0	;
0044C6 8B00     	BF      	L0044CA		;
0044C8 C60E     	MOV.L   	@(#038,GBR),R0	;
0044CA 220B     	OR      	R0,R2		;stat1 |= (start_play_pos_work >> 24) == 0x01 ? start_play_fad : start_play_pos_work;
...
0044D8 0A12     	STC     	GBR, R10	;u32* status_ptr = cd_status_buf_sel & 1 ? cd_status_buf2 : 
0044DA 30AC     	ADD     	R10,R0		;                                          cd_status_buf1;
0044DC 2012     	MOV.L   	R1,@R0		;status_ptr[0] = stat0;
0044DE 7004     	ADD     	#04,R0		;
0044E0 2022     	MOV.L   	R2,@R0		;status_ptr[1] = stat1;
0044E2 E020     	MOV     	#20,R0		;
0044E4 000B     	RTS     			;
0044E6 CE01     	XOR.B   	#01,@(R0,GBR)	;cd_status_buf_sel ^= 1;
0044E8 09000218
0044EC 09000224
0044F0 0900
0044F2 01FC

L0044F4:							;void set_cd_status()
...
0045C2 89FA     	BT      	L0045BA		;memset(0x0F000314,0,48);
0045C4 E0FF     	MOV     	#FF,R0		;
0045C6 1703     	MOV.L   	R0,@(#C,R7)		;cddata_free_block_pos = 0xFFFFFFFF;
0045C8 8170     	MOV.W   	R0,@(#00,R7)	;*(u16*)(0x0F000314+0x00) = 0xFFFF;
0045CA 8073     	MOV.B   	R0,@(#03,R7)	;*(u8*)(0x0F000314+0x03) = 0xFF;
0045CC D00E     	MOV.L   	@(#038,PC),R0	;u8 block, left;
0045CE 400B     	JSR     	@R0			;find_next_free_block(&block,&left);//L004E98
0045D0 0009     	NOP     				;
0045D2 B2EC     	BRS     	L004BAE		;L004BAE(block);//L004BAE
0045D4 0009     	NOP     				;
0045D6 D00C     	MOV.L   	@(#030,PC),R0	;
0045D8 400B     	JSR     	@R0			;find_next_free_block(&block,&left);//L004E98
0045DA 0009     	NOP     				;
...
004654 0009     	NOP     				;
004656 0009
L004658:							;task5_func_06_tbl:
	dc.l	L004924					;task5_func_06_0000_0001
	dc.l	L004928					;task5_func_06_0000_0001
	dc.l	L00492C					;task5_func_06_0002
	dc.l	L004A76					;task5_func_06_0003
	dc.l	task5_thread_loop				;
	dc.l	L004ABC					;task5_func_06_0005
	dc.l	L004930					;task5_func_06_0006
	dc.l	L004AEA					;task5_func_06_0007
	dc.l	L004934					;task5_func_06_0008
	dc.l	L0048D0					;task5_func_06_0009
...
00468E 0009     	NOP     				;
L004690: 
004690 5676     	MOV.L   	@(#18,R7),R6	;u8* block_buf = cddata_process_block_addr;
004692 760C     	ADD     	#0C,R6		;
004694 5160     	MOV.L   	@(#00,R6),R1	;u32 header = *((u32*)block_buf[12]);
004696 6013     	MOV     	R1,R0			;
004698 807A     	MOV.B   	R0,@(#0A,R7)	;cddata_mode = ((u8*)header)[3];
00469A B3B7     	BRS     	L004E0C		;u32 fad = msf2fad(header);
00469C 0009     	NOP     				;
...
0046AE B245     	BRS     	L004B3C		;reset_block_fetch();
0046B0 0009     	NOP     				;
0046B2 AF95     	BRA     	L0045E0		;goto task5_thread_loop;
0046B4 0009     	NOP     				;
L0046B6:
...
0046D2 2122     	MOV.L   	R2,@R1		;  FAD_task6 = cddata_process_block_fad;
...
004732 8063     	MOV.B   	R0,@(#03,R6)	;  block_buf[15] = *(u8*)(0x0F000314+0x07);
L004734:							;}
...
L00473C:
00473C B2DA     	BRS     	L004CF4		;get_next_free_block();
00473E 0009     	NOP     				;
...
004748 0009     	NOP     				;
00474A AF49     	BRA     	L0045E0		;goto task5_thread_loop;
00474C 0009     	NOP     				;
00474E 0009     	NOP     				;
...
004766 2212     	MOV.L   	R1,@R2		;FAD_task6 = (temp + *(u8*)(0x0F000314+0x09));
...
00478E B2B1     	BRS     	L004CF4		;get_next_free_block();
004790 0009     	NOP     				;
004792 5676     	MOV.L   	@(#18,R7),R6	;u8* block_buf = cddata_process_block_addr;
004794 760C     	ADD     	#0C,R6		;
004796 847C     	MOV.B   	@(#0C,R7),R0	;
004798 88FF     	CMP/EQ  	#FF,R0		;
00479A 8906     	BT      	L0047AA		;
00479C 847A     	MOV.B   	@(#0A,R7),R0	;
00479E 8802     	CMP/EQ  	#02,R0		;
0047A0 890C     	BT      	L0047BC		;
0047A2 8801     	CMP/EQ  	#01,R0		;
0047A4 8906     	BT      	L0047B4		;
0047A6 A01B     	BRA     	L0047E0		;
0047A8 0009     	NOP     				;
L0047AA:
0047AA 8472     	MOV.B   	@(#02,R7),R0	;if (cddata_free_block_pos == 0xFF) {
0047AC 8802     	CMP/EQ  	#02,R0		;
0047AE 89E5     	BT      	L00477C		;  if (*(u8*)(0x0F000314+0x02) == 0x02) goto L0049C6;
0047B0 A083     	BRA     	L0048BA		;  else goto L0048BA;
0047B2 0009     	NOP     				;}
L0047B4:							;switch (cddata_mode) {
0047B4 E001     	MOV     	#01,R0		;case 0x01:
0047B6 807B     	MOV.B   	R0,@(#0B,R7)	;  *(u8*)(0x0F000314+0x0B) = 0x01;
0047B8 A01C     	BRA     	L0047F4		;  mask = 0x21;
0047BA E121     	MOV     	#21,R1		;  break;
L0047BC:							;
0047BC D250     	MOV.L   	@(#140,PC),R2	;case 0x02:
0047BE 6020     	MOV.B   	@R2,R0		;
0047C0 C804     	TST     	#04,R0		;
0047C2 8B0E     	BF      	L0047E2		;  if (init_cd_flags & IFLAG_NO_MODE2_SUBHEADER == 0) {
0047C4 5161     	MOV.L   	@(#04,R6),R1	;
0047C6 5062     	MOV.L   	@(#08,R6),R0	;
0047C8 3010     	CMP/EQ 	R1,R0			;
0047CA 8B37     	BF      	L00483C		;    if (memcmp(block_buf[16],block_buf[20],4)) goto L00483C;
0047CC 4019     	SHLR8   	R0			;      
0047CE C820     	TST     	#20,R0		;
0047D0 E001     	MOV     	#01,R0		;
0047D2 8900     	BT      	#000			;
0047D4 E002     	MOV     	#02,R0		;
0047D6 807B     	MOV.B   	R0,@(#0B,R7)	;    *(u8*)(0x0F000314+0x0B) = block_buf[22] & 0x20 == 0 ? 0x01 : 0x02;
0047D8 8802     	CMP/EQ  	#02,R0		;    if (block_buf[22] & 0x20 != 0) 
0047DA 8904     	BT      	L0047E6		;       mask = *((u32*)block_buf[2348]) == 0 ? 0x20 : 0x24;
0047DC A00A     	BRA     	L0047F4		;    else mask = 0x22; goto L0047F4;
0047DE E122     	MOV     	#22,R1		;  }
0047E0 0009     	NOP     				;
L0047E2:							;default:
0047E2 A007     	BRA     	L0047F4		;  mask = 0x20; 
0047E4 E120     	MOV     	#20,R1		;  goto L0047F4;
L0047E6:							;}
0047E6 D231     	MOV.L   	@(#0C4,PC),R2	;
0047E8 326C     	ADD     	R6,R2			;
0047EA 6022     	MOV.L   	@R2,R0		;
0047EC E120     	MOV     	#20,R1		;
0047EE 2008     	TST     	R0,R0			;
0047F0 8900     	BT      	L0047F4		;
0047F2 E124     	MOV     	#24,R1		;
L0047F4:
...
00480E 8938     	BT      	L004882		;if (init_cd_flags & IFLAG_FORM2_RETRY == 0) goto L004884;
L004810:
...
004820 8B05     	BF      	L00482E		;cddata_flags & 0x08 != 0x00
004822 CB08     	OR      	#08,R0		;
004824 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags |= 0x08;
...
L004838:
004838 A032     	BRA     	L0048A0		;goto task5_thread_loop;
00483A 0009     	NOP     				;
L00483C:
...
004858 8B13     	BF      	L004882		;if (init_cd_retry & RETRY_NO != 0) goto L004884;
...
L004862:
004862 B16B     	BRS     	L004B3C		;reset_block_fetch();
004864 0009     	NOP     				;
004866 8475     	MOV.B   	@(#05,R7),R0	;
004868 CB10     	OR      	#10,R0		;
00486A 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags |= 0x10;
00486C DB8F     	MOV.L   	@(#23C,PC),R11	;*(u32*)0x0F0002B4 = *(u32*)(0x0F000314+0x2C);
00486E A041     	BRA     	L0048F4		;add_task_to_queue(0x06050000);
004870 0009     	NOP     				;goto task5_thread_loop;
L004872:
004872 B163     	BRS     	L004B3C		;reset_block_fetch();
004874 0009     	NOP     				;
004876 E000     	MOV     	#00,R0		;
004878 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags = 0x00;
00487A DB28     	MOV.L   	@(#0A0,PC),R11	;
00487C C321     	TRAPA   	#33			;add_task_to_queue(0x06050002);
00487E AEAF     	BRA     	L0045E0		;goto task5_thread_loop;
004880 0009     	NOP     				;
004882 0009     	NOP     				;
L004884:
004884 8475     	MOV.B   	@(#05,R7),R0	;
004886 C808     	TST     	#08,R0		;
004888 8B0A     	BF      	L0048A0		;if (cddata_flags & 0x08 != 0) goto task5_thread_loop;
00488A C9EF     	AND     	#EF,R0		;
00488C 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags &= ~0x10;
...
00489E 8901     	BT      	L0048A4		;if (*(u32*)(0x0F000314+0x2C) >= *(u32*)0x0F000284) goto L004A76;
L0048A0:
0048A0 AE9E     	BRA     	L0045E0		;
0048A2 0009     	NOP     				;
L0048A4:
...
L0048B0:
0048B0 B144     	BRS     	L004B3C		;reset_block_fetch();
0048B2 0009     	NOP     				;*(u32*)0x0F0002B4 = *(u32*)(0x0F000314+0x2C);
0048B4 DB1A     	MOV.L   	@(#068,PC),R11	;add_task_to_queue(0x06050004);
0048B6 A01D     	BRA     	L0048F4		;goto task5_thread_loop;
0048B8 0009     	NOP     				;
L0048BA:
0048BA D217     	MOV.L   	@(#05C,PC),R2	;
0048BC 8527     	MOV.W   	@(#0E,R2),R0	;
0048BE C9FE     	AND     	#FE,R0		;
0048C0 8127     	MOV.W   	R0,@(#0E,R2)	;SH1.DMAC.CHCR0 &= ~0x0001;
0048C2 B155     	BRS     	L004B70		;L004B70();
0048C4 0009     	NOP     				;
0048C6 8475     	MOV.B   	@(#05,R7),R0	;
0048C8 CB02     	OR      	#02,R0		;
0048CA 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags |= 0x02;
0048CC AE88     	BRA     	L0045E0		;goto task5_thread_loop;
0048CE 0009     	NOP     				;

L0048D0:							;task5_func_06_0009:
0048D0 B134     	BRS     	L004B3C		;reset_block_fetch();
0048D2 0009     	NOP     				;
0048D4 8475     	MOV.B   	@(#05,R7),R0	;
0048D6 C840     	TST     	#40,R0		;
0048D8 8901     	BT      	L0048DE		;
0048DA CB20     	OR      	#20,R0		;if (cddata_flags & 0x40 != 0)
0048DC 8075     	MOV.B   	R0,@(#05,R7)	;  cddata_flags |= 0x20;
L0048DE:
0048DE DB74     	MOV.L   	@(#1D0,PC),R11	;
0048E0 C321     	TRAPA   	#33			;add_task_to_queue(0x06050001);
0048E2 D271     	MOV.L   	@(#1C4,PC),R2	;
0048E4 6020     	MOV.B   	@R2,R0		;
0048E6 2008     	TST     	R0,R0			;
0048E8 8B02     	BF      	L0048F0		;if (*(u8*)0x0F00034B != 0)
0048EA DB73     	MOV.L   	@(#1CC,PC),R11	;  goto task5_thread_loop;
0048EC A002     	BRA     	L0048F4		;
0048EE 0009     	NOP     				;
0048F0 AE76     	BRA     	L0045E0		;
0048F2 0009     	NOP     				;
L0048F4:
0048F4 D206     	MOV.L   	@(#018,PC),R2	;
0048F6 507B     	MOV.L   	@(#2C,R7),R0	;
0048F8 2202     	MOV.L   	R0,@R2		;*(u32*)0x0F0002B4 = *(u32*)(0x0F000314+0x2C);
0048FA C321     	TRAPA   	#33			;add_task_to_queue(0x06040000);
0048FC AE70     	BRA     	L0045E0		;goto task5_thread_loop;
0048FE 0009     	NOP     				;
004900 0F00025C
004904 0F000263
004908 0F000262
...
L004924:							;
004924 A008     	BRA     	L004938		;
004926 0009     	NOP     				;
L004928:							;
004928 A006     	BRA     	L004938		;
00492A 0009     	NOP     				;
L00492C:							;
00492C A010     	BRA     	L004950		;
00492E 0009     	NOP     				;
L004930:							;
004930 A009     	BRA     	L004946		;
004932 0009     	NOP     				;
L004934:							;
004934 A00E     	BRA     	L004954		;
004936 0009     	NOP     				;

L004938:							;task5_func_06_0000_0001:
004938 8475     	MOV.B   	@(#05,R7),R0	;
00493A C840     	TST     	#40,R0		;
00493C 8901     	BT      	#002			;if (cddata_flags & 0x40 != 0)
00493E B0FD     	BRS     	L004B3C		;  reset_block_fetch();
004940 0009     	NOP     				;
004942 E040     	MOV     	#40,R0		;
004944 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags = 0x40;

L004946:							;task5_func_06_0006:
004946 8475     	MOV.B   	@(#05,R7),R0	;
004948 C9DF     	AND     	#DF,R0		;
00494A 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags &= 0xDF;
00494C E000     	MOV     	#00,R0		;
00494E 8078     	MOV.B   	R0,@(#08,R7)	;cddata_retry_cnt = 0x00;

L004950:							;task5_func_06_0002:
004950 E000     	MOV     	#00,R0		;
004952 8079     	MOV.B   	R0,@(#09,R7)	;*(u8*)(0x0F000314+0x09) = 0x00;

L004954:							;task5_func_06_0008:
004954 8475     	MOV.B   	@(#05,R7),R0	;
004956 C9FD     	AND     	#FD,R0		;
004958 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags &= 0xDF;
00495A D24E     	MOV.L   	@(#138,PC),R2	;
00495C 6122     	MOV.L   	@R2,R1		;
00495E 1717     	MOV.L   	R1,@(#1C,R7)	;*(u32*)(0x0F000314+0x1C) = FAD_02B8;
004960 171B     	MOV.L   	R1,@(#2C,R7)	;*(u32*)(0x0F000314+0x2C) = FAD_02B8;
004962 D24E     	MOV.L   	@(#138,PC),R2	;
004964 4100     	SHLL    	R1			;
004966 0018     	SETT    				;
004968 4125     	ROTCR   	R1			;
00496A 2212     	MOV.L   	R1,@R2		;FAD = FAD_02B8 | 0x80000000;
00496C D24E     	MOV.L   	@(#138,PC),R2	;
00496E 6020     	MOV.B   	@R2,R0		;
004970 2008     	TST     	R0,R0			;
004972 8B1F     	BF      	L0049B4		;if (*(u8*)0x0F00034B == 0) {
004974 B1BE     	BRS     	L004CF4		;  get_next_free_block();
004976 0009     	NOP     				;
004978 847C     	MOV.B   	@(#0C,R7),R0	;
00497A 88FF     	CMP/EQ  	#FF,R0		;
00497C 8923     	BT      	L0049C6		;  if (data_free_block_pos == 0xFF) goto L0049C6;
00497E B1A4     	BRS     	L004CCA		;  L004CCA():
004980 0009     	NOP     				;
004982 E001     	MOV     	#01,R0		;
004984 8074     	MOV.B   	R0,@(#04,R7)	;  cddata_state = 0x01;
004986 D2EF     	MOV.L   	@(#3BC,PC),R2	;
004988 E000     	MOV     	#00,R0		;
00498A 2201     	MOV.W   	R0,@R2		;  cdirq0_state = 0x00;
00498C D3EE     	MOV.L   	@(#3B8,PC),R3	;  cdirq1_state = 0x00;
00498E E000     	MOV     	#00,R0		;
004990 8131     	MOV.W   	R0,@(#02,R3)	;  YGR.CDIRQU = 0x0000;
004992 E010     	MOV     	#10,R0		;
004994 8133     	MOV.W   	R0,@(#06,R3)	;  YGR.CDMSKU = 0x0010;
004996 E102     	MOV     	#02,R1		;
004998 E2F8     	MOV     	#F8,R2		;
00499A E9F0     	MOV     	#F0,R9		;
00499C 699C     	EXTU.B   	R9,R9			;
00499E D4EB     	MOV.L   	@(#3AC,PC),R4	;
0049A0 0A02     	STC     	SR, R10		;  //save SR
0049A2 29AB     	OR      	R10,R9		;
0049A4 490E     	LDC     	R9,SR			;  SH1.SR |= 0x000000F0;
0049A6 8541     	MOV.W   	@(#02,R4),R0	;
0049A8 2029     	AND     	R2,R0			;
0049AA 201B     	OR      	R1,R0			;
0049AC 8141     	MOV.W   	R0,@(#02,R4)	;  YGR.REG1A = (YGR.REG1A & ~0x0007) | 0x0002;
0049AE 4A0E     	LDC     	R10,SR		;  //restore SR
0049B0 AE16     	BRA     	L0045E0		;  goto task5_thread_loop;
0049B2 0009     	NOP     				;}
L0049B4:
0049B4 B0C2     	BRS     	L004B3C		;reset_block_fetch();
0049B6 0009     	NOP     				;
0049B8 8475     	MOV.B   	@(#05,R7),R0	;
0049BA CB20     	OR      	#20,R0		;
0049BC 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags |= 0x20;
0049BE DB3D     	MOV.L   	@(#0F4,PC),R11	;
0049C0 C321     	TRAPA   	#33			;add_task_to_queue(0x06040001);
0049C2 AE0D     	BRA     	L0045E0		;goto task5_thread_loop;
0049C4 0009     	NOP     				;
L0049C6:
0049C6 D238     	MOV.L   	@(#0E0,PC),R2	;
0049C8 6020     	MOV.B   	@R2,R0		;
0049CA 88FF     	CMP/EQ  	#FF,R0		;
0049CC 8904     	BT      	L0049D8		;if (*(u8*)0x0F00034B != 0xFF) {
0049CE E0FF     	MOV     	#FF,R0		;
0049D0 2200     	MOV.B   	R0,@R2		;  *(u8*)0x0F00034B = 0xFF;
0049D2 D3DE     	MOV.L   	@(#378,PC),R3	;
0049D4 E008     	MOV     	#08,R0		;
0049D6 8133     	MOV.W   	R0,@(#06,R3)	;  YGR.HIRQ = HIRQ_BFUL;
L0049D8:							;}
0049D8 8475     	MOV.B   	@(#05,R7),R0	;
0049DA C840     	TST     	#40,R0		;
0049DC 8901     	BT      	L0049E2		;if (cddata_flags & 0x40 != 0) {
0049DE DB35     	MOV.L   	@(#0D4,PC),R11	;
0049E0 C321     	TRAPA   	#33			;  add_task_to_queue(0x06040001);
L0049E2:							;}
0049E2 ADFD     	BRA     	L0045E0		;goto task5_thread_loop;
0049E4 0009     	NOP     				;
...
L004A76:							;void task5_func_06_0003()
004A76 B061     	BRS     	L004B3C		;reset_block_fetch();
004A78 0009     	NOP     				;
004A7A E000     	MOV     	#00,R0		;
004A7C 8075     	MOV.B   	R0,@(#05,R7)	;cddata_flags = 0x00;
004A7E DB0C     	MOV.L   	@(#030,PC),R11	;
004A80 C321     	TRAPA   	#33			;add_task_to_queue(0x06050001);
004A82 ADAD     	BRA     	L0045E0		;goto task5_thread_loop;
004A84 0009     	NOP     				;
004A86 0009     	NOP     				;
004A88 0F000314
004A8C 0F00025C
...
004AE6 AD7B     	BRA     	L0045E0		;goto task5_thread_loop;
004AE8 0009     	NOP     				;

L004AEA:							;task5_func_06_0007:
004AEA D397     	MOV.L   	@(#25C,PC),R3	;
004AEC 8531     	MOV.W   	@(#02,R3),R0	;
004AEE C9DF     	AND     	#DF,R0		;
004AF0 8131     	MOV.W   	R0,@(#02,R3)	;YGR.CDIRQU &= ~0x0020;
004AF2 8533     	MOV.W   	@(#06,R3),R0	;
004AF4 C9DF     	AND     	#DF,R0		;
004AF6 8133     	MOV.W   	R0,@(#06,R3)	;YGR.CDMSKU &= ~0x0020;
004AF8 D292     	MOV.L   	@(#248,PC),R2	;
004AFA E000     	MOV     	#00,R0		;
004AFC 8021     	MOV.B   	R0,@(#01,R2)	;timer_state = 0x00;
004AFE AD6F     	BRA     	L0045E0		;goto task5_thread_loop;
004B00 0009     	NOP     				;
004B02 0009     	NOP     				;
004B04 0F00
004B06 06EC
...
L004B3C:							;void reset_block_fetch()
004B3C 4F22     	STS.L   	PR,@-R15		;
004B3E D284     	MOV.L   	@(#210,PC),R2	;
004B40 8527     	MOV.W   	@(#0E,R2),R0	;
004B42 C9FE     	AND     	#FE,R0		;
004B44 8127     	MOV.W   	R0,@(#0E,R2)	;SH1.DMAC.CHCR0 &= ~0x0001;
004B46 B013     	BRS     	L004B70		;disable_block_detected_irq();
004B48 0009     	NOP     				;
004B4A 8475     	MOV.B   	@(#05,R7),R0	;
004B4C C808     	TST     	#08,R0		;
004B4E 8908     	BT      	L004B62		;if (cddata_flags & 0x08 != 0) {
004B50 C9F7     	AND     	#F7,R0		;
004B52 8075     	MOV.B   	R0,@(#05,R7)	;  cddata_flags &= ~0x08;
004B54 C804     	TST     	#04,R0		;
004B56 8904     	BT      	L004B62		;  if (cddata_flags & 0x04 != 0) {
004B58 C9FB     	AND     	#FB,R0		;
004B5A 8075     	MOV.B   	R0,@(#05,R7)	;    cddata_flags &= ~0x04;
004B5C DB81     	MOV.L   	@(#204,PC),R11	;
004B5E C328     	TRAPA   	#40			;    TRAP_40(0x01050000);
004B60 D770     	MOV.L   	@(#1C0,PC),R7	;}}
L004B62:
004B62 B054     	BRS     	L004C0E		;release_blocks_upto_2();
004B64 0009     	NOP     				;
004B66 E000     	MOV     	#00,R0		;
004B68 8074     	MOV.B   	R0,@(#04,R7)	;cddata_state = 0x00;
004B6A 4F26     	LDS.L   	@R15+,PR		;
004B6C 000B     	RTS     				;
004B6E 0009     	NOP     				;

L004B70:							;void disable_block_detected_irq()
004B70 D375     	MOV.L   	@(#1D4,PC),R3	;
004B72 D476     	MOV.L   	@(#1D8,PC),R4	;
004B74 8533     	MOV.W   	@(#06,R3),R0	;
004B76 C9EF     	AND     	#EF,R0		;
004B78 8133     	MOV.W   	R0,@(#06,R3)	;YGR.CDMASKU &= ~0x0010;
...
004B8C 8141     	MOV.W   	R0,@(#02,R4)	;YGR.REG1A &= ~0x0007;
004B8E 4A0E     	LDC     	R10,SR		;//restore SR
004B90 D26C     	MOV.L   	@(#1B0,PC),R2	;
004B92 E000     	MOV     	#00,R0		;
004B94 2200     	MOV.B   	R0,@R2		;timer_state = 0x00;
004B96 000B     	RTS     				;
004B98 0009     	NOP     				;
...
L004BAE:							;(u8 block)	//block-R1
004BAE D75D     	MOV.L   	@(#174,PC),R7	;
004BB0 601E     	EXTS.B   	R1,R0			;
004BB2 88FF     	CMP/EQ  	#FF,R0		;
004BB4 890F     	BT      	L004BD6		;if (block == 0xFF) return;
004BB6 D85C     	MOV.L   	@(#170,PC),R8	;
004BB8 8472     	MOV.B   	@(#02,R7),R0	;
004BBA 8800     	CMP/EQ  	#00,R0		;
004BBC 8B03     	BF      	L004BC6		;if (cddata_block_taken == 0x00) {
004BBE 601C     	EXTU.B   	R1,R0			;
004BC0 8070     	MOV.B   	R0,@(#00,R7)	;  cddata_block_next = block;
004BC2 A003     	BRA     	L004BCC		;
004BC4 0009     	NOP     				;} else {
L004BC6:
004BC6 8471     	MOV.B   	@(#01,R7),R0	;  u8 n = *(u8*)(0x0F000314+0x01);
004BC8 600C     	EXTU.B   	R0,R0			;
004BCA 0814     	MOV.B   	R1,@(R0,R8)		;  block_chain[n] = block;
L004BCC:							;}
004BCC 601C     	EXTU.B   	R1,R0			;
004BCE 8071     	MOV.B   	R0,@(#01,R7)	;*(u8*)(0x0F000314+0x01) = block;
004BD0 8472     	MOV.B   	@(#02,R7),R0	;
004BD2 7001     	ADD     	#01,R0		;
004BD4 8072     	MOV.B   	R0,@(#02,R7)	;cddata_block_taken++;
L004BD6:
004BD6 000B     	RTS     				;
004BD8 0009     	NOP     				;

L004BDA:							;u8 get_next_taken_block()
004BDA D752     	MOV.L   	@(#148,PC),R7	;
004BDC E1FF     	MOV     	#FF,R1		;
004BDE 8472     	MOV.B   	@(#02,R7),R0	;
004BE0 8800     	CMP/EQ  	#00,R0		;
004BE2 8912     	BT      	L004C0A		;if (cddata_block_taken == 0) return 0;
004BE4 D850     	MOV.L   	@(#140,PC),R8	;
004BE6 70FF     	ADD     	#FF,R0		;
004BE8 620C     	EXTU.B   	R0,R2			;
004BEA 8072     	MOV.B   	R0,@(#02,R7)	;cddata_block_taken--;
004BEC 8470     	MOV.B   	@(#00,R7),R0	;
004BEE 610C     	EXTU.B   	R0,R1			;u8 block = cddata_block_next;
004BF0 2228     	TST     	R2,R2			;
004BF2 8B04     	BF      	L004BFE		;if (cddata_block_taken == 0) {
004BF4 E0FF     	MOV     	#FF,R0		;
004BF6 8070     	MOV.B   	R0,@(#00,R7)	;  cddata_block_next = 0xFF;
...
004C02 8070     	MOV.B   	R0,@(#00,R7)	;  cddata_block_next = block_chain[block];
L004C04:
004C04 601C     	EXTU.B   	R1,R0			;
004C06 E3FF     	MOV     	#FF,R3		;
004C08 0834     	MOV.B   	R3,@(R0,R8)		;block_chain[block] = 0xFF;
L004C0A:
004C0A 000B     	RTS     				;return block;
004C0C 0009     	NOP     				;

L004C0E:							;void release_blocks_upto_2()
004C0E 4F22     	STS.L   	PR,@-R15		;
004C10 8472     	MOV.B   	@(#02,R7),R0	;
004C12 E102     	MOV     	#02,R1		;
004C14 600C     	EXTU.B   	R0,R0			;
004C16 3016     	CMP/HI 	R1,R0			;
004C18 8B0F     	BF      	L004C3A		;if (cddata_block_taken > 0x02) {
004C1A DB50     	MOV.L   	@(#140,PC),R11	;
004C1C C32A     	TRAPA   	#42			;  TRAP_42(0x0B050000);
004C1E D741     	MOV.L   	@(#104,PC),R7	;
L004C20:							;  do {
004C20 BFDB     	BRS     	L004BDA		;    u8 block = get_next_taken_block();
004C22 0009     	NOP     				;
004C24 D043     	MOV.L   	@(#10C,PC),R0	;
004C26 400B     	JSR     	@R0			;    release_taken_block(block);
004C28 0009     	NOP     				;
...
004C34 89F4     	BT      	L004C20		;  } while (cddata_block_taken > 0x02);
004C36 DB49     	MOV.L   	@(#124,PC),R11	;
004C38 C327     	TRAPA   	#39			;  TRAP_39(0x0B050000);
L004C3A:							;}
004C3A D292     	MOV.L   	@(#248,PC),R2	;
004C3C E000     	MOV     	#00,R0		;
004C3E 1200     	MOV.L   	R0,@(#0,R2)		;memset(0x0F0006A0,0,26);
...
004C5C 8B2D     	BF      	L004CBA		;if (cddata_block_taken <= 0x02) return;
004C5E DB3F     	MOV.L   	@(#0FC,PC),R11	;
004C60 C32A     	TRAPA   	#42			;TRAP_42(0x0B050000);
...
004C72 0009     	NOP     				;}
L004C74:
004C74 BFB1     	BRS     	L004BDA		;u8 temp = L004BDA();
004C76 0009     	NOP     				;
004C78 8073     	MOV.B   	R0,@(#03,R7)	;*(u8*)(0x0F000314+0x03) = temp;
004C7A E280     	MOV     	#80,R2		;
004C7C D02F     	MOV.L   	@(#0BC,PC),R0	;
004C7E 400B     	JSR     	@R0			;L004FA4(0x80);
004C80 0009     	NOP     				;
...
004C9C B0B6     	BRS     	L004E0C		;u32 fad = msf2fad(header);
004C9E 0009     	NOP     				;
...
004CA6 4100     	SHLL    	R1			;
004CA8 0018     	SETT    				;
004CAA 4125     	ROTCR   	R1			;
004CAC 2212     	MOV.L   	R1,@R2		;FAD = fad | 0x80000000;
...
L004CF4:							;get_next_free_block()
004CF4 4F22     	STS.L   	PR,@-R15		;
004CF6 DB19     	MOV.L   	@(#064,PC),R11	;
004CF8 C32A     	TRAPA   	#39			;TRAP_39(0x0B050000);
004CFA D00D     	MOV.L   	@(#034,PC),R0	;u8 block,left;
004CFC 400B     	JSR     	@R0			;find_next_free_block(&block,&left);//L004E98
004CFE 0009     	NOP     				;
...
004D80 C321     	TRAPA   	#33			;  add_task_to_queue(0x05810030);
...
004DA4 6D03     	MOV     	R0,R13		;*rr3 = val << 8; *rr4 = 0x0000;
...
L004E0C:							;u32 msf2fad(u32 header)	//header-R1, return-R1
...
L004E3E:							;u32 fad2msf(u32 fad)//fad-R1,ret-R1
004E3E C715     	MOVA    	@(#54,PC),R0	;
004E40 E200     	MOV     	#00,R2		;
004E42 6403     	MOV     	R0,R4			;const u32 d[7] = {0,1,10,75,750,4500,45000};
004E44 E306     	MOV     	#06,R3		;u32 msf = 0;
L004E46:
004E46 6041     	MOV.W   	@R4,R0		;for (int i=0; i<7; i++) {
004E48 74FE     	ADD     	#FE,R4		;
004E4A 600D     	EXTU.W   	R0,R0			;  u32 temp = d[i];
004E4C 4008     	SHLL2   	R0			;
004E4E 4000     	SHLL    	R0			;
004E50 3102     	CMP/HS 	R0,R1			;
004E52 8B00     	BF      	#000			;
004E54 3108     	SUB     	R0,R1			;  if (fad >= temp<<3) {fad -= temp<<3; msf |= 1;}
004E56 4224     	ROTCL   	R2			;  msf <<= 1;
004E58 4001     	SHLR    	R0			;
004E5A 3102     	CMP/HS 	R0,R1			;
004E5C 8B00     	BF      	#000			;
004E5E 3108     	SUB     	R0,R1			;  if (fad >= temp<<2) {fad -= temp<<2; msf |= 1;}
004E60 4224     	ROTCL   	R2			;  msf <<= 1;
004E62 4001     	SHLR    	R0			;
004E64 3102     	CMP/HS 	R0,R1			;
004E66 8B00     	BF      	#000			;
004E68 3108     	SUB     	R0,R1			;  if (fad >= temp<<1) {fad -= temp<<1; msf |= 1;}
004E6A 4224     	ROTCL   	R2			;  msf <<= 1;
004E6C 4001     	SHLR    	R0			;
004E6E 3102     	CMP/HS 	R0,R1			;
004E70 8B00     	BF      	#000			;
004E72 3108     	SUB     	R0,R1			;  if (fad >= temp<<0) {fad -= temp<<0; msf |= 1;}
004E74 4224     	ROTCL   	R2			;  msf <<= 1;
004E76 73FF     	ADD     	#FF,R3		;
004E78 4315     	CMP/PL  	R3			;
004E7A 89E4     	BT      	L004E46		;}
004E7C 6123     	MOV     	R2,R1			;
004E7E 000B     	RTS     				;return msf;
004E80 0009     	NOP     				;
004E82 0009     	NOP     				;
004E84 0F0006A0
004E88 0000
...
L004E98:							;void find_next_free_block(u8* block,u8* left)	//block-R1,left-R2
004E98 D7F0     	MOV.L   	@(#3C0,PC),R7	;
004E9A D9F1     	MOV.L   	@(#3C4,PC),R9	;
004E9C 8472     	MOV.B   	@(#02,R7),R0	;u8 n = free_block_next;
004E9E 8800     	CMP/EQ  	#00,R0		;
004EA0 8913     	BT      	L004ECA		;if (free_block_left != 0)
004EA2 70FF     	ADD     	#FF,R0		;  free_block_left--;
004EA4 8072     	MOV.B   	R0,@(#02,R7)	;  
004EA6 620C     	EXTU.B   	R0,R2			;  *left = free_block_left;
004EA8 8470     	MOV.B   	@(#00,R7),R0	;
004EAA 610C     	EXTU.B   	R0,R1			;  *block = free_block_next;
004EAC 2228     	TST     	R2,R2			;
004EAE 8B04     	BF      	L004EBA		;  if (free_block_left == 0) {
004EB0 E0FF     	MOV     	#FF,R0		;
004EB2 8070     	MOV.B   	R0,@(#00,R7)	;    free_block_next = 0xFF;
...
004EBE 8070     	MOV.B   	R0,@(#00,R7)	;    free_block_next = block_chain[n];
L004EC0:
004EC0 601C     	EXTU.B   	R1,R0			;  }
004EC2 E3FF     	MOV     	#FF,R3		;
004EC4 0934     	MOV.B   	R3,@(R0,R9)		;  block_chain[n] = 0xFF;
004EC6 000B     	RTS     				;  return;
004EC8 0009     	NOP     				;}
L004ECA:
004ECA 620C     	EXTU.B   	R0,R2			;*arg2 = free_block_left;
004ECC E0FF     	MOV     	#FF,R0		;
004ECE 610C     	EXTU.B   	R0,R1			;*block = 0xFF;
004ED0 000B     	RTS     				;
004ED2 0009     	NOP     				;

L004ED4:							;void release_taken_block(u8 block)//block-R1
004ED4 D7E1     	MOV.L   	@(#384,PC),R7	;
004ED6 D9E2     	MOV.L   	@(#388,PC),R9	;
004ED8 601E     	EXTS.B   	R1,R0			;
004EDA 88FF     	CMP/EQ  	#FF,R0		;
004EDC 890C     	BT      	L004EF8		;if (block == 0xFF) return;
004EDE 8472     	MOV.B   	@(#02,R7),R0	;
004EE0 600C     	EXTU.B   	R0,R0			;
004EE2 7001     	ADD     	#01,R0		;
004EE4 8072     	MOV.B   	R0,@(#02,R7)	;free_block_left++;
004EE6 8801     	CMP/EQ  	#01,R0		;
004EE8 8908     	BT      	L004EFC		;if (free_block_left != 1) {
004EEA 8471     	MOV.B   	@(#01,R7),R0	;
004EEC 600C     	EXTU.B   	R0,R0			;  u8 n = *(u8*)(0x0F000348+0x01);
004EEE 0914     	MOV.B   	R1,@(R0,R9)		;  block_chain[n] = block;
...
004EFA 0009     	NOP     				;
L004EFC:
004EFC 022A     	STS     	PR, R2		;else {
004EFE B17C     	BRS     	L0051FA		;  L0051FA();
004F00 0009     	NOP     				;
004F02 422A     	LDS     	R2,PR			;
004F04 601C     	EXTU.B   	R1,R0			;  free_block_next = block;
004F06 8070     	MOV.B   	R0,@(#00,R7)	;}
004F08 AFF3     	BRA     	L004EF2		;*(u8*)(0x0F000348+0x01) = block;
004F0A 0009     	NOP     				;block_chain[block] = 0xFF;
...
L004FA4:							;int (u8 block,u8 arg2)
004FA4 4F22     	STS.L   	PR,@-R15		;
004FA6 D7AD     	MOV.L   	@(#2B4,PC),R7	;0F000348
004FA8 2F16     	MOV.L   	R1,@-R15		;
004FAA B15B     	BRS     	L005264		;int num = L005264(block,arg2,0);
004FAC 0009     	NOP     				;
004FAE 61F6     	MOV.L   	@R15+,R1		;
004FB0 88FF     	CMP/EQ  	#FF,R0		;
004FB2 8B05     	BF      	L004FC0		;if (num == -1 || num > 24) {
L004FB4:
004FB4 BF8E     	BRS     	L004ED4		;  release_taken_block(block);
004FB6 0009     	NOP     				;
004FB8 E0FF     	MOV     	#FF,R0		;
004FBA 620C     	EXTU.B   	R0,R2			;  *ret = 0xFF;
004FBC A043     	BRA     	L005046		;  return -1;
004FBE 0009     	NOP     				;}
L004FC0:
...
004FD2 4000     	SHLL    	R0			;
004FD4 380C     	ADD     	R0,R8			;partition_data* pd = partition_data_array[num];
004FD6 8482     	MOV.B   	@(#02,R8),R0	;
004FD8 600C     	EXTU.B   	R0,R0			;
004FDA 7001     	ADD     	#01,R0		;
004FDC 8082     	MOV.B   	R0,@(#02,R8)	;pd->size++;
004FDE 8801     	CMP/EQ  	#01,R0		;
004FE0 8B03     	BF      	L004FEA		;
004FE2 601C     	EXTU.B   	R1,R0			;if (pd->size == 1)
004FE4 8080     	MOV.B   	R0,@(#00,R8)	;  pd->first = block;
004FE6 A004     	BRA     	L004FF2		;
004FE8 0009     	NOP     				;
L004FEA:
004FEA 8481     	MOV.B   	@(#01,R8),R0	;
004FEC 600C     	EXTU.B   	R0,R0			;else
004FEE 0914     	MOV.B   	R1,@(R0,R9)		;  block_chain[pd->last] = block;
004FF0 601C     	EXTU.B   	R1,R0			;
L004FF2:
004FF2 8081     	MOV.B   	R0,@(#01,R8)	;pd->last = block;
004FF4 E3FF     	MOV     	#FF,R3		;
004FF6 0934     	MOV.B   	R3,@(R0,R9)		;block_chain[block] = 0xFF;
004FF8 8483     	MOV.B   	@(#03,R8),R0	;
004FFA C803     	TST     	#03,R0		;
004FFC 890F     	BT      	L00501E		;if (pd->m3 & 3) {
004FFE 8483     	MOV.B   	@(#03,R8),R0	;
005000 C801     	TST     	#01,R0		;
005002 8901     	BT      	L005008		;
005004 DB16     	MOV.L   	@(#058,PC),R11	;  if (pd->m3 & 1)
005006 C321     	TRAPA   	#33			;    add_task_to_queue(0x07040000);
L005008:
...
005014 2302     	MOV.L   	R0,@R3		;  *(u32*)0x0F00034C--;
005016 8800     	CMP/EQ  	#00,R0		;
005018 8B01     	BF      	L00501E		;
00501A DB12     	MOV.L   	@(#048,PC),R11	;  if (*(u32*)0x0F00034C == 0)
00501C C321     	TRAPA   	#33			;    add_task_to_queue(0x07040001);
L00501E:							;}
...
005040 C321     	TRAPA   	#33			;add_task_to_queue(0x06040001);
005042 0009     	NOP     				;
005044 0009     	NOP     				;
L005046:
...
L00506C:							;u8 get_abs_block_pos(u8 bufno,u8 spos)//bufno-R1,spos-R2,ret-R1
...
005076 891C     	BT      	L0050B2		;if (bufno >= 24) return 0xFF;
005078 4000     	SHLL    	R0			;
00507A 380C     	ADD     	R0,R8			;
00507C 4000     	SHLL    	R0			;
00507E 380C     	ADD     	R0,R8			;partition_data* pd = &partition_data_array[bufno];
005080 8482     	MOV.B   	@(#02,R8),R0	;
005082 630C     	EXTU.B   	R0,R3			;
005084 8800     	CMP/EQ  	#00,R0		;
005086 8914     	BT      	L0050B2		;if (pd->size == 0) return 0xFF;
005088 602E     	EXTS.B   	R2,R0			;
00508A 88FF     	CMP/EQ  	#FF,R0		;
00508C 8B01     	BF      	L005092		;
00508E 623C     	EXTU.B   	R3,R2			;
005090 72FF     	ADD     	#FF,R2		;u8 pos = (spos != 0xFF) ? spos : pd->size - 1;
005092 2228     	TST     	R2,R2			;
005094 8910     	BT      	L0050B8		;if (pos == 0) return pd->first;
005096 7201     	ADD     	#01,R2		;
005098 3230     	CMP/EQ 	R3,R2			;
00509A 8910     	BT      	L0050BE		;else if (pos + 1 == pd->size) return pd->last;
00509C 3236     	CMP/HI 	R3,R2			;
00509E 8908     	BT      	L0050B2		;else if (pos + 1 > pd->size) return 0xFF;
0050A0 72FF     	ADD     	#FF,R2		;
0050A2 6C2C     	EXTU.B   	R2,R12		;
0050A4 4F22     	STS.L   	PR,@-R15		;
0050A6 B2AB     	BRS     	L005600		;else return move_to_block(pd,pos);
0050A8 0009     	NOP     				;
...
L0050CA:							;int (u8 bufno,u8 arg2,u8 arg3,u8* ret1,u8* ret2)//bufno-R1,arg2-R2,arg3-R3,ret1-R1,ret2-R2
0050CA D8A2     	MOV.L   	@(#288,PC),R8	;
0050CC D964     	MOV.L   	@(#190,PC),R9	;block_chain
0050CE 601C     	EXTU.B   	R1,R0			;
0050D0 E418     	MOV     	#18,R4		;
0050D2 3042     	CMP/HS 	R4,R0			;
0050D4 8952     	BT      	L00517C		;if (bufno >= 24) return -1;
0050D6 4000     	SHLL    	R0			;
0050D8 380C     	ADD     	R0,R8			;
0050DA 4000     	SHLL    	R0			;
0050DC 380C     	ADD     	R0,R8			;partition_data* pd = &partition_data_array[bufno];
0050DE 8482     	MOV.B   	@(#02,R8),R0	;
0050E0 8800     	CMP/EQ  	#00,R0		;
0050E2 894B     	BT      	L00517C		;if (pd->size == 0) return -1;
0050E4 640C     	EXTU.B   	R0,R4			;
0050E6 602E     	EXTS.B   	R2,R0			;
0050E8 88FF     	CMP/EQ  	#FF,R0		;
0050EA 8B01     	BF      	#002			;
0050EC 624C     	EXTU.B   	R4,R2			;if (arg2 == 0xFF)
0050EE 72FF     	ADD     	#FF,R2		;  arg2 = pd->size - 1;
0050F0 603E     	EXTS.B   	R3,R0			;
0050F2 88FF     	CMP/EQ  	#FF,R0		;
0050F4 8B01     	BF      	#002			;
0050F6 634C     	EXTU.B   	R4,R3			;if (arg3 == 0xFF)
0050F8 3328     	SUB     	R2,R3			;  arg3 = pd->size - arg2;
0050FA 633C     	EXTU.B   	R3,R3			;
0050FC 622C     	EXTU.B   	R2,R2			;
0050FE 2338     	TST     	R3,R3			;
005100 893C     	BT      	L00517C		;if (arg3 == 0) return -1;
005102 6033     	MOV     	R3,R0			;
005104 302C     	ADD     	R2,R0			;
005106 3046     	CMP/HI 	R4,R0			;
005108 8938     	BT      	L00517C		;if (arg2 + arg3 > pd->size) return -1;
00510A 2228     	TST     	R2,R2			;
00510C 8B14     	BF      	L005138		;
00510E 3340     	CMP/EQ 	R4,R3			;
005110 8B12     	BF      	L005138		;if (arg2 == 0 && arg3 == pd->size) {
005112 DC4B     	MOV.L   	@(#12C,PC),R12	;
005114 633C     	EXTU.B   	R3,R3			;
005116 60C1     	MOV.W   	@R12,R0		;
005118 3038     	SUB     	R3,R0			;
00511A 2C01     	MOV.W   	R0,@R12		;  *(u16*)0x0F000350 -= arg3;
00511C 8480     	MOV.B   	@(#00,R8),R0	;
00511E 610C     	EXTU.B   	R0,R1			;  *ret1 = pd->first;
005120 8481     	MOV.B   	@(#01,R8),R0	;
005122 620C     	EXTU.B   	R0,R2			;  *ret2 = pd->last;
005124 E0FF     	MOV     	#FF,R0		;
005126 8080     	MOV.B   	R0,@(#00,R8)	;  pd->first = 0xFF;
005128 8081     	MOV.B   	R0,@(#01,R8)	;  pd->last = 0xFF;
00512A 8084     	MOV.B   	R0,@(#04,R8)	;  pd->pos = 0xFF;
00512C 8085     	MOV.B   	R0,@(#05,R8)	;  pd->curr = 0xFF;
00512E 6403     	MOV     	R0,R4			;
005130 E000     	MOV     	#00,R0		;
005132 8082     	MOV.B   	R0,@(#02,R8)	;  pd->size = 0x00;
005134 000B     	RTS     				;  return 0;
005136 0009     	NOP     				;}
L005138:
005138 4F22     	STS.L   	PR,@-R15		;
00513A B023     	BRS     	L005184		;L005184
00513C 0009     	NOP     				;
...
L0051BE:							;(u8 num,u8 arg2)//num-R1,arg2-R3
0051BE 4F22     	STS.L   	PR,@-R15		;
0051C0 BF83     	BRS     	L0050CA		;L0050CA();
0051C2 0009     	NOP     				;
0051C4 4F26     	LDS.L   	@R15+,PR		;
0051C6 601E     	EXTS.B   	R1,R0			;
0051C8 88FF     	CMP/EQ  	#FF,R0		;
0051CA 8914     	BT      	#028			;
0051CC D723     	MOV.L   	@(#08C,PC),R7	;0F000348
...
0051FE 8910     	BT      	L005222		;if (*(u8*)(0x0F000348+0x03) != 0) {
005200 E000     	MOV     	#00,R0		;
005202 8073     	MOV.B   	R0,@(#03,R7)	;  *(u8*)(0x0F000348+0x03) = 0x00;
005204 DC12     	MOV.L   	@(#048,PC),R12	;
005206 60C0     	MOV.B   	@R12,R0		;
005208 C820     	TST     	#20,R0		;
00520A 8909     	BT      	L005220		;  if (cddata_flags & 0x20 != 0) {
00520C DB0D     	MOV.L   	@(#034,PC),R11	;
00520E DC0E     	MOV.L   	@(#038,PC),R12	;
005210 60B2     	MOV.L   	@R11,R0		;
005212 4000     	SHLL    	R0			;
005214 4001     	SHLR    	R0			;
005216 2C02     	MOV.L   	R0,@R12		;    FAD_02C0 = FAD & ~0x80000000;
005218 DB0E     	MOV.L   	@(#038,PC),R11	;
00521A C321     	TRAPA   	#33			;    add_task_to_queue(0x06040000);
00521C A00E     	BRA     	L00523C		;
00521E 0009     	NOP     				;  }
005220 0009     	NOP     				;}
L005222:
005222 DC0B     	MOV.L   	@(#02C,PC),R12	;else {
005224 60C0     	MOV.B   	@R12,R0		;
005226 C802     	TST     	#02,R0		;
005228 8907     	BT      	L00523A 		;  if (cddata_flags & 0x02 != 0) {
00522A DB06     	MOV.L   	@(#018,PC),R11	;
00522C DC07     	MOV.L   	@(#01C,PC),R12	;
00522E 60B2     	MOV.L   	@R11,R0		;
005230 4000     	SHLL    	R0			;
005232 4001     	SHLR    	R0			;
005234 2C02     	MOV.L   	R0,@R12		;    FAD_02B4 = FAD & ~0x80000000;
005236 DB08     	MOV.L   	@(#020,PC),R11	;
005238 C321     	TRAPA   	#33			;    add_task_to_queue(0x06050000);
00523A 0009     	NOP     				;  }
L00523C:
00523C 000B     	RTS     				;}
00523E 0009     	NOP     				;
...
L005264:							;int (u8 sec,u8 arg2,u8* ret)	//arg1-R1,arg2-R2,ret-R1
...
005270 8B6B     	BF      	L00534A		;if (arg2 == 0xFF || arg2 & 0x1F >= 16) {*ret = 0xFF; return -1;}
005272 330C     	ADD     	R0,R3			;u8* ptr = 0x0F000690 + (arg2 & 0x0F);
...
005282 8962     	BT      	L00534A		;if (sec >= 202) {*ret = 0xFF; return -1;}
005284 D038     	MOV.L   	@(#0E0,PC),R0	;
005286 201E     	MULU.W  	R1,R0			;
005288 001A     	STS     	MACL, R0		;
00528A 330C     	ADD     	R0,R3			;
00528C 730C     	ADD     	#0C,R3		;sector_mode2_form1* sec_mode2 = cddata_dram_buf + (sec * 2352);
00528E E500     	MOV     	#00,R5		;
005290 8433     	MOV.B   	@(#03,R3),R0	;
005292 8802     	CMP/EQ  	#02,R0		;
005294 8B00     	BF      	L005298		;
005296 5531     	MOV.L   	@(#04,R3),R5	;u32 subheader = (sec_mode2->header.mode == 0x02) ? *((u32*)sec_mode2->subheader) :
L005298:							;                                                   0x00000000;
005298 6132     	MOV.L   	@R3,R1		;u32 header = *((u32*)sec_mode2->header);
00529A 6623     	MOV     	R2,R6			;
00529C 4F22     	STS.L   	PR,@-R15		;
00529E D033     	MOV.L   	@(#0CC,PC),R0	;
0052A0 400B     	JSR     	@R0			;u32 fad = msf2fad(header);
0052A2 0009     	NOP     				;
...
L0052AC:
0052AC 88FF     	CMP/EQ  	#FF,R0		;while (1) {
...
0052BE 3B0C     	ADD     	R0,R11		;  filter_connection* fc = filter_connection_array[arg2 & 0x1F];
0052C0 4008     	SHLL2   	R0			;
0052C2 3A0C     	ADD     	R0,R10		;  filter_data* fd = filter_data_array[arg2 & 0x1F];
...
0052D6 3312     	CMP/HS 	R1,R3			;  if (fd->mode & 0x40 &&
0052D8 8930     	BT      	L00533C		;      (fd->fad > fad || fad > fd->fad + fd->range))
0052DA 84A0     	MOV.B   	@(#00,R10),R0	;
L0052DC:
0052DC C80F     	TST     	#0F,R0		;
0052DE 8930     	BT      	L005342		;  if (!(fd->mode & 0x0F)) {*ret = fc->tout; return fc->tout;}
0052E0 4601     	SHLR    	R6			;
...
L00533C:
00533C 84B3     	MOV.B   	@(#03,R11),R0	;  temp = fc->fout;
...
L005370:							;void task4_init()
005370 4F22     	STS.L   	PR,@-R15		;
005372 B005     	BRS     	L005380		;task4_free_block_init();
005374 0009     	NOP     				;
005376 B01B     	BRS     	L0053B0		;task4_selector_init();
005378 0009     	NOP     				;
00537A 4F26     	LDS.L   	@R15+,PR		;
00537C 000B     	RTS     				;
00537E 0009     	NOP     				;

L005380:							;void task4_free_block_init()
...
L00538A:
00538A 0914     	MOV.B   	R1,@(R0,R9)		;u8 i=0;
00538C 7001     	ADD     	#01,R0		;  
00538E 7101     	ADD     	#01,R1		;
005390 3022     	CMP/HS 	R2,R0			;for (; i<201; i++)
005392 8BFA     	BF      	L00538A		;  block_chain[i] = i + 0x01;
005394 E1FF     	MOV     	#FF,R1		;
005396 0914     	MOV.B   	R1,@(R0,R9)		;block_chain[i] = 0xFF;
005398 D7D1     	MOV.L   	@(#344,PC),R7	;
00539A E000     	MOV     	#00,R0		;
00539C 8070     	MOV.B   	R0,@(#00,R7)	;free_block_next = 0x00;
00539E 8073     	MOV.B   	R0,@(#03,R7)	;*(u8*)(0x0F000348+0x03) = 0x00;
0053A0 1701     	MOV.L   	R0,@(#4,R7)		;*(u32*)(0x0F000348+0x04) = 0x00000000;
0053A2 8174     	MOV.W   	R0,@(#08,R7)	;*(u16*)(0x0F000348+0x08) = 0x0000;
0053A4 E0CA     	MOV     	#CA,R0		;
0053A6 8072     	MOV.B   	R0,@(#02,R7)	;free_block_left = 202;
0053A8 70FF     	ADD     	#FF,R0		;
0053AA 8071     	MOV.B   	R0,@(#01,R7)	;*(u8*)(0x0F000348+0x01) = 0xFF;
0053AC 000B     	RTS     				;
0053AE 0009     	NOP     				;

L0053B0:							;void task4_selector_init()
0053B0 E000     	MOV     	#00,R0		;
0053B2 D2CF     	MOV.L   	@(#33C,PC),R2	;
0053B4 E318     	MOV     	#18,R3		;
0053B6 1200     	MOV.L   	R0,@(#0,R2)		;for (int i=0; i<24; i++)
0053B8 1201     	MOV.L   	R0,@(#4,R2)		;  memset(&filter_data_array[i],0,sizeof(filter_data));
0053BA 1202     	MOV.L   	R0,@(#8,R2)		;
0053BC 1203     	MOV.L   	R0,@(#C,R2)		;
0053BE 7210     	ADD     	#10,R2		;
0053C0 73FF     	ADD     	#FF,R3		;
0053C2 4315     	CMP/PL  	R3			;
0053C4 89F7     	BT      	L0053B6		;
0053C6 D8C8     	MOV.L   	@(#320,PC),R8	;
0053C8 E318     	MOV     	#18,R3		;
0053CA E0FF     	MOV     	#FF,R0		;for (int i=0; i<24; i++) {
0053CC 8180     	MOV.W   	R0,@(#00,R8)	;  partition_data_array[i].first = 0xFF;
0053CE 8182     	MOV.W   	R0,@(#04,R8)	;  partition_data_array[i].last = 0xFF;
0053D0 E000     	MOV     	#00,R0		;  partition_data_array[i].pos = 0xFF;
0053D2 8181     	MOV.W   	R0,@(#02,R8)	;  partition_data_array[i].m5 = 0xFF;
0053D4 7806     	ADD     	#06,R8		;
0053D6 73FF     	ADD     	#FF,R3		;  partition_data_array[i].size = 0x00;
0053D8 4315     	CMP/PL  	R3			;  partition_data_array[i].m3 = 0x00;
0053DA 89F6     	BT      	L0053CA		;}
0053DC D2C3     	MOV.L   	@(#30C,PC),R2	;
0053DE E318     	MOV     	#18,R3		;
0053E0 E0A0     	MOV     	#A0,R0		;
0053E2 E1FF     	MOV     	#FF,R1		;for (int i=0; i<24; i++) {
0053E4 2212     	MOV.L   	R1,@R2		;  filter_connection_array[i].m0 = 0xFF;
0053E6 8022     	MOV.B   	R0,@(#02,R2)	;  filter_connection_array[i].m1 = 0xFF;
0053E8 7001     	ADD     	#01,R0		;  filter_connection_array[i].condt = 0xA0;
0053EA 7204     	ADD     	#04,R2		;  filter_connection_array[i].condf = 0xFF;
0053EC 73FF     	ADD     	#FF,R3		;}
0053EE 4315     	CMP/PL  	R3			;
0053F0 89F8     	BT      	L0053E4		;
0053F2 D2C0     	MOV.L   	@(#300,PC),R2	;
0053F4 E0FF     	MOV     	#FF,R0		;
0053F6 1200     	MOV.L   	R0,@(#0,R2)		;memset(0x0F000690,0xFF,16);
...
L005402:							;void filter_inputs_init()
005402 E500     	MOV     	#00,R5		;for (int i=0; i<24; i++)
005404 A004     	BRA     	L005410		;  selector_disconnect((0<<5) | i);
005406 0009     	NOP     				;

L005408:							;void partition_outputs_init()
005408 E520     	MOV     	#20,R5		;for (int i=0; i<24; i++)
00540A A001     	BRA     	L005410		;  selector_disconnect((1<<5) | i);
00540C 0009     	NOP     				;

L00540E:							;void filter_false_outputs_init()
00540E E560     	MOV     	#60,R5		;
005410 4F22     	STS.L   	PR,@-R15		;
005412 6653     	MOV     	R5,R6			;
005414 7618     	ADD     	#18,R6		;
005416 6153     	MOV     	R5,R1			;for (int i=0; i<24; i++)
005418 B06A     	BRS     	L0054F0		;  selector_disconnect((3<<5) | i);
00541A 0009     	NOP     				;
00541C 7501     	ADD     	#01,R5		;
00541E 3562     	CMP/HS 	R6,R5			;
005420 8BF9     	BF      	L005416		;
005422 4F26     	LDS.L   	@R15+,PR		;
005424 000B     	RTS     				;
005426 0009     	NOP     				;

L005428:							;void filter_true_outputs_init()
005428 D2B0     	MOV.L   	@(#2C0,PC),R2	;
00542A E0A0     	MOV     	#A0,R0		;
00542C E318     	MOV     	#18,R3		;for (u8 i=0; i<24; i++) 
00542E 8022     	MOV.B   	R0,@(#02,R2)	;  filter_connection_array[i].tout = 0xA0 | i;
005430 7204     	ADD     	#04,R2		;
005432 7001     	ADD     	#01,R0		;
005434 73FF     	ADD     	#FF,R3		;
005436 4315     	CMP/PL  	R3			;
005438 89F9     	BT      	L00542E		;
00543A 000B     	RTS     				;
00543C 0009     	NOP     				;
...
L00545C:							;void filter_conditions_init()
00545C D2A4     	MOV.L   	@(#290,PC),R2	;
00545E E000     	MOV     	#00,R0		;
005460 E318     	MOV     	#18,R3		;for (int i=0; i<24; i++)
005462 1200     	MOV.L   	R0,@(#0,R2)		;  memset(filter_data_array[i],0,sizeof(filter_data));
...
005470 89F7     	BT      	L005462		;
005472 000B     	RTS     				;
005474 0009     	NOP     				;

L005476:							;void partition_clear(u8 bufno)//bufno-R1
...
005482 8920     	BT      	L0054C6		;if (bufno >= 24) return;
005484 6013     	MOV     	R1,R0			;
005486 4000     	SHLL    	R0			;
005488 6203     	MOV     	R0,R2			;
00548A 4000     	SHLL    	R0			;
00548C 302C     	ADD     	R2,R0			;
00548E 380C     	ADD     	R0,R8			;partition_data* pd = &partition_data_array[bufno];
005490 8482     	MOV.B   	@(#02,R8),R0	;
005492 640C     	EXTU.B   	R0,R4			;u8 size = pd->size;
005494 8800     	CMP/EQ  	#00,R0		;
005496 8916     	BT      	L0054C6		;if (size == 0) return;
005498 8472     	MOV.B   	@(#02,R7),R0	;
00549A 650C     	EXTU.B   	R0,R5			;
00549C 8800     	CMP/EQ  	#00,R0		;
00549E 8914     	BT      	L0054CA		;if (free_block_left == 0) {
0054A0 8480     	MOV.B   	@(#00,R8),R0	;  free_block_next = pd->first;
0054A2 660C     	EXTU.B   	R0,R6			;  L0051FA();
0054A4 8471     	MOV.B   	@(#01,R7),R0	;} else
0054A6 600C     	EXTU.B   	R0,R0			;  u8 n = *(u8*)(0x0F000348+0x01);
0054A8 0964     	MOV.B   	R6,@(R0,R9)		;  block_chain[n] = pd->first;
L0054AA:							;}
0054AA 8481     	MOV.B   	@(#01,R8),R0	;
0054AC 8071     	MOV.B   	R0,@(#01,R7)	;*(u8*)(0x0F000348+0x01) = pd->last;
0054AE 6053     	MOV     	R5,R0			;
0054B0 304C     	ADD     	R4,R0			;
0054B2 8072     	MOV.B   	R0,@(#02,R7)	;free_block_left += size;
0054B4 E000     	MOV     	#00,R0		;
0054B6 8082     	MOV.B   	R0,@(#02,R8)	;pd->size = 0x00;
0054B8 8574     	MOV.W   	@(#08,R7),R0	;
0054BA 644C     	EXTU.B   	R4,R4			;
0054BC 3048     	SUB     	R4,R0			;
0054BE 8174     	MOV.W   	R0,@(#08,R7)	;*(u16*)(0x0F000348+0x08) -= size;
0054C0 E0FF     	MOV     	#FF,R0		;
0054C2 8180     	MOV.W   	R0,@(#00,R8)	;pd->first = 0xFF;
0054C4 8182     	MOV.W   	R0,@(#04,R8)	;pd->pos = 0xFF;
L0054C6:
0054C6 000B     	RTS     				;
0054C8 0009     	NOP     				;
L0054CA:
...
0054D0 BE93     	BRS     	L0051FA		;
0054D2 0009     	NOP     				;
0054D4 4F26     	LDS.L   	@R15+,PR		;
0054D6 AFE8     	BRA     	L0054AA		;
0054D8 0009     	NOP     				;

L0054DA:							;void partitions_init()
0054DA 4F22     	STS.L   	PR,@-R15		;
0054DC E100     	MOV     	#00,R1		;
0054DE E318     	MOV     	#18,R3		;for (int i=0; i<24; i++)
0054E0 BFC9     	BRS     	L005476		;  partition_clear(i);
0054E2 0009     	NOP     				;
...
L0054F0:							;void selector_disconnect(u8 pat)	//pat-R1
0054F0 4F22     	STS.L   	PR,@-R15		;
0054F2 601E     	EXTS.B   	R1,R0			;
0054F4 88FF     	CMP/EQ  	#FF,R0		;
0054F6 8908     	BT      	L00550A		;if (pat == 0xFF) return;
0054F8 6413     	MOV     	R1,R4			;u8 conn;
0054FA B058     	BRS     	L0055AE		;get_connection(pat,&conn);
0054FC 0009     	NOP     				;
0054FE E2FF     	MOV     	#FF,R2		;
005500 B019     	BRS     	L005536		;set_connection(conn,0xFF);
005502 0009     	NOP     				;
005504 6143     	MOV     	R4,R1			;
005506 B016     	BRS     	L005536		;set_connection(pat,0xFF);
005508 0009     	NOP     				;
L00550A:
...
L005510:							;(u8 pat,u8 pat2)	//pat-R1,pat2-R2
005510 4F22     	STS.L   	PR,@-R15		;
005512 6D13     	MOV     	R1,R13		;
005514 6C23     	MOV     	R2,R12		;
005516 BFEB     	BRS     	L0054F0		;selector_disconnect(pat);
005518 0009     	NOP     				;
00551A 61C3     	MOV     	R12,R1		;
00551C BFE8     	BRS     	L0054F0		;selector_disconnect(pat2);
00551E 0009     	NOP     				;
005520 62D3     	MOV     	R13,R2		;
005522 61C3     	MOV     	R12,R1		;
005524 B007     	BRS     	L005536		;set_connection(pat2,pat);
005526 0009     	NOP     				;
005528 61D3     	MOV     	R13,R1		;
00552A 62C3     	MOV     	R12,R2		;
00552C B003     	BRS     	L005536		;set_connection(pat,pat2);
00552E 0009     	NOP     				;
005530 4F26     	LDS.L   	@R15+,PR		;
005532 000B     	RTS     				;
005534 0009     	NOP     				;

L005536:							;void set_connection(u8 pat,u8 val)	//pat-R1,val-R2
005536 602E     	EXTS.B   	R2,R0			;
005538 88FF     	CMP/EQ  	#FF,R0		;
00553A 8915     	BT      	L005568		;if (val == 0xFF) goto L005568;
00553C C9E0     	AND     	#E0,R0		;
00553E 600E     	EXTS.B   	R0,R0			;
005540 8880     	CMP/EQ  	#80,R0		;
005542 8906     	BT      	L005552		;if (val & 0xE0 == 0x80) goto L005552;
005544 88A0     	CMP/EQ  	#A0,R0		;
005546 890A     	BT      	L00555E		;
005548 C880     	TST     	#80,R0		;
00554A 8908     	BT      	L00555E		;if (valarg2 & 0xE0 == 0xA0 || val & 0x80 == 0x00) goto L00555E;
L00554C:
00554C E2FF     	MOV     	#FF,R2		;val = 0xFF;
L00554E:
...
005566 89F1     	BT      	L00554C		;if (val & 0x1F >= 0x18) val = 0xFF;
L005568:
005568 601E     	EXTS.B   	R1,R0			;
00556A 88FF     	CMP/EQ  	#FF,R0		;
00556C 8914     	BT      	L005598		;if (pat == 0xFF) return;
00556E C9E0     	AND     	#E0,R0		;
005570 600E     	EXTS.B   	R0,R0			;
005572 8880     	CMP/EQ  	#80,R0		;
005574 8912     	BT      	L00559C		;
005576 C880     	TST     	#80,R0		;
005578 8B0E     	BF      	L005598		;if (pat & 0x80 == 0x00) {
00557A 6013     	MOV     	R1,R0			;
00557C C91F     	AND     	#1F,R0		;  u8 filtno = pat & 0x1F;
00557E E318     	MOV     	#18,R3		;  u8 conn = (pat & 0x60) >> 5;
005580 3032     	CMP/HS 	R3,R0			;
005582 8909     	BT      	L005598		;  if (filtno >= 24) return -1;
005584 D359     	MOV.L   	@(#164,PC),R3	;
005586 4008     	SHLL2   	R0			;
005588 330C     	ADD     	R0,R3			;  filter_connection* fc = filter_connection_array[filtno];
00558A 6013     	MOV     	R1,R0			;
00558C C9E0     	AND     	#E0,R0		;  switch (conn) {
00558E 4009     	SHLR2   	R0			;  case 0: fc->pout = val;
005590 4009     	SHLR2   	R0			;  case 1: fc->m1 = val;
005592 4001     	SHLR    	R0			;  case 2: fc->tout = val;
005594 330C     	ADD     	R0,R3			;  case 3: fc->fout = val;
005596 2320     	MOV.B   	R2,@R3		;  }
L005598:							;
005598 000B     	RTS     				;  return;
00559A 0009     	NOP     				;}
L00559C:							; 
00559C D355     	MOV.L   	@(#154,PC),R3	;else if (pat & 0xE0 == 0x80) {
00559E 6013     	MOV     	R1,R0			;
0055A0 C91F     	AND     	#1F,R0		;  u8 n = pat & 0x1F;
0055A2 C810     	TST     	#10,R0		;
0055A4 8BF8     	BF      	L005598		;  if (n >= 16) return;
0055A6 330C     	ADD     	R0,R3			;
0055A8 2320     	MOV.B   	R2,@R3		;  *(u8*)(0x0F000690 + n) = val;
0055AA 000B     	RTS     				;  return;
0055AC 0009     	NOP     				;}

L0055AE:							;int get_connection(u8 pat,u8 *ret)	//pat-R1,ret-R1
0055AE 601E     	EXTS.B   	R1,R0			;*ret = 0xFF;
0055B0 88FF     	CMP/EQ  	#FF,R0		;
0055B2 8921     	BT      	L0055F8		;if (pat == 0xFF) return -1;
0055B4 C9E0     	AND     	#E0,R0		;
0055B6 600E     	EXTS.B   	R0,R0			;
0055B8 8880     	CMP/EQ  	#80,R0		;
0055BA 8913     	BT      	L0055E4		;
0055BC C880     	TST     	#80,R0		;
0055BE 8B1B     	BF      	L0055F8		;if (pat & 0x80 == 0) {
0055C0 6013     	MOV     	R1,R0			;
0055C2 C91F     	AND     	#1F,R0		;  u8 filtno = pat & 0x1F;
0055C4 E218     	MOV     	#18,R2		;  u8 conn = (pat & 0x60) >> 5;
0055C6 3022     	CMP/HS 	R2,R0			;
0055C8 8916     	BT      	L0055F8		;  if (filtno >= 24) return -1;
0055CA D248     	MOV.L   	@(#120,PC),R2	;
0055CC 4008     	SHLL2   	R0			;
0055CE 320C     	ADD     	R0,R2			;  filter_connection* fc = filter_connection_array[filtno];
0055D0 6013     	MOV     	R1,R0			;
0055D2 C9E0     	AND     	#E0,R0		;  switch (conn) {
0055D4 4009     	SHLR2   	R0			;  case 0: *ret = fc->pout;
0055D6 4009     	SHLR2   	R0			;  case 1: *ret = fc->m1;
0055D8 4001     	SHLR    	R0			;  case 2: *ret = fc->tout;
0055DA 320C     	ADD     	R0,R2			;  case 3: *ret = fc->fout;
0055DC 6020     	MOV.B   	@R2,R0		;  }
0055DE 610C     	EXTU.B   	R0,R1			;
0055E0 000B     	RTS     				;  return *ret;
0055E2 0009     	NOP     				;} 
L0055E4:
0055E4 D243     	MOV.L   	@(#10C,PC),R2	;else if (pat & 0xE0 == 0x80) {
0055E6 6013     	MOV     	R1,R0			;
0055E8 C91F     	AND     	#1F,R0		;  u8 n = pat & 0x1F;
0055EA C810     	TST     	#10,R0		;
0055EC 8B04     	BF      	L0055F8		;  if (n >= 16) return -1;
0055EE 320C     	ADD     	R0,R2			;
0055F0 6020     	MOV.B   	@R2,R0		;
0055F2 610C     	EXTU.B   	R0,R1			;
0055F4 000B     	RTS     				;  return (*ret = *(u8*)(0x0F000690 + n));
0055F6 0009     	NOP     				;}
L0055F8:
0055F8 E0FF     	MOV     	#FF,R0		;
0055FA 610C     	EXTU.B   	R0,R1			;
0055FC 000B     	RTS     				;return -1;
0055FE 0009     	NOP     				;

L005600:							;u8 move_to_block(partition_data *pd,u8 pos)//pd-R8,pos-R12
005600 D938     	MOV.L   	@(#0E0,PC),R9	;
005602 8484     	MOV.B   	@(#04,R8),R0	;
005604 6D03     	MOV     	R0,R13		;u8 old_pos = pd->pos;
005606 6CCC     	EXTU.B   	R12,R12		;
005608 60C3     	MOV     	R12,R0		;
00560A 8084     	MOV.B   	R0,@(#04,R8)	;pd->pos = pos;
00560C 60D3     	MOV     	R13,R0		;
00560E 88FF     	CMP/EQ  	#FF,R0		;
005610 8907     	BT      	L005622		;if (old_pos == 0xFF) 
005612 600C     	EXTU.B   	R0,R0			;  pd->curr = move_block_by_cnt(pd->first,pos);
005614 3C00     	CMP/EQ 	R0,R12		;
005616 8918     	BT      	L00564A		;else if (pos == old_pos) 
005618 7001     	ADD     	#01,R0		;  return pd->curr;
00561A 3C00     	CMP/EQ 	R0,R12		;
00561C 890E     	BT      	L00563C		;else if (pos == old_pos + 1) 
00561E 3C06     	CMP/HI 	R0,R12		;  return pd->curr = block_chain[pd->curr];
005620 8902     	BT      	L005628		;else if (pos > old_pos + 1)
L005622:							;  return pd->curr= move_block_by_cnt(pd->curr,pos - old_pos - 1);
005622 8480     	MOV.B   	@(#00,R8),R0	;
005624 A003     	BRA     	L00562E		;
005626 0009     	NOP     				;
L005628:
...
005632 B00E     	BRS     	L005652		;
005634 0009     	NOP     				;
005636 4F26     	LDS.L   	@R15+,PR		;
005638 A003     	BRA     	L005642		;
00563A 0009     	NOP     				;
L00563C:
...
L005652:							;u8 move_block_by_cnt(u8 start,u8 cnt)//start-R0,cnt-R12
005652 D924     	MOV.L   	@(#090,PC),R9	;
005654 600C     	EXTU.B   	R0,R0			;
005656 2CC8     	TST     	R12,R12		;
005658 893E     	BT      	L0056D8		;if (cnt == 0) return start;
L00565A:
00565A ED19     	MOV     	#19,R13		;u8 n = start;
00565C 3CD6     	CMP/HI 	R13,R12		;for (int i=0; i<cnt; i++)
00565E 8905     	BT      	L00566C		;  n = block_chain[n];
005660 DD1E     	MOV.L   	@(#078,PC),R13	;
005662 4C08     	SHLL2   	R12			;
005664 3DC8     	SUB     	R12,R13		;
005666 EC00     	MOV     	#00,R12		;
005668 4D2B     	JMP     	@R13			;
00566A 0009     	NOP     				;return n;
L00566C:
...
L0056F8:							;task4_thread()
0056F8 D922     	MOV.L   	@(#088,PC),R9	;
0056FA 490B     	JSR     	@R9			;task4_init();	//L005370
0056FC 0009     	NOP     				;
0056FE B047     	BRS     	L005790		;task4_command_init();
005700 0009     	NOP     				;
L005702:							;task4_thread_loop:
005702 C323     	TRAPA   	#35			;handle_t handle; handle.h = switch_task();
...
005710 2122     	MOV.L   	R2,@R1		;memcpy(command_param,set_command_param,8);
005712 D01E     	MOV.L   	@(#078,PC),R0	;
005714 400B     	JSR     	@R0			;clear_selector_param();
005716 0009     	NOP     				;
...
005724 8903     	BT      	L00572E		;
005726 8807     	CMP/EQ  	#07,R0		;
005728 8920     	BT      	L00576C		;
00572A AFEA     	BRA     	L005702		;goto task4_thread_loop;
00572C 0009     	NOP     				;
L00572E:
00572E 60BD     	EXTU.W   	R11,R0		;if (handle.fn == 0x81) {
005730 8840     	CMP/EQ  	#40,R0		;  switch(handle.arg) {
005732 890D     	BT      	L005750		;    case 0x0040: goto task4_func_81_0040;
005734 8842     	CMP/EQ  	#42,R0		;
005736 890D     	BT      	L005754		;    case 0x0042: goto task4_func_81_0042;
005738 8844     	CMP/EQ  	#44,R0		;
00573A 890D     	BT      	L005758		;    case 0x0044: goto task4_func_81_0044;
00573C 8846     	CMP/EQ  	#46,R0		;
00573E 890D     	BT      	L00575C		;    case 0x0046: goto task4_func_81_0046;
005740 8848     	CMP/EQ  	#48,R0		;
005742 890D     	BT      	L005760		;    case 0x0048: goto task4_func_81_0048;
005744 8852     	CMP/EQ  	#52,R0		;
005746 890D     	BT      	L005764		;    case 0x0052: goto task4_func_81_0052;
005748 8855     	CMP/EQ  	#55,R0		;
00574A 890D     	BT      	L005768		;    case 0x0055: goto task4_func_81_0055;
00574C AFD9     	BRA     	L005702		;    default: goto task4_thread_loop;
00574E 0009     	NOP     				;  }
005750 A02C     	BRA     	L0057AC		;}
005752 0009     	NOP     				;
005754 A044     	BRA     	L0057E0		;
005756 0009     	NOP     				;
005758 A059     	BRA     	L00580E		;
00575A 0009     	NOP     				;
00575C A074     	BRA     	L005848		;
00575E 0009     	NOP     				;
005760 A0A9     	BRA     	L0058B6		;
005762 0009     	NOP     				;
005764 A0DB     	BRA     	L00591E		;
005766 0009     	NOP     				;
005768 A156     	BRA     	L005A18		;
00576A 0009     	NOP     				;
L00576C:
00576C 60BD     	EXTU.W   	R11,R0		;else if (handle.fn == 0x07) {
00576E 8840     	CMP/EQ  	#40,R0		;  switch(handle.arg) {
005770 89EE     	BT      	L005750		;    case 0x0040: goto task4_func_81_0040;
005772 8842     	CMP/EQ  	#42,R0		;
005774 89EE     	BT      	L005754		;    case 0x0042: goto task4_func_81_0042;
005776 8844     	CMP/EQ  	#44,R0		;
005778 89EE     	BT      	L005758		;    case 0x0044: goto task4_func_81_0044;
00577A 8846     	CMP/EQ  	#46,R0		;
00577C 89EE     	BT      	L00575C		;    case 0x0046: goto task4_func_81_0046;
00577E AFC0     	BRA     	L005702		;    default: goto task4_thread_loop;
005780 0009     	NOP     				;  }
005782 0009     	NOP     				;}
005784 00005370						;goto task4_thread_loop;
005788 0F000738
00578C 00007794

L005790:							;void task4_command_init()
005790 200A     	XOR     	R0,R0			;
005792 D1E3     	MOV.L   	@(#38C,PC),R1	;
005794 2102     	MOV.L   	R0,@R1		;actual_size = 0;
005796 D1D7     	MOV.L   	@(#35C,PC),R1	;
005798 2102     	MOV.L   	R0,@R1		;memset(command_param,0,16);
00579A 1101     	MOV.L   	R0,@(#4,R1)		;
00579C 1102     	MOV.L   	R0,@(#8,R1)		;
00579E 1103     	MOV.L   	R0,@(#C,R1)		;
0057A0 D1E4     	MOV.L   	@(#390,PC),R1	;
0057A2 2102     	MOV.L   	R0,@R1		;search_result_fad = 0x00000000;
0057A4 1101     	MOV.L   	R0,@(#4,R1)		;search_result_sector = search_result_partition = 0x000;
0057A6 8114     	MOV.W   	R0,@(#08,R1)	;get_sector_size = put_sector_size = 0x00;
0057A8 000B     	RTS     				;
0057AA 0009     	NOP     				;

L0057AC:							;task4_func_81_0040://Set Filter Range
0057AC DBDA     	MOV.L   	@(#368,PC),R11	;
0057AE C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
0057B0 D1D0     	MOV.L   	@(#340,PC),R1	;
0057B2 D224     	MOV.L   	@(#090,PC),R2	;
0057B4 8414     	MOV.B   	@(#04,R1),R0	;
0057B6 600C     	EXTU.B   	R0,R0			;u8 filtno = command_param[4];
0057B8 4008     	SHLL2   	R0			;
0057BA 4008     	SHLL2   	R0			;
0057BC 320C     	ADD     	R0,R2			;filter_data* fd = &filter_data_array[filtno];
0057BE 6012     	MOV.L   	@R1,R0		;
0057C0 4018     	SHLL8   	R0			;
0057C2 4019     	SHLR8   	R0			;
0057C4 1202     	MOV.L   	R0,@(#8,R2)		;fd->fad = *((u32*)&command_param[0]) & 0x00FFFFFF;
0057C6 5011     	MOV.L   	@(#04,R1),R0	;
0057C8 4018     	SHLL8   	R0			;
0057CA 4019     	SHLR8   	R0			;
0057CC 1203     	MOV.L   	R0,@(#C,R2)		;fd->range = *((u32*)&command_param[4]) & 0x00FFFFFF;
0057CE DBD2     	MOV.L   	@(#348,PC),R11	;
0057D0 C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
0057D2 D1D4     	MOV.L   	@(#350,PC),R1	;
0057D4 D2D4     	MOV.L   	@(#350,PC),R2	;YGR.HIRQ = HIRQ_ESEL;
0057D6 AF94     	BRA     	L005702		;goto task4_thread_loop;
0057D8 2121     	MOV.W   	R2,@R1		;
0057DA 0009     	NOP     				;
0057DC 00FF
0057DE FFFF

L0057E0:							;task4_func_81_0042://Set Filter Subheader Conditions
0057E0 DBCD     	MOV.L   	@(#334,PC),R11	;
0057E2 C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
0057E4 D1C3     	MOV.L   	@(#30C,PC),R1	;
0057E6 D217     	MOV.L   	@(#05C,PC),R2	;
0057E8 8414     	MOV.B   	@(#04,R1),R0	;
0057EA 600C     	EXTU.B   	R0,R0			;u8 filtno = command_param[4];
0057EC 4008     	SHLL2   	R0			;
0057EE 4008     	SHLL2   	R0			;
0057F0 320C     	ADD     	R0,R2			;filter_data* fd = &filter_data_array[filtno];
0057F2 8415     	MOV.B   	@(#05,R1),R0	;
0057F4 8022     	MOV.B   	R0,@(#02,R2)	;fd->fid = command_param[5];
0057F6 8411     	MOV.B   	@(#01,R1),R0	;
0057F8 8023     	MOV.B   	R0,@(#03,R2)	;fd->chan = command_param[1];
0057FA 8511     	MOV.W   	@(#02,R1),R0	;
0057FC 8122     	MOV.W   	R0,@(#04,R2)	;fd->smm = command_param[2];
0057FE 8513     	MOV.W   	@(#06,R1),R0	;fd->cim = command_param[3];
005800 8123     	MOV.W   	R0,@(#06,R2)	;fd->smv = command_param[6];
005802 DBC5     	MOV.L   	@(#314,PC),R11	;fd->civ = command_param[7];
005804 C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
005806 D1C7     	MOV.L   	@(#31C,PC),R1	;
005808 D2C7     	MOV.L   	@(#31C,PC),R2	;
00580A AF7A     	BRA     	L005702		;YGR.HIRQ = HIRQ_ESEL;
00580C 2121     	MOV.W   	R2,@R1		;goto task4_thread_loop;

L00580E:							;task4_func_81_0044://Set Filter Mode
00580E DBC2     	MOV.L   	@(#308,PC),R11	;
005810 C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
005812 D1B8     	MOV.L   	@(#2E0,PC),R1	;
005814 D20B     	MOV.L   	@(#02C,PC),R2	;
005816 8414     	MOV.B   	@(#04,R1),R0	;
005818 600C     	EXTU.B   	R0,R0			;u8 filtno = command_param[4];
00581A 4008     	SHLL2   	R0			;
00581C 4008     	SHLL2   	R0			;
00581E 320C     	ADD     	R0,R2			;filter_data* fd = &filter_data_array[filtno];
005820 8411     	MOV.B   	@(#01,R1),R0	;
005822 600C     	EXTU.B   	R0,R0			;
005824 C880     	TST     	#80,R0		;
005826 8905     	BT      	L005834		;if (command_param[1] & 0x80 != 0) {
005828 200A     	XOR     	R0,R0			;  fd->mode = 0;
00582A 1202     	MOV.L   	R0,@(#8,R2)		;  fd->fad = 0;
00582C 1203     	MOV.L   	R0,@(#C,R2)		;  fd->range = 0;
00582E 8121     	MOV.W   	R0,@(#02,R2)	;  fd->fid = fd->chan = 0;
005830 1201     	MOV.L   	R0,@(#4,R2)		;  fd->smm = fd->cim = fd->smv = fd->civ = 0;
005832 8021     	MOV.B   	R0,@(#01,R2)	;  fd->m1 = 0;
L005834:							;}
005834 8020     	MOV.B   	R0,@(#00,R2)	;else fd->mode = command_param[1];
005836 DBB8     	MOV.L   	@(#2E0,PC),R11	;
005838 C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
00583A D1BA     	MOV.L   	@(#2E8,PC),R1	;
00583C D2BA     	MOV.L   	@(#2E8,PC),R2	;
00583E AF60     	BRA     	L005702		;
005840 2121     	MOV.W   	R2,@R1		;YGR.HIRQ = HIRQ_ESEL;
005842 0009     	NOP     				;goto task4_thread_loop;
005844 0F000420

L005848:							;task4_func_81_0046://Set Filter Connection
005848 DBB3     	MOV.L   	@(#2CC,PC),R11	;
00584A C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
00584C D6A9     	MOV.L   	@(#2A4,PC),R6	;
00584E 8464     	MOV.B   	@(#04,R6),R0	;
005850 650C     	EXTU.B   	R0,R5			;u8 filtno = command_param[4];
005852 8461     	MOV.B   	@(#01,R6),R0	;
005854 C801     	TST     	#01,R0		;
005856 8912     	BT      	L00587E		;if (command_param[1] & 0x01 != 0) {
...
00586A 8906     	BT      	L00587A		;
00586C E0A0     	MOV     	#A0,R0		;
00586E 620C     	EXTU.B   	R0,R2			;
005870 223B     	OR      	R3,R2			;  if (command_param[2] != 0xFF) 
005872 BE4D     	BRS     	L005510		;    L005510(filtno | 0x40,command_param[2] | 0xA0);
005874 0009     	NOP     				;
005876 A002     	BRA     	L00587E		;
005878 0009     	NOP     				;  
L00587A:							;  else
00587A BE39     	BRS     	L0054F0    		;    L0054F0(filtno | 0x40);
00587C 0009     	NOP     				;}
L00587E:
00587E 8461     	MOV.B   	@(#01,R6),R0	;
005880 C802     	TST     	#02,R0		;
005882 8912     	BT      	L0058AA		;if (command_param[1] & 0x02 != 0) {
...
005896 8906     	BT      	L0058A6		;
005898 E000     	MOV     	#00,R0		;
00589A 620C     	EXTU.B   	R0,R2			;
00589C 223B     	OR      	R3,R2			;  if (command_param[3] != 0xFF) 
00589E BE37     	BRS     	L005510		;    L005510(filtno | 0x60,command_param[2] | 0x00);
0058A0 0009     	NOP     				;
0058A2 A002     	BRA     	L0058AA		;
0058A4 0009     	NOP     				;
L0058A6:							;  else
0058A6 BE23     	BRS     	L0054F0		;    L0054F0(filtno | 0x40);
0058A8 0009     	NOP     				;}
L0058AA:
0058AA DB9B     	MOV.L   	@(#26C,PC),R11	;
0058AC C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
0058AE D19D     	MOV.L   	@(#274,PC),R1	;
0058B0 D29D     	MOV.L   	@(#274,PC),R2	;
0058B2 AF26     	BRA     	L005702		;YGR.HIRQ = HIRQ_ESEL;
0058B4 2121     	MOV.W   	R2,@R1		;goto task4_thread_loop;

L0058B6:							;task4_func_81_0048://Reset Selector
0058B6 DB98     	MOV.L   	@(#260,PC),R11	;
0058B8 C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
0058BA D18E     	MOV.L   	@(#238,PC),R1	;
0058BC 8411     	MOV.B   	@(#01,R1),R0	;
0058BE 600C     	EXTU.B   	R0,R0			;
0058C0 C8FF     	TST     	#FF,R0		;
0058C2 8923     	BT      	L00590C		;
0058C4 C804     	TST     	#04,R0		;
0058C6 8903     	BT      	L0058D0		;if (command_param[1] & 0x04 != 0) 
0058C8 BE07     	BRS     	L0054DA		;  partitions_init();
0058CA 0009     	NOP     				;
0058CC D189     	MOV.L   	@(#224,PC),R1	;
0058CE 8411     	MOV.B   	@(#01,R1),R0	; 
L0058D0:
0058D0 C808     	TST     	#08,R0		;
0058D2 8903     	BT      	L0058DC		;if (command_param[1] & 0x08 != 0) 
0058D4 BD98     	BRS     	L005408		;  partition_outputs_init();
0058D6 0009     	NOP     				;
0058D8 D186     	MOV.L   	@(#218,PC),R1	;
0058DA 8411     	MOV.B   	@(#01,R1),R0	;
L0058DC:
0058DC C810     	TST     	#10,R0		;
0058DE 8903     	BT      	L0058E8		;if (command_param[1] & 0x10 != 0) 
0058E0 BDBC     	BRS     	L00545C		;  filter_conditions_init();
0058E2 0009     	NOP     				;
0058E4 D183     	MOV.L   	@(#20C,PC),R1	;
0058E6 8411     	MOV.B   	@(#01,R1),R0	;
L0058E8:
0058E8 C820     	TST     	#20,R0		;
0058EA 8903     	BT      	L0058F4		;if (command_param[1] & 0x20 != 0) 
0058EC BD89     	BRS     	L005402		;  filter_inputs_init();
0058EE 0009     	NOP     				;
0058F0 D180     	MOV.L   	@(#200,PC),R1	;
0058F2 8411     	MOV.B   	@(#01,R1),R0	;
L0058F4:
0058F4 C840     	TST     	#40,R0		;
0058F6 8903     	BT      	L005900		;if (command_param[1] & 0x40 != 0) 
0058F8 BD96     	BRS     	L005428		;  filter_true_outputs_init();
0058FA 0009     	NOP     				;
0058FC D17D     	MOV.L   	@(#1F4,PC),R1	;
0058FE 8411     	MOV.B   	@(#01,R1),R0	;
L005900:
005900 C880     	TST     	#80,R0		;
005902 8906     	BT      	L005912		;if (command_param[1] & 0x80 != 0) 
005904 BD83     	BRS     	L00540E		;  filter_false_outputs_init();
005906 0009     	NOP     				;
005908 A003     	BRA     	L005912		;
00590A 0009     	NOP     				;
L00590C:
00590C 8414     	MOV.B   	@(#04,R1),R0	;if (command_param[1] == 0)  
00590E BDB2     	BRS     	L005476		;  partition_clear(command_param[4]);
005910 610C     	EXTU.B   	R0,R1			;
L005912:
005912 DB81     	MOV.L   	@(#204,PC),R11	;
005914 C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
005916 D183     	MOV.L   	@(#20C,PC),R1	;
005918 D283     	MOV.L   	@(#20C,PC),R2	;
00591A AEF2     	BRA     	L005702		;YGR.HIRQ = HIRQ_ESEL;
00591C 2121     	MOV.W   	R2,@R1		;goto task4_thread_loop;

L00591E:							;task4_func_81_0052://Calculate Actual Size
00591E D375     	MOV.L   	@(#1D4,PC),R3	;
005920 8533     	MOV.W   	@(#06,R3),R0	;u32 size_w;
005922 600D     	EXTU.W   	R0,R0			;u16 snum = *(u16*)&command_param[6];
005924 8800     	CMP/EQ  	#00,R0		;
005926 8969     	BT      	L0059FC		;if (snum == 0) {
005928 D173     	MOV.L   	@(#1CC,PC),R1	;  TRAP_39(0x0B040000);
00592A 6010     	MOV.B   	@R1,R0		;  size_w = 0;
00592C 600C     	EXTU.B   	R0,R0			;  goto L005A0C;
00592E 8800     	CMP/EQ  	#00,R0		;}
005930 8B4E     	BF      	L0059D0		;if (get_sector_size == 0) {
005932 DB79     	MOV.L   	@(#1E4,PC),R11	;
005934 C32A     	TRAPA   	#42			;  TRAP_42(0x0B040000);
005936 D36F     	MOV.L   	@(#1BC,PC),R3	;
005938 8434     	MOV.B   	@(#04,R3),R0	;
00593A 610C     	EXTU.B   	R0,R1			;  u8 bufno = command_param[4];
00593C 2F16     	MOV.L   	R1,@-R15		;
00593E CB20     	OR      	#20,R0		;
005940 610C     	EXTU.B   	R0,R1			;
005942 8531     	MOV.W   	@(#02,R3),R0	;
005944 620D     	EXTU.W   	R0,R2			;
005946 2F26     	MOV.L   	R2,@-R15		;  u16 spos = *(u16*)&command_param[2];
005948 BDD2     	BRS     	L0054F0		;  selector_disconnect((1<<5) | bufno);
00594A 0009     	NOP     				;
00594C 62F6     	MOV.L   	@R15+,R2		;
00594E 61F6     	MOV.L   	@R15+,R1		;
005950 BB8C     	BRS     	L00506C		;  u8 block = get_abs_block_pos(bufno,spos);
005952 0009     	NOP     				;
005954 E0FF     	MOV     	#FF,R0		;
005956 600C     	EXTU.B   	R0,R0			;
005958 3100     	CMP/EQ 	R0,R1			;
00595A 894F     	BT      	L0059FC		;  if (block == 0xFF) {
00595C D265     	MOV.L   	@(#194,PC),R2	;    TRAP_39(0x0B040000);
00595E 8523     	MOV.W   	@(#06,R2),R0	;    size_w = 0;
005960 630D     	EXTU.W   	R0,R3			;    goto L005A0C;
005962 D466     	MOV.L   	@(#198,PC),R4	;  }
005964 214E     	MULU.W  	R4,R1			;
005966 021A     	STS     	MACL, R2		;
005968 DA65     	MOV.L   	@(#194,PC),R10	;
00596A 32AC     	ADD     	R10,R2		;  u8* block_buf = cddata_dram_buf + (block * 2352);
00596C D86B     	MOV.L   	@(#1AC,PC),R8	;
00596E 255A     	XOR     	R5,R5			;  u32 data_len;
005970 D664     	MOV.L   	@(#190,PC),R6	;
005972 D765     	MOV.L   	@(#194,PC),R7	;
L005974:
005974 842F     	MOV.B   	@(#0F,R2),R0	;  while (1) {
005976 600C     	EXTU.B   	R0,R0			;    sector_mode2_form2* sec_m2f2 = (sector_mode2_form2*)block_buf;
005978 8800     	CMP/EQ  	#00,R0		;
00597A 8B02     	BF      	L005982		;    if (sec_m2f2->header.mode == 0x00)
00597C 356C     	ADD     	R6,R5			;      size_w += 2048/2;
00597E A013     	BRA     	L0059A8		;
005980 0009     	NOP     				;
L005982:
005982 8801     	CMP/EQ  	#01,R0		;
005984 8B02     	BF      	L00598C		;    else if (sec_m2f2->header.mode == 0x01)
005986 356C     	ADD     	R6,R5			;      size_w += 2048/2;
005988 A00E     	BRA     	L0059A8		;
00598A 0009     	NOP     				;
L00598C:
00598C 8802     	CMP/EQ  	#02,R0		;
00598E 8902     	BT      	L005996		;    else if (secm2f2->header.mode != 0x02) 
005990 356C     	ADD     	R6,R5			;      size_w += 2048/2;
005992 A009     	BRA     	L0059A8		;
005994 0009     	NOP     				;
L005996:
...
00599E 8902     	BT      	L0059A6		;    else if (sec_m2f2->subheader.sm & 0x20 != 0x00) 
0059A0 357C     	ADD     	R7,R5			;      size_w += 2324/2;
0059A2 A001     	BRA     	L0059A8		;    else
0059A4 0009     	NOP     				;      size_w += 2048/2;
0059A6 356C     	ADD     	R6,R5			;
L0059A8:
0059A8 73FF     	ADD     	#FF,R3		;
0059AA 6033     	MOV     	R3,R0			;
0059AC 8800     	CMP/EQ  	#00,R0		;
0059AE 8B03     	BF      	L0059B8		;    if (snum - 1 == 0) {
0059B0 DB59     	MOV.L   	@(#164,PC),R11	;
0059B2 C327     	TRAPA   	#39			;      TRAP_39(0x0B040000);
0059B4 A02A     	BRA     	L005A0C		;      goto L005A0C;
0059B6 0009     	NOP     				;    }
L0059B8:
0059B8 E0FF     	MOV     	#FF,R0		;    if (block == 0xFF) {
0059BA 600C     	EXTU.B   	R0,R0			;      TRAP_39(0x0B040000);
0059BC 3100     	CMP/EQ 	R0,R1			;      size_w = 0x00FFFFFF;
0059BE 8916     	BT      	L0059EE		;      goto L005A0C;
0059C0 6083     	MOV     	R8,R0			;    }
0059C2 091C     	MOV.B   	@(R0,R1),R9		;
0059C4 619C     	EXTU.B   	R9,R1			;    block = block_chain[block];
0059C6 214E     	MULU.W  	R4,R1			;
0059C8 021A     	STS     	MACL, R2		;
0059CA 32AC     	ADD     	R10,R2		;    block_buf = cddata_dram_buf + (next_block * 2352);
0059CC AFD2     	BRA     	L005974		;  }
0059CE 0009     	NOP     				;}
L0059D0:
0059D0 8801     	CMP/EQ  	#01,R0		;
0059D2 8B02     	BF      	L0059DA		;else if (get_sector_size == 1) {
0059D4 D44D     	MOV.L   	@(#134,PC),R4	;  size_w = snum * 2336/2;
0059D6 A014     	BRA     	L005A02		;
0059D8 0009     	NOP     				;
0059DA 8802     	CMP/EQ  	#02,R0		;
0059DC 8B02     	BF      	L0059E4		;else if (get_sector_size == 2) {
0059DE D44C     	MOV.L   	@(#130,PC),R4	;  size_w = snum * 2340/2;
0059E0 A00F     	BRA     	L005A02		;
0059E2 0009     	NOP     				;
0059E4 8803     	CMP/EQ  	#03,R0		;
0059E6 8B09     	BF      	L0059FC		;else if (get_sector_size == 3) {
0059E8 D44A     	MOV.L   	@(#128,PC),R4	;  size_w = snum * 2352/2;
0059EA A00A     	BRA     	L005A02		;
0059EC 0009     	NOP     				;
L0059EE:
0059EE DB4A     	MOV.L   	@(#128,PC),R11	;
0059F0 C327     	TRAPA   	#39			;
0059F2 E5FF     	MOV     	#FF,R5		;
0059F4 4518     	SHLL8   	R5			;
0059F6 4519     	SHLR8   	R5			;
0059F8 A008     	BRA     	L005A0C		;
0059FA 0009     	NOP     				;
L0059FC:
0059FC DB46     	MOV.L   	@(#118,PC),R11	;else {
0059FE C327     	TRAPA   	#39			;  TRAP_39(0x0B040000);
005A00 244A     	XOR     	R4,R4			;  size_w = 0;
L005A02:							;}
...
005A0E 2152     	MOV.L   	R5,@R1		;actual_size = size_w;
005A10 D144     	MOV.L   	@(#110,PC),R1	;
005A12 D245     	MOV.L   	@(#114,PC),R2	;
005A14 AE75     	BRA     	L005702		;YGR.HIRQ = HIRQ_ESEL;
005A16 2121     	MOV.W   	R2,@R1		;goto task4_thread_loop;

L005A18:							;task4_func_81_0055://Execute FAD Search
005A18 DB3F     	MOV.L   	@(#0FC,PC),R11	;
005A1A C32A     	TRAPA   	#42			;TRAP_42(0x0B040000);
005A1C D335     	MOV.L   	@(#0D4,PC),R3	;
005A1E D444     	MOV.L   	@(#110,PC),R4	;
005A20 E000     	MOV     	#00,R0		;
005A22 2402     	MOV.L   	R0,@R4		;search_msf = 0x00000000;
005A24 5031     	MOV.L   	@(#04,R3),R0	;
005A26 4018     	SHLL8   	R0			;
005A28 4019     	SHLR8   	R0			;u32 fad = *(u32*)&command_param[4] & 0x00FFFFFF;
005A2A BA08     	BRS     	L004E3E		;msf_t msf; msf.u = fad2msf(fad);
...
005A36 600C     	EXTU.B   	R0,R0			;u8 bufno = command_param[4];
005A38 8143     	MOV.W   	R0,@(#06,R4)	;search_buf_num = (u16)bufno;
005A3A 6103     	MOV     	R0,R1			;
005A3C 2F16     	MOV.L   	R1,@-R15		;
005A3E CB20     	OR      	#20,R0		;
005A40 610C     	EXTU.B   	R0,R1			;
005A42 8531     	MOV.W   	@(#02,R3),R0	;
005A44 600D     	EXTU.W   	R0,R0			;u16 spos = *(u16*)&command_param[2];
005A46 8142     	MOV.W   	R0,@(#04,R4)	;search_sec_pos = spos;
005A48 6203     	MOV     	R0,R2			;
005A4A 2F26     	MOV.L   	R2,@-R15		;
005A4C BD50     	BRS     	L0054F0		;selector_disconnect((1<<5) | bufno);
005A4E 0009     	NOP     				;
005A50 62F6     	MOV.L   	@R15+,R2		;
005A52 61F6     	MOV.L   	@R15+,R1		;
005A54 2F26     	MOV.L   	R2,@-R15		;
005A56 BB09     	BRS     	L00506C		;u8 block = get_abs_block_pos(bufno,spos);
005A58 0009     	NOP     				;
...
005A6E 8B08     	BF      	L005A82		;if (block == 0xFF) {
005A70 E0FF     	MOV     	#FF,R0		;
005A72 8186     	MOV.W   	R0,@(#0C,R8)	;  search_result_sector = 0xFFFF;
005A74 4018     	SHLL8   	R0			;
005A76 4019     	SHLR8   	R0			;
005A78 1802     	MOV.L   	R0,@(#8,R8)		;  search_result_fad = 0x00FFFFFF;
005A7A 8583     	MOV.W   	@(#06,R8),R0	;
005A7C 8187     	MOV.W   	R0,@(#0E,R8)	;  search_result_partition = 0xFFFF;
005A7E A033     	BRA     	L005AE8		;  goto L005AE8;
005A80 0009     	NOP     				;}
L005A82:
005A82 269E     	MULU.W  	R9,R6			;do {
005A84 001A     	STS     	MACL, R0		;
005A86 30CC     	ADD     	R12,R0		;  u8* block_buf = cddata_dram_buf + (block * 2352);
005A88 700C     	ADD     	#0C,R0		;  sector_mode2_form2* sec_m2f2 = (sector_mode2_form2*)block_buf;
005A8A 6102     	MOV.L   	@R0,R1		;  u32 header = *(u32*)&sec_m2f2->header.min;
005A8C 4119     	SHLR8   	R1			; 
005A8E 3170     	CMP/EQ 	R7,R1			;
005A90 8B0A     	BF      	L005AA8		;  if (header>>8 == msf.u) {
005A92 4718     	SHLL8   	R7			;
005A94 B9BA     	BRS     	L004E0C		;
005A96 6173     	MOV     	R7,R1			;
005A98 6013     	MOV     	R1,R0			;
005A9A 1802     	MOV.L   	R0,@(#8,R8)		;    search_result_fad = msf2fad(msf.u);
005A9C 60A3     	MOV     	R10,R0		;
005A9E 8186     	MOV.W   	R0,@(#0C,R8)	;    search_result_sector = spos;
005AA0 8583     	MOV.W   	@(#06,R8),R0	;
005AA2 8187     	MOV.W   	R0,@(#0E,R8)	;    search_result_partition = search_buf_num;
005AA4 A020     	BRA     	L005AE8		;    goto L005AE8;
005AA6 0009     	NOP     				;  }
L005AA8:
005AA8 6382     	MOV.L   	@R8,R3		;
005AAA 3136     	CMP/HI 	R3,R1			;
005AAC 8B04     	BF      	L005AB8		;
005AAE 3716     	CMP/HI 	R1,R7			;  if (header>>8 > search_msf && msf.u > header>>8) {
005AB0 8B02     	BF      	L005AB8		;
005AB2 2812     	MOV.L   	R1,@R8		;    search_msf = header>>8;
005AB4 60A3     	MOV     	R10,R0		;    search_sec_pos = spos;
005AB6 8182     	MOV.W   	R0,@(#04,R8)	;  }
L005AB8:
005AB8 7A01     	ADD     	#01,R10		;  spos++;
005ABA 39DC     	ADD     	R13,R9		;
005ABC 6190     	MOV.B   	@R9,R1		;
005ABE 611C     	EXTU.B   	R1,R1			;  block = block_chain[block];
005AC0 6913     	MOV     	R1,R9			;
005AC2 E0FF     	MOV     	#FF,R0		;
005AC4 600C     	EXTU.B   	R0,R0			;
005AC6 3100     	CMP/EQ 	R0,R1			;
005AC8 8BDB     	BF      	L005A82		;} while (block != 0xFF);
005ACA 8583     	MOV.W   	@(#06,R8),R0	;
005ACC 8187     	MOV.W   	R0,@(#0E,R8)	;search_result_partition = search_buf_num;
005ACE 6182     	MOV.L   	@R8,R1		;
005AD0 B99C     	BRS     	L004E0C		;
005AD2 4118     	SHLL8   	R1			;
005AD4 6013     	MOV     	R1,R0			;u32 fad = msf2fad(search_msf<<8);
005AD6 1802     	MOV.L   	R0,@(#8,R8)		;search_result_fad = fad;
005AD8 8800     	CMP/EQ  	#00,R0		;
005ADA 8B03     	BF      	L005AE4		;
005ADC E0FF     	MOV     	#FF,R0		;if (fad == 0)
005ADE 8186     	MOV.W   	R0,@(#0C,R8)	;  search_result_sector = 0xFFFF;
005AE0 A002     	BRA     	L005AE8		;
005AE2 0009     	NOP     				;
L005AE4:
005AE4 8582     	MOV.W   	@(#04,R8),R0	;else 
005AE6 8186     	MOV.W   	R0,@(#0C,R8)	;  search_result_sector = search_sec_pos;
L005AE8:
005AE8 DB0B     	MOV.L   	@(#02C,PC),R11	;
005AEA C327     	TRAPA   	#39			;TRAP_39(0x0B040000);
005AEC D10D     	MOV.L   	@(#034,PC),R1	;
005AEE D20E     	MOV.L   	@(#038,PC),R2	;
005AF0 AE07     	BRA     	L005702		;YGR.HIRQ = HIRQ_ESEL;
005AF2 2121     	MOV.W   	R2,@R1		;goto task4_thread_loop;
005AF4 0F0006C0
005AF8 0F0006D8
005AFC 00000930
005B00 09000230
...
005B5C B012     	BRS     	L005B84		;dmac0_restart();
005B5E 0009     	NOP     				;
005B60 2F96     	MOV.L   	R9,@-R15		;
005B62 DB1A     	MOV.L   	@(#068,PC),R11	;
005B64 C32D     	TRAPA   	#45			;add_delayed_task_to_queue(0x05840010);
...
005C02 2019     	AND     	R1,R0			;u8 flags = (u8)(YGR.CDIRQU & YGR.CDMASK);
005C04 80D2     	MOV.B   	R0,@(#02,R13)	;cdirq_flags = flags;
005C06 C810     	TST     	#10,R0		;
005C08 8901     	BT      	L005C0E		;
005C0A B012     	BRS     	L005C32		;if (flags & 0x10 != 0) cdirq0_handler();
005C0C 0009     	NOP     				;
L005C0E:
005C0E 84D2     	MOV.B   	@(#02,R13),R0	;
005C10 C820     	TST     	#20,R0		;
005C12 8901     	BT      	L005C18		;
005C14 B050     	BRS     	L005CB8		;if (flags & 0x20 != 0) cdirq1_handle();
005C16 0009     	NOP     				;
L005C18:
...
L005C32:							;void cdirq0_handler()
005C32 E0EF     	MOV     	#EF,R0		;
005C34 81A1     	MOV.W   	R0,@(#02,R10)	;YGR.CDIRQU = ~0x0010;
005C36 84D0     	MOV.B   	@(#00,R13),R0	;
005C38 8801     	CMP/EQ  	#01,R0		;
005C3A 8903     	BT      	L005C44		;
005C3C 8800     	CMP/EQ  	#00,R0		;
005C3E 8925     	BT      	L005C8C		;
005C40 A01A     	BRA     	L005C78		;switch (cdirq0_state) {
005C42 0009     	NOP     				;
L005C44:
005C44 092A     	STS     	PR, R9		;case 0x01:
005C46 B0FB     	BRS     	L005E40		;  u32 t = (u32)get_cd_counter48();
005C48 0009     	NOP     				;
005C4A 492A     	LDS     	R9,PR			;
005C4C 52D3     	MOV.L   	@(#0C,R13),R2	;  
005C4E 1D13     	MOV.L   	R1,@(#C,R13)	;  timer_old = t;
005C50 3128     	SUB     	R2,R1			;
005C52 50D2     	MOV.L   	@(#08,R13),R0	;
005C54 0008     	CLRT    				;
005C56 310A     	SUBC    	R0,R1			;  s32 dev -= (t - timer_old) - timer_interval;
005C58 8B00     	BF      	L005C5C		;
005C5A 611B     	NEG     	R1,R1			;  dev = abs(dev);
005C5C 84D3     	MOV.B   	@(#03,R13),R0	;
005C5E 3106     	CMP/HI 	R0,R1			;
005C60 890F     	BT      	L005C82		;  if (dev > timer_deviation) {
005C62 E107     	MOV     	#07,R1		;    timer_fault_cnt++;
005C64 85B1     	MOV.W   	@(#02,R11),R0	;    return;
005C66 201B     	OR      	R1,R0			;  }
005C68 81B1     	MOV.W   	R0,@(#02,R11)	;  YGR.REG1A |= 0x0007;
005C6A E002     	MOV     	#02,R0		;
005C6C 80D0     	MOV.B   	R0,@(#00,R13)	;  cdirq0_state = 0x02;
005C6E DB6D     	MOV.L   	@(#1B4,PC),R11	;
005C70 C32D     	TRAPA   	#45			;  add_delayed_task_to_queue(0x05800012);
005C72 DA6A     	MOV.L   	@(#1A8,PC),R10	;
005C74 DB6A     	MOV.L   	@(#1A8,PC),R11	;
005C76 DD68     	MOV.L   	@(#1A0,PC),R13	;
L005C78:
005C78 85A3     	MOV.W   	@(#06,R10),R0	;case 0x02:
005C7A C9EF     	AND     	#EF,R0		;
005C7C 81A3     	MOV.W   	R0,@(#06,R10)	;  YGR.CDMASK &= ~0x0010;
005C7E 000B     	RTS     				;  return;
005C80 0009     	NOP     				;
L005C82:
005C82 84D7     	MOV.B   	@(#07,R13),R0	;
005C84 7001     	ADD     	#01,R0		;
005C86 80D7     	MOV.B   	R0,@(#07,R13)	;
005C88 000B     	RTS     				;
005C8A 0009     	NOP     				;
L005C8C:
005C8C 092A     	STS     	PR, R9		;case 0x00:
005C8E B0D7     	BRS     	L005E40		;
005C90 0009     	NOP     				;
005C92 492A     	LDS     	R9,PR			;
005C94 1D13     	MOV.L   	R1,@(#C,R13)	;  timer_old = (u32)get_cd_counter48();
005C96 D268     	MOV.L   	@(#1A0,PC),R2	;
005C98 D165     	MOV.L   	@(#194,PC),R1	;  const1 = 0x00008235;
005C9A 6020     	MOV.B   	@R2,R0		;
005C9C E21C     	MOV     	#1C,R2		;  const2 = 0x1C;
...
L005CA6:							;  }
005CA6 1D12     	MOV.L   	R1,@(#8,R13)	;  timer_interval = const1;
005CA8 6023     	MOV     	R2,R0			;
005CAA 80D3     	MOV.B   	R0,@(#03,R13)	;  timer_deviation = const2;
005CAC E000     	MOV     	#00,R0		;
005CAE 80D7     	MOV.B   	R0,@(#07,R13)	;  timer_fault_cnt = 0x00;
005CB0 E001     	MOV     	#01,R0		;
005CB2 80D0     	MOV.B   	R0,@(#00,R13)	;  cdirq0_state = 0x01;
005CB4 000B     	RTS     				;
005CB6 0009     	NOP     				;}

L005CB8:							;void cdirq1_handler()
005CB8 4F12     	STS.L   	MACL,@-R15		;
005CBA 092A     	STS     	PR, R9		;
005CBC 85A1     	MOV.W   	@(#02,R10),R0	;
005CBE 80D2     	MOV.B   	R0,@(#02,R13)	;cdirq_flags = (u8)YGR.CDIRQU;
005CC0 E09F     	MOV     	#9F,R0		;
005CC2 81A1     	MOV.W   	R0,@(#02,R10)	;YGR.CDIRQU = ~0x0060;
...
005CCE 8903     	BT      	L005CD8		;switch (cdirq1_state) {
005CD0 8802     	CMP/EQ  	#02,R0		;
005CD2 8910     	BT      	L005CF6		;default:
005CD4 A099     	BRA     	L005E0A		;  return;
005CD6 0009     	NOP     				;
L005CD8:							;case 0x01:
005CD8 1D13     	MOV.L   	R1,@(#C,R13)	;  timer_old = new_val;
005CDA 84D2     	MOV.B   	@(#02,R13),R0	;
005CDC C840     	TST     	#40,R0		;
005CDE 89F9     	BT      	L005CD4		;  if (cdirq_flags & 0x40 == 0) return;
005CE0 84D6     	MOV.B   	@(#06,R13),R0	;
005CE2 7001     	ADD     	#01,R0		;
005CE4 80D6     	MOV.B   	R0,@(#06,R13)	;  cdirq1_div_cnt++;
005CE6 2008     	TST     	R0,R0			;
005CE8 8BF4     	BF      	L005CD4		;  if (cdirq1_div_cnt != 0) return;
005CEA E000     	MOV     	#00,R0		;
005CEC 80D7     	MOV.B   	R0,@(#07,R13)	;  timer_fault_cnt = 0x00;
005CEE E002     	MOV     	#02,R0		;
005CF0 80D1     	MOV.B   	R0,@(#01,R13)	;  cdirq1_state = 0x02;
005CF2 A063     	BRA     	L005DBC		;  break;
005CF4 0009     	NOP     				;
L005CF6:
005CF6 E000     	MOV     	#00,R0		;case 0x02:
005CF8 80D3     	MOV.B   	R0,@(#03,R13)	;  timer_deviation = 0x00;
005CFA 52D3     	MOV.L   	@(#0C,R13),R2	;  old_val = timer_old;
005CFC 1D13     	MOV.L   	R1,@(#C,R13)	;  timer_old = new_val;
005CFE 3128     	SUB     	R2,R1			;
005D00 611D     	EXTU.W   	R1,R1			;  new_val -= old_val;
005D02 935A     	MOV.W   	@(#0B4,PC),R3	;
005D04 71AB     	ADD     	#AB,R1		;  new_val -= 0x0055;
005D06 3136     	CMP/HI 	R3,R1			;
005D08 8902     	BT      	L005D10		;  if (new_val <= 0x0154) 
005D0A E101     	MOV     	#01,R1		;    step = 1;
005D0C A00E     	BRA     	L005D2C		;  else {
005D0E 0009     	NOP     				;
L005D10:
005D10 4308     	SHLL2   	R3			;
005D12 4308     	SHLL2   	R3			;
005D14 3136     	CMP/HI 	R3,R1			;
005D16 8944     	BT      	L005DA2		;    if (new_val > 0x1540) goto L005DA2;
...
005D2A 7101     	ADD     	#01,R1		;    step = ((new_val % 0x1540) & 0x0F) + 1;
L005D2C:							;  }
005D2C 84D6     	MOV.B   	@(#06,R13),R0	;
005D2E 301C     	ADD     	R1,R0			;  temp = cdirq1_div_cnt + step;
005D30 E262     	MOV     	#62,R2		;
005D32 3022     	CMP/HS 	R2,R0			;
005D34 8B04     	BF      	L005D40		;  if (temp >= 0x62) {
005D36 3028     	SUB     	R2,R0			;    temp -= 0x62;
005D38 80D6     	MOV.B   	R0,@(#06,R13)	;    cdirq1_div_cnt = temp;
005D3A 7018     	ADD     	#18,R0		;    temp += 0x18;
005D3C A007     	BRA     	L005D4E		;
005D3E 0009     	NOP     				;  }
L005D40:							;  else {
005D40 80D6     	MOV.B   	R0,@(#06,R13)	;    cdirq1_div_cnt = temp;
005D42 E260     	MOV     	#60,R2		;
005D44 3022     	CMP/HS 	R2,R0			;
005D46 8B00     	BF      	L005D4A		;
005D48 E100     	MOV     	#00,R1		;
005D4A 84D5     	MOV.B   	@(#05,R13),R0	;
005D4C 301C     	ADD     	R1,R0			;    temp = cdirq1_cnt1 + (temp >= 0x60 ? 0 : step);
L005D4E:							;  }
005D4E E218     	MOV     	#18,R2		;
005D50 80D5     	MOV.B   	R0,@(#05,R13)	;  cdirq1_cnt1 = temp;
005D52 3022     	CMP/HS 	R2,R0			;
005D54 8B07     	BF      	L005D66		;  if (temp >= 0x18) {
005D56 3028     	SUB     	R2,R0			;    temp -= 0x18;
005D58 80D5     	MOV.B   	R0,@(#05,R13)	;    cdirq1_cnt1 = temp;
005D5A 84D4     	MOV.B   	@(#04,R13),R0	;
005D5C 7001     	ADD     	#01,R0		;
005D5E C91F     	AND     	#1F,R0		;    cdirq1_cnt2++;
005D60 80D4     	MOV.B   	R0,@(#04,R13)	;    cdirq1_cnt2 &= 0x1F;
005D62 E001     	MOV     	#01,R0		;
005D64 80D3     	MOV.B   	R0,@(#03,R13)	;    timer_deviation = 0x01;
L005D66:							;  }
005D66 84D6     	MOV.B   	@(#06,R13),R0	;
005D68 6103     	MOV     	R0,R1			;
005D6A 2008     	TST     	R0,R0			;
005D6C 890D     	BT      	L005D8A		;  if (cdirq1_div_cnt == 0) {
005D6E 84D2     	MOV.B   	@(#02,R13),R0	;    if (cdirq_flags & 0x40 != 0) timer_fault_cnt = 0x00;
005D70 C840     	TST     	#40,R0		;    break;
005D72 8923     	BT      	L005DBC		;  }
005D74 E260     	MOV     	#60,R2		;  if (cdirq_flags & 0x40 == 0) 
005D76 3122     	CMP/HS 	R2,R1			;    break;
005D78 890E     	BT      	L005D98		;
005D7A E204     	MOV     	#04,R2		;
005D7C 3126     	CMP/HI 	R2,R1			;  if (cdirq1_div_cnt < 0x60 &&
005D7E 890B     	BT      	L005D98		;      cdirq1_div_cnt <= 0x04) {
005D80 E000     	MOV     	#00,R0		;
005D82 80D6     	MOV.B   	R0,@(#06,R13)	;    cdirq1_div_cnt = 0x00;
005D84 80D5     	MOV.B   	R0,@(#05,R13)	;    cdirq1_cnt1 = 0x00;
005D86 A019     	BRA     	L005DBC		;    break;
005D88 0009     	NOP     				;  }
L005D8A:
005D8A 84D2     	MOV.B   	@(#02,R13),R0	;
005D8C C840     	TST     	#40,R0		;
005D8E 8901     	BT      	L005D94		;
005D90 E000     	MOV     	#00,R0		;
005D92 80D7     	MOV.B   	R0,@(#07,R13)	;
L005D94:
...
005D9C 80D7     	MOV.B   	R0,@(#07,R13)	;  timer_fault_cnt++;
005D9E 8803     	CMP/EQ  	#03,R0		;
005DA0 8B0C     	BF      	L005DBC		;  if (timer_fault_cnt == 0x03) {
L005DA2:
005DA2 84D4     	MOV.B   	@(#04,R13),R0	;
005DA4 7004     	ADD     	#04,R0		;
005DA6 C91C     	AND     	#1C,R0		;    cdirq1_cnt2 += 0x04;
005DA8 80D4     	MOV.B   	R0,@(#04,R13)	;    cdirq1_cnt2 &= 0x1C;
005DAA E000     	MOV     	#00,R0		;
005DAC 80D5     	MOV.B   	R0,@(#05,R13)	;    cdirq1_cnt1 = 0x00;
005DAE E001     	MOV     	#01,R0		;
005DB0 80D1     	MOV.B   	R0,@(#01,R13)	;    cdirq1_state = 0x01;
005DB2 E0FF     	MOV     	#FF,R0		;
005DB4 80D6     	MOV.B   	R0,@(#06,R13)	;    cdirq1_div_cnt = 0xFF;
005DB6 A029     	BRA     	L005E0C		;    return;
005DB8 0009     	NOP     				;    
005DBA 0154							;  }
L005DBC:							;}
...
005DD6 031A     	STS     	MACL, R3		;
005DD8 303C     	ADD     	R3,R0			;u32 n = cdirq1_cnt1 + ((cdirq1_cnt2 + 7 - (cdirq1_cnt1 & 7)) * 24);            
005DDA D314     	MOV.L   	@(#050,PC),R3	;
005DDC 3022     	CMP/HS 	R2,R0			;
005DDE 8B00     	BF      	L005DE2		;
005DE0 3028     	SUB     	R2,R0			;if (n >= 0x0300) n -= 0x0300;
L005DE2:
005DE2 0314     	MOV.B   	R1,@(R0,R3)		;L09074E10[n] = YGR.REG18 & 0x3F;
005DE4 84D3     	MOV.B   	@(#03,R13),R0	;
005DE6 8801     	CMP/EQ  	#01,R0		;
005DE8 8B10     	BF      	L005E0C		;if (timer_deviation == 0x01) {
...
005DF8 8B01     	BF      	L005DFE		;
005DFA E003     	MOV     	#03,R0		;  if (*(U8*)(0x0F0006EC+0x01) == (cdirq1_cnt2 + 8) & 0x1F)
005DFC 8022     	MOV.B   	R0,@(#02,R2)	;    *(U8*)(0x0F0006EC+0x02) = 0x03;
L005DFE:
005DFE 0009     	NOP     				;
005E00 DB09     	MOV.L   	@(#024,PC),R11	;
005E02 6193     	MOV     	R9,R1			;
005E04 C32D     	TRAPA   	#45			;  add_delayed_task_to_queue(0x02800010);
005E06 6913     	MOV     	R1,R9			;
005E08 DD03     	MOV.L   	@(#00C,PC),R13	;}
L005E0A:
005E0A 0009     	NOP     				;
L005E0C:
...
L005E68:							;task2_thread()
005E68 E000     	MOV     	#00,R0		;
005E6A DA45     	MOV.L   	@(#114,PC),R10	;
005E6C 1A00     	MOV.L   	R0,@(#0,R10)	;memset(0x0F0006EC,0,12);
005E6E 1A01     	MOV.L   	R0,@(#4,R10)	;
005E70 1A02     	MOV.L   	R0,@(#8,R10)	;
L005E72:							;task2_thread_loop:
005E72 C323     	TRAPA   	#35			;u32 h = switch_task();
005E74 DA42     	MOV.L   	@(#108,PC),R10	;handle_t* handle = (handle_t*)&h;
005E76 60B9     	SWAP.W   	R11,R0		;
005E78 600E     	EXTS.B   	R0,R0			;
005E7A 8880     	CMP/EQ  	#80,R0		;
005E7C 8933     	BT      	L005EE6		;if (handle->fn == 0x80) goto task2_func_80;
005E7E 8881     	CMP/EQ  	#81,R0		;
005E80 890C     	BT      	L005E9C		;else if (handle->fn == 0x81) goto task2_func_81;
005E82 8803     	CMP/EQ  	#03,R0		;
005E84 8901     	BT      	L005E8A		;else if (handle->fn == 0x03) goto task2_func_03;
005E86 AFF4     	BRA     	L005E72		;goto task2_thread_loop;
005E88 0009     	NOP     				;

L005E8A:							;task2_func_03:
005E8A 60BE     	EXTS.B   	R11,R0		;
005E8C 8801     	CMP/EQ  	#01,R0		;
005E8E 8901     	BT      	L005E94		;if (handle->arg == 0x01) goto task2_func_03_0001;
005E90 AFEF     	BRA     	L005E72		;goto task2_thread_loop;
005E92 0009     	NOP     				;
L005E94:							;task2_func_03_0001:
005E94 DB41     	MOV.L   	@(#104,PC),R11	;
005E96 C327     	TRAPA   	#39			;TRAP_39(0x03020000);
005E98 AFEB     	BRA     	L005E72		;goto task2_thread_loop;
005E9A 0009     	NOP     				;

L005E9C:							;task2_func_81:
005E9C DB3F     	MOV.L   	@(#0FC,PC),R11	;
005E9E C32A     	TRAPA   	#42			;TRAP_42(0x03020000);
005EA0 DA37     	MOV.L   	@(#0DC,PC),R10	;
005EA2 84A1     	MOV.B   	@(#01,R10),R0	;u8 n = *(u8*)(0x0F0006EC+0x01);
...
005EAE 310C     	ADD     	R0,R1			;u8* ptr = &L09074E10[n*24];
005EB0 2212     	MOV.L   	R1,@R2		;unknown_0250 = ptr;
005EB2 D237     	MOV.L   	@(#0DC,PC),R2	;
005EB4 E00C     	MOV     	#0C,R0		;
005EB6 2201     	MOV.W   	R0,@R2		;unknown_0254 = 0x000C;
005EB8 84A2     	MOV.B   	@(#02,R10),R0	;
005EBA 8803     	CMP/EQ  	#03,R0		;
005EBC 8907     	BT      	L005ECE		;switch (*(u8*)(0x0F0006EC+0x02)) {
005EBE 8802     	CMP/EQ  	#02,R0		;
005EC0 8B0B     	BF      	L005EDA		;case 0x02:
005EC2 84A1     	MOV.B   	@(#01,R10),R0	;  n = *(u8*)(0x0F0006EC+0x01);
005EC4 7001     	ADD     	#01,R0		;  n++;
005EC6 C91F     	AND     	#1F,R0		;  n &= 0x1F;
005EC8 80A1     	MOV.B   	R0,@(#01,R10)	;  *(u8*)(0x0F0006EC+0x01) = n;
005ECA A006     	BRA     	L005EDA		;
005ECC 0009     	NOP     				;  break;
L005ECE:							;case 0x03:
005ECE 84A0     	MOV.B   	@(#00,R10),R0	;  n = *(u8*)(0x0F0006EC+0x00);
005ED0 7009     	ADD     	#09,R0		;  n += 9;
005ED2 C91F     	AND     	#1F,R0		;  n &= 0x1F;
005ED4 80A1     	MOV.B   	R0,@(#01,R10)	;  *(u8*)(0x0F0006EC+0x01) = n;
005ED6 E002     	MOV     	#02,R0		;  *(u8*)(0x0F0006EC+0x02) = 0x02;
...
005EDE 400B     	JSR     	@R0			;
005EE0 0009     	NOP     				;
005EE2 AFC6     	BRA     	L005E72		;goto task2_thread_loop;
005EE4 0009     	NOP     				;

L005EE6:							;task2_func_80:
005EE6 DA26     	MOV.L   	@(#098,PC),R10	;
005EE8 84A2     	MOV.B   	@(#02,R10),R0	;
005EEA 8802     	CMP/EQ  	#02,R0		;
005EEC 8911     	BT      	L005F12		;
005EEE 8801     	CMP/EQ  	#01,R0		;
005EF0 8905     	BT      	L005EFE		;
005EF2 8800     	CMP/EQ  	#00,R0		;
005EF4 8901     	BT      	L005EFA		;u8 n;
005EF6 A00B     	BRA     	L005F12		;
005EF8 0009     	NOP     				;switch (*(u8*)(0x0F0006EC+0x02)) {
L005EFA:							;case 0x00:
005EFA E001     	MOV     	#01,R0		;  *(u8*)(0x0F0006EC+0x02) = 0x01;
005EFC 80A2     	MOV.B   	R0,@(#02,R10)	;
L005EFE:
005EFE D21F     	MOV.L   	@(#07C,PC),R2	;case 0x01:
005F00 8424     	MOV.B   	@(#04,R2),R0	;
005F02 8809     	CMP/EQ  	#09,R0		;
005F04 8B38     	BF      	L005F78		;  if (cdirq1_cnt2 != 0x09) break;
005F06 E008     	MOV     	#08,R0		;
005F08 80A0     	MOV.B   	R0,@(#00,R10)	;  *(u8*)(0x0F0006EC+0x00) = 0x08;
005F0A 80A1     	MOV.B   	R0,@(#01,R10)	;  *(u8*)(0x0F0006EC+0x01) = 0x08;
005F0C E002     	MOV     	#02,R0		;
005F0E 80A2     	MOV.B   	R0,@(#02,R10)	;  *(u8*)(0x0F0006EC+0x02) = 0x02;
005F10 0009     	NOP     				;
L005F12:							;case 0x02:
005F12 84A0     	MOV.B   	@(#00,R10),R0	;default:
005F14 E118     	MOV     	#18,R1		; do {
005F16 210E     	MULU.W  	R0,R1			;  n = *(u8*)(0x0F0006EC+0x00);
005F18 D11A     	MOV.L   	@(#068,PC),R1	;
005F1A 001A     	STS     	MACL, R0		;
005F1C 310C     	ADD     	R0,R1			;  u8* ptr = &L09074E10[n*24]
005F1E 1A12     	MOV.L   	R1,@(#8,R10)	;  *(u32*)(0x0F0006EC+0x08) = ptr;
005F20 6312     	MOV.L   	@R1,R3		;  temp = ptr[0x03];
005F22 411E     	LDC     	R1,GBR		;
005F24 C417     	MOV.B   	@(#017,GBR),R0	;  
005F26 C003     	MOV.B   	R0,@(#003,GBR)	;  ptr[0x03] = ptr[0x17];
005F28 603C     	EXTU.B   	R3,R0			;
005F2A C017     	MOV.B   	R0,@(#017,GBR)	;  ptr[0x17] = temp;
005F2C C405     	MOV.B   	@(#005,GBR),R0	;  temp = ptr[0x02];
005F2E 4319     	SHLR8   	R3			;
005F30 C002     	MOV.B   	R0,@(#002,GBR)	;  ptr[0x02] = ptr[0x05];
005F32 603C     	EXTU.B   	R3,R0			;
005F34 C005     	MOV.B   	R0,@(#005,GBR)	;  ptr[0x05] = temp;
005F36 C412     	MOV.B   	@(#012,GBR),R0	;  temp = ptr[0x01];
005F38 4319     	SHLR8   	R3			;
005F3A C001     	MOV.B   	R0,@(#001,GBR)	;  ptr[0x01] = ptr[0x12];
005F3C 603C     	EXTU.B   	R3,R0			;
005F3E C012     	MOV.B   	R0,@(#012,GBR)	;  ptr[0x12] = temp;
005F40 B077     	BRS     	L006032		;  temp = L006032();
005F42 0009     	NOP     				;
005F44 DA0E     	MOV.L   	@(#038,PC),R10	;
005F46 80A4     	MOV.B   	R0,@(#04,R10)	;  *(u8*)(0x0F0006EC+0x04) = temp;
005F48 52A2     	MOV.L   	@(#08,R10),R2	;
005F4A B02B     	BRS     	L005FA4		;  temp = L005FA4();
005F4C 0009     	NOP     				;
005F4E DA0C     	MOV.L   	@(#030,PC),R10	;
005F50 80A5     	MOV.B   	R0,@(#05,R10)	;  *(u8*)(0x0F0006EC+0x05) = temp;
005F52 84A5     	MOV.B   	@(#05,R10),R0	;
005F54 6103     	MOV     	R0,R1			;
005F56 84A4     	MOV.B   	@(#04,R10),R0	;
005F58 201B     	OR      	R1,R0			;
005F5A C880     	TST     	#80,R0		;
005F5C 8903     	BT      	L005F66		;  if (*(u8*)(0x0F0006EC+0x04) | *(u8*)(0x0F0006EC+0x05) & 0x80 != 0) {
005F5E 52A2     	MOV.L   	@(#08,R10),R2	;    ptr = *(u32*)(0x0F0006EC+0x08);
005F60 6020     	MOV.B   	@R2,R0		;
005F62 CB80     	OR      	#80,R0		;    *ptr |= 0x80;
005F64 2200     	MOV.B   	R0,@R2		;  }
L005F66:
005F66 84A0     	MOV.B   	@(#00,R10),R0	;  n = *(u8*)(0x0F0006EC+0x00);
005F68 7001     	ADD     	#01,R0		;  n++;
005F6A C91F     	AND     	#1F,R0		;  n &= 0x1F;
005F6C 80A0     	MOV.B   	R0,@(#00,R10)	;  *(u8*)(0x0F0006EC+0x00) = n;
005F6E D203     	MOV.L   	@(#00C,PC),R2	;
005F70 6103     	MOV     	R0,R1			;
005F72 8424     	MOV.B   	@(#04,R2),R0	;
005F74 3010     	CMP/EQ 	R1,R0			;
005F76 8BCC     	BF      	L005F12		;  } while (n != cdirq1_cnt2);
L005F78:							;}
005F78 AF7B     	BRA     	L005E72		;goto task2_thread_loop;
005F7A 0009     	NOP     				;
005F7C 0F0006DC
005F80 0F0006EC
005F84 09074E10
...
006034 D892     	MOV.L   	@(#248,PC),R8	;00006294
006036 D993     	MOV.L   	@(#24C,PC),R9	;000062D4
006038 DA90     	MOV.L   	@(#240,PC),R10	;0F0006EC
00603A DB95     	MOV.L   	@(#254,PC),R11	;0F000708
00603C B008     	BRS     	L006050		;L006050();
00603E 0009     	NOP     				;
006040 DA92     	MOV.L   	@(#248,PC),R10	;0F0006F8
006042 B09B     	BRS     	L00617C		;L00617C();
006044 0009     	NOP     				;
006046 B02E     	BRS     	L0060A6		;L0060A6();
006048 0009     	NOP     				;
...
L006050:							;
006050 52A2     	MOV.L   	@(#08,R10),R2	;u8* ptr = *(u32*)(0x0F0006EC+0x08);
...
L006062:
006062 72FF     	ADD     	#FF,R2		;for (int i=0;i<24;i++) {
006064 6120     	MOV.B   	@R2,R1		;
006066 2118     	TST     	R1,R1			;
006068 8917     	BT      	L00609A		;  if (ptr[0x18-1] == 0x00) continue;
...
L00689C:							;get_sector_data_inner(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
00689C D93A     	MOV.L   	@(#0E8,PC),R9	;
00689E 6090     	MOV.B   	@R9,R0		;
0068A0 C80E     	TST     	#0E,R0		;
0068A2 8B32     	BF      	L00690A		;if (*(u8*)0x0F000724 & 0x0E != 0) return L0091EC(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0068A4 D936     	MOV.L   	@(#0D8,PC),R9	;
0068A6 4F22     	STS.L   	PR,@-R15		;
0068A8 490B     	JSR     	@R9			;int ret = check_fix_command_param(&cr1,&cr2,&cr3,&cr4);
0068AA 0009     	NOP     				;
0068AC 4F26     	LDS.L   	@R15+,PR		;
0068AE 88FF     	CMP/EQ  	#FF,R0		;
0068B0 8926     	BT      	L006900		;if (ret == -1) return L0091E8(0,0,0,0,rr1,rr2,rr3,rr4);
0068B2 8801     	CMP/EQ  	#01,R0		;
0068B4 8929     	BT      	L00690A		;if (ret == 1) return L0091EC(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0068B6 A03B     	BRA     	L006930		;goto L006930;
0068B8 0009     	NOP     				;

;cdb command 62 "Delete Sector Data"
L0068BA:							;del_sector_data(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0068BA D931     	MOV.L   	@(#0C4,PC),R9	;
0068BC 4F22     	STS.L   	PR,@-R15		;
0068BE 490B     	JSR     	@R9			;int ret = check_fix_command_param(&cr1,&cr2,&cr3,&cr4);
0068C0 0009     	NOP     				;
0068C2 4F26     	LDS.L   	@R15+,PR		;
0068C4 88FF     	CMP/EQ  	#FF,R0		;
0068C6 891B     	BT      	L006900		;if (ret == -1) return L0091E8(0,0,0,0,rr1,rr2,rr3,rr4);
0068C8 8801     	CMP/EQ  	#01,R0		;
0068CA 891E     	BT      	L00690A		;if (ret == 1) return L0091EC(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0068CC A020     	BRA     	L006910		;goto L006910;
0068CE 0009     	NOP     				;

L0068D0:							;put_sector_data_inner(u16 cr1,cr2,cr3,cr4,*rr1,*rr2,*rr3,*rr4)
0068D0 D92D     	MOV.L   	@(#0B4,PC),R9	;
0068D2 6090     	MOV.B   	@R9,R0		;
0068D4 C80E     	TST     	#0E,R0		;
0068D6 8B18     	BF      	L00690A		;if (*(u8*)0x0F000724 & 0x0E != 0) return L0091EC(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0068D8 6029     	SWAP.W   	R2,R0			;
0068DA 6008     	SWAP.B   	R0,R0			;
0068DC 600C     	EXTU.B   	R0,R0			;u8 num = cr3>>8;
0068DE E318     	MOV     	#18,R3		;
0068E0 633C     	EXTU.B   	R3,R3			;
0068E2 3032     	CMP/HS 	R3,R0			;
0068E4 8B01     	BF      	#002			;
0068E6 A00B     	BRA     	L006900		;if (num > 24) return L0091E8(0,0,0,0,rr1,rr2,rr3,rr4);
0068E8 0009     	NOP     				;
0068EA 632D     	EXTU.W   	R2,R3			;u8 sec = cr4;
0068EC D927     	MOV.L   	@(#09C,PC),R9	;
0068EE 6090     	MOV.B   	@R9,R0		;
0068F0 600C     	EXTU.B   	R0,R0			;
0068F2 3306     	CMP/HI 	R0,R3			;
0068F4 8909     	BT      	L00690A		;
0068F6 E000     	MOV     	#00,R0		;
0068F8 3030     	CMP/EQ 	R3,R0			;
0068FA 8906     	BT      	L00690A		;if (sec >= *(u8*)0x0F00034A || sec == 0) return L0091EC(cr1,cr2,cr3,cr4,rr1,rr2,rr3,rr4);
0068FC A018     	BRA     	L006930		;goto L006930;
0068FE 0009     	NOP     				;
L006900:
006900 D01A     	MOV.L   	@(#068,PC),R0	;
006902 3118     	SUB     	R1,R1			;
006904 3228     	SUB     	R2,R2			;
006906 A026     	BRA     	L006956		;
006908 3BB8     	SUB     	R11,R11		;
L00690A:
00690A D019     	MOV.L   	@(#064,PC),R0	;
00690C A023     	BRA     	L006956		;
...
L006DAC:							;int check_fix_command_param(u16 *cr1,*cr2,*cr3,*cr4)
006DAC 6029     	SWAP.W   	R2,R0			;
006DAE 6008     	SWAP.B   	R0,R0			;
006DB0 600C     	EXTU.B   	R0,R0			;u8 bufno = *cr3>>8;
006DB2 E318     	MOV     	#18,R3		;
006DB4 633C     	EXTU.B   	R3,R3			;
006DB6 3032     	CMP/HS 	R3,R0			;
006DB8 8B01     	BF      	#002			;
006DBA A02B     	BRA     	L006E14		;if (bufno >= 24) return -1;
...
006DC8 330C     	ADD     	R0,R3			;partition_data* pd = &partition_data_array[bufno];
006DCA 8432     	MOV.B   	@(#02,R3),R0	;
006DCC 600C     	EXTU.B   	R0,R0			;u8 size = pd->size;
006DCE 8800     	CMP/EQ  	#00,R0		;
006DD0 890A     	BT      	L006DE8		;if (size == 0) return 1;
006DD2 631D     	EXTU.W   	R1,R3			;u8 sec_offs = (u8)*cr2;
006DD4 3302     	CMP/HS 	R0,R3			;
006DD6 8B09     	BF      	L006DEC		;if (sec_offs >= size) {
...
006DE2 4128     	SHLL16  	R1			;  *cr2 = size - 1;
...
006E10 8B00     	BF      	#000			;
006E12 E001     	MOV     	#01,R0		;return (sec_num <= size ? 0 : 1);
L006E14:
006E14 000B     	RTS     				;
006E16 0009     	NOP     				;
...
L007380:							;set_filter_range(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
007380 6329     	SWAP.W   	R2,R3			;
007382 6338     	SWAP.B   	R3,R3			;
007384 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
007386 E018     	MOV     	#18,R0		;
007388 600C     	EXTU.B   	R0,R0			;
00738A 3302     	CMP/HS 	R0,R3			;
00738C 8B01     	BF      	L007392		;
00738E A1B1     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007390 0009     	NOP     				;
L007392:
007392 A19F     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007394 0009     	NOP     				;

;cdb command 41 "Get Filter Range"
L007396:							;get_filter_range(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
007396 6329     	SWAP.W   	R2,R3			;
007398 6338     	SWAP.B   	R3,R3			;
00739A 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
00739C E018     	MOV     	#18,R0		;
00739E 600C     	EXTU.B   	R0,R0			;
0073A0 3302     	CMP/HS 	R0,R3			;
0073A2 8B01     	BF      	#002			;
0073A4 A1A6     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0073A6 0009     	NOP     				;
0073A8 3CC8     	SUB     	R12,R12		;*rr1 = 0x0000; *rr2 = 0x0000;
0073AA 6D38     	SWAP.B   	R3,R13		;
0073AC 6DD9     	SWAP.W   	R13,R13		;*rr3 = filtno << 8; *rr4 = 0x0000;
0073AE E410     	MOV     	#10,R4		;
0073B0 644C     	EXTU.B   	R4,R4			;
0073B2 243E     	MULU.W  	R3,R4			;
0073B4 041A     	STS     	MACL, R4		;
0073B6 D3DD     	MOV.L   	@(#374,PC),R3	;
0073B8 343C     	ADD     	R3,R4			;filter_data* filter = &filter_data_array[filtno];
...
0073C0 A1A0     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0073C2 2D0B     	OR      	R0,R13		;

;cdb command 42 "Set Filter Subheader Conditions"
L0073C4:							;set_filter_subheader(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0073C4 6329     	SWAP.W   	R2,R3			;
0073C6 6338     	SWAP.B   	R3,R3			;
0073C8 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
0073CA E018     	MOV     	#18,R0		;
0073CC 600C     	EXTU.B   	R0,R0			;
0073CE 3302     	CMP/HS 	R0,R3			;
0073D0 8B01     	BF      	#002			;
0073D2 A18F     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0073D4 0009     	NOP     				;
0073D6 A17D     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0073D8 0009     	NOP     				;

;cdb command 43 "Get Filter Subheader Conditions"
L0073DA:							;get_filter_subheader(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0073DA 6329     	SWAP.W   	R2,R3			;
0073DC 6338     	SWAP.B   	R3,R3			;
0073DE 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
0073E0 E018     	MOV     	#18,R0		;
0073E2 600C     	EXTU.B   	R0,R0			;
0073E4 3302     	CMP/HS 	R0,R3			;
0073E6 8B01     	BF      	#002			;
0073E8 A184     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0073EA 0009     	NOP     				;
0073EC 3CC8     	SUB     	R12,R12		;*rr1 = 0x0000; *rr2 = 0x0000;
0073EE 6D38     	SWAP.B   	R3,R13		;
0073F0 6DD9     	SWAP.W   	R13,R13		;*rr3 = filtno << 8; *rr4 = 0x0000;
0073F2 E410     	MOV     	#10,R4		;
0073F4 644C     	EXTU.B   	R4,R4			;
0073F6 243E     	MULU.W  	R3,R4			;
0073F8 041A     	STS     	MACL, R4		;
0073FA D3CC     	MOV.L   	@(#330,PC),R3	;
0073FC 343C     	ADD     	R3,R4			;filter_data* filter = filter_data_array[filtno];
...
007418 A174     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00741A 2C2B     	OR      	R2,R12		;

;cdb command 44 "Set Filter Mode"
L00741C:							;set_filter_mode(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
00741C 6329     	SWAP.W   	R2,R3			;
00741E 6338     	SWAP.B   	R3,R3			;
007420 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
007422 E018     	MOV     	#18,R0		;
007424 600C     	EXTU.B   	R0,R0			;
007426 3302     	CMP/HS 	R0,R3			;
007428 8B01     	BF      	#002			;
00742A A163     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00742C 0009     	NOP     				;
00742E A151     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007430 0009     	NOP     				;

;cdb command 45 "Get Filter Mode"
L007432:							;get_filter_mode(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
007432 6329     	SWAP.W   	R2,R3			;
007434 6338     	SWAP.B   	R3,R3			;
007436 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
007438 E018     	MOV     	#18,R0		;
00743A 600C     	EXTU.B   	R0,R0			;
00743C 3302     	CMP/HS 	R0,R3			;
00743E 8B01     	BF      	#002			;
007440 A158     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007442 0009     	NOP     				;
007444 6D38     	SWAP.B   	R3,R13		;
007446 6DD9     	SWAP.W   	R13,R13		;*rr3 = filtno << 8; *rr4 = 0x0000;
007448 E410     	MOV     	#10,R4		;
00744A 644C     	EXTU.B   	R4,R4			;
00744C 243E     	MULU.W  	R3,R4			;
00744E 041A     	STS     	MACL, R4		;
007450 D3B6     	MOV.L   	@(#2D8,PC),R3	;
007452 343C     	ADD     	R3,R4			;filter_data* filter = filter_data_array[filtno];
007454 5040     	MOV.L   	@(#00,R4),R0	;
007456 4029     	SHLR16  	R0			;
007458 4019     	SHLR8   	R0			;*rr1 = (u16)filter.mode; *rr2 = 0x0000;
00745A A153     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00745C 6C09     	SWAP.W   	R0,R12		;

;cdb command 46 "Set Filter Connection"
L00745E:							;set_filter_connection(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
00745E 6329     	SWAP.W   	R2,R3			;
007460 6338     	SWAP.B   	R3,R3			;
007462 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
007464 E018     	MOV     	#18,R0		;
007466 600C     	EXTU.B   	R0,R0			;
007468 3302     	CMP/HS 	R0,R3			;
00746A 8B01     	BF      	#002			;
00746C A142     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00746E 0009     	NOP     				;
...
00748C A132     	BRA     	L0076F4		;  return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00748E 0009     	NOP     				;
L007490:
...
0074AA A123     	BRA     	L0076F4		;  return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0074AC 0009     	NOP     				;
L0074AE:
0074AE A111     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0074B0 0009     	NOP     				;

;cdb command 47 "Get Filter Connection"
L0074B2:							;get_filter_connection(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0074B2 6329     	SWAP.W   	R2,R3			;
0074B4 6338     	SWAP.B   	R3,R3			;
0074B6 633C     	EXTU.B   	R3,R3			;u8 filtno = cr3 >> 8;
0074B8 E018     	MOV     	#18,R0		;
0074BA 600C     	EXTU.B   	R0,R0			;
0074BC 3302     	CMP/HS 	R0,R3			;
0074BE 8B01     	BF      	#002			;
0074C0 A118     	BRA     	L0076F4		;if (filtno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0074C2 0009     	NOP     				;
0074C4 6D38     	SWAP.B   	R3,R13		;
0074C6 6DD9     	SWAP.W   	R13,R13		;*rr3 = filtno << 8; *rr4 = 0x0000;
...
0074D4 343C     	ADD     	R3,R4			;filter_connection* connection = filter_connection_array[filtno];
...
00750E A0F9     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007510 0009     	NOP     				;

;cdb command 48 "Reset Selector"
L007512:							;reset_selector(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
...
00752A A0E3     	BRA     	L0076F4		;  return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00752C 0009     	NOP     				;
L00752E:
00752E A0D1     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007530 0009     	NOP     				;
...
00754A A0DB     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00754C 2D3B     	OR      	R3,R13		;

;cdb command 60 "Set Sector Length"
L00754E:							;set_sector_length(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
...
007566 A0C5     	BRA     	L0076F4		;  return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007568 0009     	NOP     				;
L00756A:
...
007572 A0BF     	BRA     	L0076F4		;  return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
007574 0009     	NOP     				;
L007576:
...
L007586:
007586 3BB8     	SUB     	R11,R11		;*h = 0x00000000;
...
L007590:							;get_sector_number(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
007590 6029     	SWAP.W   	R2,R0			;
007592 6008     	SWAP.B   	R0,R0			;
007594 600C     	EXTU.B   	R0,R0			;u8 bufno = cr3 >> 8;
007596 E418     	MOV     	#18,R4		;
007598 644C     	EXTU.B   	R4,R4			;
00759A 3042     	CMP/HS 	R4,R0			;
00759C 8B01     	BF      	#002			;
00759E A0A9     	BRA     	L0076F4		;if (bufno >= 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075A0 0009     	NOP     				;
0075A2 E306     	MOV     	#06,R3		;
0075A4 203E     	MULU.W  	R3,R0			;
0075A6 D363     	MOV.L   	@(#18C,PC),R3	;
0075A8 001A     	STS     	MACL, R0		;
0075AA 330C     	ADD     	R0,R3			;partition_data* pd = &partition_data_array[bufno];
0075AC 8432     	MOV.B   	@(#02,R3),R0	;*rr1 = 0x0000; *rr2 = 0x0000;
0075AE 6D0C     	EXTU.B   	R0,R13		;*rr3 = 0x0000; *rr4 = pd->size;
0075B0 A0A8     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075B2 EC00     	MOV     	#00,R12		;

;cdb command 52 "Calculate Actual Size"
L0075B4:							;calc_actual_size(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0075B4 D968     	MOV.L   	@(#1A0,PC),R9	;
0075B6 4F22     	STS.L   	PR,@-R15		;
0075B8 490B     	JSR     	@R9			;int err = check_fix_command_param(&cr1,&cr2,&cr3,&cr4);
0075BA 0009     	NOP     				;
0075BC 4F26     	LDS.L   	@R15+,PR		;
0075BE 88FF     	CMP/EQ  	#FF,R0		;
0075C0 8B01     	BF      	#002			;
0075C2 A097     	BRA     	L0076F4		;if (err == -1) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075C4 0009     	NOP     				;
0075C6 8801     	CMP/EQ  	#01,R0		;if (err == 1) {
0075C8 8B01     	BF      	#002			;  *h = 0x00000000;
...
0075D0 A080     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075D2 ED00     	MOV     	#00,R13		;

;cdb command 53 "Get Actual Size"
L0075D4:							;get_actual_size(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
...
0075DC A092     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075DE 4C19     	SHLR8   	R12			;

;cdb command 54 "Get Sector Info"
L0075E0:							;get_sector_info(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0075E0 6029     	SWAP.W   	R2,R0			;
0075E2 6008     	SWAP.B   	R0,R0			;
0075E4 600C     	EXTU.B   	R0,R0			;u8 bufno = cr3 >> 8;
0075E6 E418     	MOV     	#18,R4		;
0075E8 644C     	EXTU.B   	R4,R4			;
0075EA 3042     	CMP/HS 	R4,R0			;
0075EC 8B01     	BF      	#002			;
0075EE A081     	BRA     	L0076F4		;if (bufno > 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0075F0 0009     	NOP     				;
0075F2 E306     	MOV     	#06,R3		;
0075F4 203E     	MULU.W  	R3,R0			;
0075F6 D34F     	MOV.L   	@(#13C,PC),R3	;
0075F8 001A     	STS     	MACL, R0		;
0075FA 330C     	ADD     	R0,R3			;partition_data* pd = &partition_data_array[bufno];
0075FC 8432     	MOV.B   	@(#02,R3),R0	;
0075FE 600C     	EXTU.B   	R0,R0			;
007600 8800     	CMP/EQ  	#00,R0		;
007602 8B01     	BF      	#002			;
007604 A07B     	BRA     	L0076FE		;if (pd->size == 0) return make_cd_status_80(rr1,rr2,rr3,rr4);
007606 0009     	NOP     				;
007608 631D     	EXTU.W   	R1,R3			;u8 spos = (u8)cr2;
00760A D454     	MOV.L   	@(#150,PC),R4	;
00760C 3430     	CMP/EQ 	R3,R4			;
00760E 8B05     	BF      	L00761C		;if (spos == 0xFF) {
007610 6303     	MOV     	R0,R3			;
007612 73FF     	ADD     	#FF,R3		;
007614 4129     	SHLR16  	R1			;
007616 4128     	SHLL16  	R1			;
007618 A004     	BRA     	L007624		;  cr2 = pd->size - 1;
00761A 213B     	OR      	R3,R1			;}
L00761C:
00761C 3302     	CMP/HS 	R0,R3			;else if (spos >= pd->size) {
00761E 8B01     	BF      	#002			;
...
007628 6323     	MOV     	R2,R3			;bufno = cr3 >> 8;
00762A 621D     	EXTU.W   	R1,R2			;spos = (u8)cr2;
00762C 6133     	MOV     	R3,R1			;
00762E D93B     	MOV.L   	@(#0EC,PC),R9	;
007630 4F22     	STS.L   	PR,@-R15		;
007632 490B     	JSR     	@R9			;u8 block = get_abs_block_pos(bufno,spos);
007634 0009     	NOP     				;
...
007642 441E     	LDC     	R4,GBR		;u8* sec_buf = cddata_dram_buf + (block * 2352);
007644 C603     	MOV.L   	@(#00C,GBR),R0	;sector_mode2_form2* sec_m2f2 = (sector_mode2_form2*)sec_buf;
007646 6103     	MOV     	R0,R1			;
007648 2F16     	MOV.L   	R1,@-R15		;u32 header = *(u32*)&sec_m2f2->header.min;
00764A D93E     	MOV.L   	@(#0F8,PC),R9	;
00764C 4F22     	STS.L   	PR,@-R15		;
00764E 490B     	JSR     	@R9			;u32 fad = msf2fad(header);
007650 0009     	NOP     				;
007652 4F26     	LDS.L   	@R15+,PR		;
007654 6C13     	MOV     	R1,R12		;*rr1 = fad>>16; *rr2 = fad & 0xFFFF;
007656 61F6     	MOV.L   	@R15+,R1		;
007658 A000     	BRA     	#0000			;
00765A 0009     	NOP     				;
00765C 601C     	EXTU.B   	R1,R0			;u32 subheader;
00765E 8802     	CMP/EQ  	#02,R0		;
007660 8B02     	BF      	L007668		;if (sec_m2f2->header.mode == 0x02)
007662 C604     	MOV.L   	@(#010,GBR),R0	;  subheader = *(u32*)&sec_m2f2->subheader.fn;
007664 A001     	BRA     	#0002			;else
007666 0009     	NOP     				;  subheader = 0;
007668 E000     	MOV     	#00,R0		;*rr3 = subheader>>16; *rr4 = subheader & 0xFFFF;
00766A A04B     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00766C 6D03     	MOV     	R0,R13		;

;cdb command 55 "Execute FAD Search"
L00766E:							;exec_fad_search(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
00766E 6029     	SWAP.W   	R2,R0			;
007670 6008     	SWAP.B   	R0,R0			;
007672 600C     	EXTU.B   	R0,R0			;u8 num = cr3 >> 8;
007674 E418     	MOV     	#18,R4		;
007676 644C     	EXTU.B   	R4,R4			;
007678 3042     	CMP/HS 	R4,R0			;
00767A 8B01     	BF      	#002			;
00767C A03A     	BRA     	L0076F4		;if (num > 24) return selector_error(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
00767E 0009     	NOP     				;
007680 E306     	MOV     	#06,R3		;
007682 203E     	MULU.W  	R3,R0			;
007684 D32B     	MOV.L   	@(#0AC,PC),R3	;
007686 001A     	STS     	MACL, R0		;
007688 330C     	ADD     	R0,R3			;partition_data* pd = &partition_data_array[num];
00768A 8432     	MOV.B   	@(#02,R3),R0	;
00768C 600C     	EXTU.B   	R0,R0			;
00768E 8800     	CMP/EQ  	#00,R0		;
007690 8B01     	BF      	#002			;
007692 A034     	BRA     	L0076FE		;if (pd->size == 0) return make_cd_status_80(rr1,rr2,rr3,rr4);
007694 0009     	NOP     				;
007696 631D     	EXTU.W   	R1,R3			;u8 sec = (u8)cr2;
007698 D430     	MOV.L   	@(#0C0,PC),R4	;
00769A 3430     	CMP/EQ 	R3,R4			;
00769C 8B05     	BF      	L0076AA		;if (sec == 0xFF) {
00769E 6303     	MOV     	R0,R3			;
0076A0 73FF     	ADD     	#FF,R3		;
0076A2 4129     	SHLR16  	R1			;
0076A4 4128     	SHLL16  	R1			;
0076A6 A004     	BRA     	L0076B2		;  cr2 = pd->size - 1;
0076A8 213B     	OR      	R3,R1			;}
L0076AA:
0076AA 3302     	CMP/HS 	R0,R3			;else if (sec >= pd->size) {
0076AC 8B01     	BF      	#002			;
0076AE A026     	BRA     	L0076FE		;  return make_cd_status_80(rr1,rr2,rr3,rr4);
0076B0 0009     	NOP     				;}
L0076B2:
0076B2 EC00     	MOV     	#00,R12		;*rr1 = *rr2 = *rr3 = *rr4 = 0x0000;
0076B4 A00E     	BRA     	L0076D4		;return set_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0076B6 ED00     	MOV     	#00,R13		;

;cdb command 56 "Get FAD Search Results"
L0076B8:							;get_fad_search(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0076B8 DA2C     	MOV.L   	@(#0B0,PC),R10	;
0076BA 6DA2     	MOV.L   	@R10,R13		;
0076BC 4D18     	SHLL8   	R13			;
0076BE 4D19     	SHLR8   	R13			;*rr3 = (search_result_fad>>16) & 0x00FF; 
0076C0 DA2B     	MOV.L   	@(#0AC,PC),R10	;*rr4 = search_result_fad & 0xFFFF;
0076C2 60A1     	MOV.W   	@R10,R0		;
0076C4 600C     	EXTU.B   	R0,R0			;
0076C6 6008     	SWAP.B   	R0,R0			;
0076C8 6009     	SWAP.W   	R0,R0			;
0076CA 2D0B     	OR      	R0,R13		;*rr3 |= search_result_partition<<8;
0076CC DA29     	MOV.L   	@(#0A4,PC),R10	;
0076CE 60A1     	MOV.W   	@R10,R0		;*rr1 = 0x0000; *rr2 = search_result_sector;
0076D0 A018     	BRA     	L007704		;return get_selector_inner(cr1,cr2,cr3,cr4,h,rr1,rr2,rr3,rr4);
0076D2 6C0D     	EXTU.W   	R0,R12		;

L0076D4:							;void set_selector_inner(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
0076D4 DB0F     	MOV.L   	@(#03C,PC),R11	;
0076D6 4F22     	STS.L   	PR,@-R15		;
0076D8 4B0B     	JSR     	@R11			;
0076DA 0009     	NOP     				;
0076DC 4F26     	LDS.L   	@R15+,PR		;
0076DE 8B01     	BF      	#002			;if (save_selector_param(cr1,cr2,cr3,cr4)) { 
0076E0 A00D     	BRA     	L0076FE		;  *h = 0x00000000;
...
L007704:							;void get_selector_inner(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
007704 D013     	MOV.L   	@(#04C,PC),R0	;
007706 3BB8     	SUB     	R11,R11		;*h = 0x00000000;
L007708:
007708 4F22     	STS.L   	PR,@-R15		;
00770A 400B     	JSR     	@R0			;get_rr1_status(rr1);//L0091A8
00770C 0009     	NOP     				;
...
L007778:							;bool save_selector_param(u16 cr1,cr2,cr3,cr4)
007778 D309     	MOV.L   	@(#024,PC),R3	;
00777A 6030     	MOV.B   	@R3,R0		;
00777C C801     	TST     	#01,R0		;
00777E 8901     	BT      	#002			;
007780 A006     	BRA     	L007790		;if (set_command_flag & 0x01 != 0) return true;
007782 0018     	SETT    				;
007784 D407     	MOV.L   	@(#01C,PC),R4	;
007786 2422     	MOV.L   	R2,@R4		;set_command_param[1] = (cr3 << 16) | cr4;
007788 2416     	MOV.L   	R1,@-R4		;set_command_param[0] = (cr1 << 16) | cr2;
00778A CB01     	OR      	#01,R0		;
00778C 2300     	MOV.B   	R0,@R3		;set_command_flag |= 0x01;
00778E 0008     	CLRT    				;return false;
L007790:
007790 000B     	RTS     				;
007792 0009     	NOP     				;

L007794:							;void clear_selector_param()
007794 D302     	MOV.L   	@(#008,PC),R3	;
007796 6030     	MOV.B   	@R3,R0		;
007798 C9FE     	AND     	#FE,R0		;set_command_flag &= ~0x01;
00779A 000B     	RTS     				;
...
0077AC 2101     	MOV.W   	R0,@R1		;auth_status_cd = 0x0000;
0077AE 000B     	RTS     				;
0077B0 0009     	NOP     				;

L0077B2:							;task7_thread()
0077B2 4F22     	STS.L   	PR,@-R15		;
0077B4 B154     	BRS     	L007A60		;task7_tread_init();
0077B6 0009     	NOP     				;
...
0077CA 892A     	BT      	L007822		;  case 0x06: goto task7_func_06;
0077CC E281     	MOV     	#81,R2		;
0077CE 622C     	EXTU.B   	R2,R2			;
0077D0 3020     	CMP/EQ 	R2,R0			;
0077D2 8947     	BT      	L007864		;  case 0x81: goto task7_func_81;
0077D4 8804     	CMP/EQ  	#04,R0		;
0077D6 897D     	BT      	L0078D4		;  case 0x04: goto task7_func_04;
0077D8 8803     	CMP/EQ  	#03,R0		;
0077DA 8B02     	BF      	L0077E2		;  case 0x03: goto task7_func_03;
0077DC D089     	MOV.L   	@(#224,PC),R0	;
0077DE 402B     	JMP     	@R0			;  default: task7_func_rest;
0077E0 0009     	NOP     				;}

L0077E2:							;task7_func_rest:
0077E2 8807     	CMP/EQ  	#07,R0		;
0077E4 8BEC     	BF      	L0077C0		;
0077E6 60BD     	EXTU.W   	R11,R0		;
0077E8 8800     	CMP/EQ  	#00,R0		;if (handle.fn != 0x07 || handle.arg != 0)
0077EA 8BE9     	BF      	L0077C0		;  goto task7_thread_loop;
0077EC D1DA     	MOV.L   	@(#368,PC),R1	;
0077EE 6010     	MOV.B   	@R1,R0		;
0077F0 600C     	EXTU.B   	R0,R0			;
0077F2 8802     	CMP/EQ  	#02,R0		;
0077F4 8B02     	BF      	L0077FC		;if (task7_state == 0x02) {
0077F6 E000     	MOV     	#00,R0		;  auth_status_cd = AUTH_STAT_NO_CD;
0077F8 A00B     	BRA     	L007812		;  *(u8*)0x0F000788 = 0x00;
0077FA 0009     	NOP     				;
L0077FC:
0077FC 8807     	CMP/EQ  	#07,R0		;}
0077FE 8B02     	BF      	L007806		;
007800 D08D     	MOV.L   	@(#234,PC),R0	;else if (task7_state == 0x07) {
007802 402B     	JMP     	@R0			;  goto L008BD4;
007804 0009     	NOP     				;}
L007806:
007806 8803     	CMP/EQ  	#03,R0		;
007808 8B02     	BF      	L007810 		;else if (task7_state == 0x03) {
00780A E000     	MOV     	#00,R0		;  auth_status_cd = AUTH_STAT_NO_CD;
00780C A001     	BRA     	L007812		;  *(u8*)0x0F000788 = 0x00;
00780E 0009     	NOP     				;}
L007810:
007810 E003     	MOV     	#03,R0		;else {
L007812:
007812 D1D2     	MOV.L   	@(#348,PC),R1	;
007814 8011     	MOV.B   	R0,@(#01,R1)	;  auth_status_cd = AUTH_STAT_NON_SATURN_DISK;
007816 D1CE     	MOV.L   	@(#338,PC),R1	;
007818 200A     	XOR     	R0,R0			;
00781A 2100     	MOV.B   	R0,@R1		;  *(u8*)0x0F000788 = 0x00;
00781C D086     	MOV.L   	@(#218,PC),R0	;}
00781E 402B     	JMP     	@R0			;goto L008BD4;
007820 0009     	NOP     				;

L007822:							;task7_func_06:
007822 60BD     	EXTU.W   	R11,R0		;
007824 8800     	CMP/EQ  	#00,R0		;
007826 8B0D     	BF      	L007844		;if (handle.arg == 0) {
007828 D1CA     	MOV.L   	@(#328,PC),R1	;
00782A 6010     	MOV.B   	@R1,R0		;
00782C 600C     	EXTU.B   	R0,R0			;
00782E 8800     	CMP/EQ  	#00,R0		;
007830 8902     	BT      	L007838		;
007832 D17F     	MOV.L   	@(#1FC,PC),R1	;
007834 412B     	JMP     	@R1			;  if (auth_device_flag != 0) goto L008494();
007836 0009     	NOP     				;
L007838:
007838 4F22     	STS.L   	PR,@-R15		;
00783A B13F     	BRS     	L007ABC		;  task7_reinit();
00783C 0009     	NOP     				;
00783E 4F26     	LDS.L   	@R15+,PR		;
007840 AFBE     	BRA     	L0077C0		;  goto task7_thread_loop;
007842 0009     	NOP     				;}
L007844:
007844 8801     	CMP/EQ  	#01,R0		;
007846 8B01     	BF      	L00784C		;else if (handle.arg == 0x0001) {
007848 AFBA     	BRA     	L0077C0		;  goto task7_thread_loop;
00784A 0009     	NOP     				;}
00784C 8802     	CMP/EQ  	#02,R0		;
00784E 8B02     	BF      	L007856 		;else if (handle.arg == 0x0002) {
007850 D178     	MOV.L   	@(#1E0,PC),R1	;
007852 412B     	JMP     	@R1			;  goto L008952();
007854 0009     	NOP     				;}
L007856:
007856 8803     	CMP/EQ  	#03,R0		;
007858 8B02     	BF      	L007860		;else if (handle.arg == 0x0003) {
00785A D175     	MOV.L   	@(#1D4,PC),R1	;
00785C 412B     	JMP     	@R1			;  goto L008494();
00785E 0009     	NOP     				;}
L007860:
007860 AFAE     	BRA     	L0077C0		;goto task7_thread_loop;
007862 0009     	NOP     				;

L007864:							;task7_func_81:
007864 60BD     	EXTU.W   	R11,R0		;
007866 8800     	CMP/EQ  	#00,R0		;
007868 8B07     	BF      	L00787A		;if (handle.arg == 0x0000) {
00786A D16E     	MOV.L   	@(#1B8,PC),R1	;
00786C 6012     	MOV.L   	@R1,R0		;
00786E 8800     	CMP/EQ  	#00,R0		;
007870 8901     	BT      	#002			;  if (*(u32*)0x0F000760 != 0)
007872 A1C8     	BRA     	L007C06		;    goto L007C06;
007874 0009     	NOP     				;
007876 A179     	BRA     	L007B6C		;  goto task7_func_810000;
007878 0009     	NOP     				;}
L00787A:
00787A 8801     	CMP/EQ  	#01,R0		;
00787C 8B01     	BF      	#002			;else if (handle.arg == 0x0001) 
00787E A303     	BRA     	L007E88		;  goto task7_func_810001;
007880 0009     	NOP     				;
007882 8804     	CMP/EQ  	#04,R0		;
007884 8B01     	BF      	#002			;else if (handle.arg == 0x0004) 
007886 A343     	BRA     	L007F10		;  goto task7_func_810004;
007888 0009     	NOP     				;
00788A 8805     	CMP/EQ  	#05,R0		;
00788C 8B01     	BF      	#002			;else if (handle.arg == 0x0005) 
00788E A359     	BRA     	L007F44		;  goto task7_func_810005;
007890 0009     	NOP     				;
007892 8802     	CMP/EQ  	#02,R0		;
007894 8B01     	BF      	#002			;else if (handle.arg == 0x0002) 
007896 A377     	BRA     	L007F88		;  goto task7_func_810002;
007898 0009     	NOP     				;
00789A 8806     	CMP/EQ  	#06,R0		;
00789C 8B01     	BF      	#002			;else if (handle.arg == 0x0006) 
00789E A4C3     	BRA     	L008228		;  goto task7_func_810006;
0078A0 0009     	NOP     				;
0078A2 8807     	CMP/EQ  	#07,R0		;
0078A4 8B01     	BF      	#002			;else if (handle.arg == 0x0007) 
0078A6 A004     	BRA     	L0078B2		;  goto task7_func_810007;
0078A8 0009     	NOP     				;
0078AA 8808     	CMP/EQ  	#08,R0		;
0078AC 8B88     	BF      	L0077C0		;else if (handle.arg == 0x0008) 
0078AE A62F     	BRA     	L008510		;  goto task7_func_810008;
0078B0 0009     	NOP     				;else goto task7_thread_loop;

L0078B2:							;task7_func_810007:
0078B2 D164     	MOV.L   	@(#190,PC),R1	;
0078B4 6010     	MOV.B   	@R1,R0		;
0078B6 600C     	EXTU.B   	R0,R0			;
0078B8 8800     	CMP/EQ  	#00,R0		;
0078BA 8B05     	BF      	L0078C8		;if (0F00076C) {
0078BC 90C8     	MOV.W   	@(#190,PC),R0	;
0078BE 600D     	EXTU.W   	R0,R0			;
0078C0 D397     	MOV.L   	@(#25C,PC),R3	;
0078C2 2301     	MOV.W   	R0,@R3		;  YGR.HIRQ = HIRQ_EFLS;
0078C4 AF7C     	BRA     	L0077C0		;  goto task7_thread_loop;
0078C6 0009     	NOP     				;}
L0078C8:
0078C8 D1A6     	MOV.L   	@(#298,PC),R1	;else {
...
L0078D4:							;task7_func_04:
0078D4 60BD     	EXTU.W   	R11,R0		;
0078D6 8802     	CMP/EQ  	#02,R0		;
0078D8 8B01     	BF      	#002			;
0078DA AF71     	BRA     	L0077C0		;if (handle.arg >= 0x0002)
0078DC 0009     	NOP     				;  goto task7_thread_loop;
0078DE 8800     	CMP/EQ  	#00,R0		;
0078E0 8905     	BT      	L0078EE		;
0078E2 8801     	CMP/EQ  	#01,R0		;
0078E4 8901     	BT      	#002			;
0078E6 AF6B     	BRA     	L0077C0		;else if (handle.arg == 0x0001)
0078E8 0009     	NOP     				;  goto L0082BE;
0078EA A4E8     	BRA     	L0082BE		;
0078EC 0009     	NOP     				;
L0078EE:
0078EE D19A     	MOV.L   	@(#268,PC),R1	;//handle.arg == 0x0000
0078F0 6010     	MOV.B   	@R1,R0		;
0078F2 600C     	EXTU.B   	R0,R0			;
0078F4 8801     	CMP/EQ  	#01,R0		;
0078F6 892D     	BT      	L007954		;if (task7_state == 0x01)
0078F8 8803     	CMP/EQ  	#03,R0		;  goto task7_process_fs;
0078FA 8B01     	BF      	#002			;else if (task7_state == 0x03)
0078FC A6E9     	BRA     	L0086D2		;  goto task7_process_boot_sector;
0078FE 0009     	NOP     				;
007900 8806     	CMP/EQ  	#06,R0		;
007902 8B02     	BF      	#004			;
007904 D04E     	MOV.L   	@(#138,PC),R0	;else if (task7_state == 0x06)
007906 402B     	JMP     	@R0			;  goto L008A60;
007908 0009     	NOP     				;
00790A 8807     	CMP/EQ  	#07,R0		;
00790C 891F     	BT      	L00794E		;else if (task7_state == 0x07)
00790E 8804     	CMP/EQ  	#04,R0		;  goto L008DA8;
007910 8901     	BT      	#002			;else if (task7_state != 0x04)
007912 AF55     	BRA     	L0077C0		;  goto task7_thread_loop;
007914 0009     	NOP     				;
007916 4F22     	STS.L   	PR,@-R15		;else {
007918 DB3E     	MOV.L   	@(#0F8,PC),R11	;
00791A C32A     	TRAPA   	#42			;  TRAPA_42(0x0B070000);
...
00792A 312C     	ADD     	R2,R1			;  partition_data* pd = &partition_data_array[curr_buf_num];
00792C 8412     	MOV.B   	@(#02,R1),R0	;
00792E D147     	MOV.L   	@(#11C,PC),R1	;
007930 6210     	MOV.B   	@R1,R2		;
007932 622C     	EXTU.B   	R2,R2			;
007934 3028     	SUB     	R2,R0			;  u8 temp = pd->size - *(u8*)0x0F00078B;
007936 8800     	CMP/EQ  	#00,R0		;
007938 8904     	BT      	L007944		;
00793A 6133     	MOV     	R3,R1			;
00793C 6303     	MOV     	R0,R3			;
00793E D038     	MOV.L   	@(#0E0,PC),R0	;
007940 400B     	JSR     	@R0			;  if (temp != 0) L0051BE(num,temp);
007942 0009     	NOP     				;
L007944:
007944 DB33     	MOV.L   	@(#0CC,PC),R11	;
007946 C327     	TRAPA   	#39			;  TRAP_39(0x0B070000);
007948 4F26     	LDS.L   	@R15+,PR		;
00794A AF39     	BRA     	L0077C0		;  goto task7_thread_loop;
00794C 0009     	NOP     				;}
...
L007954:							;task7_process_fs:
007954 D283     	MOV.L   	@(#20C,PC),R2	;
007956 6020     	MOV.B   	@R2,R0		;
007958 600C     	EXTU.B   	R0,R0			;
00795A 8802     	CMP/EQ  	#02,R0		;
00795C 8B01     	BF      	#002			;if (*(u8*)0x0F00076B == 0x02)
00795E AF2F     	BRA     	L0077C0		;  goto task7_thread_loop;
007960 0009     	NOP     				;
007962 DB2C     	MOV.L   	@(#0B0,PC),R11	;
007964 C32A     	TRAPA   	#42			;TRAP_42(0x0B070000);
...
007972 400B     	JSR     	@R0			;u8 sec = get_abs_block_pos(curr_buf_num,0);//L00506C
007974 0009     	NOP     				;
007976 DB27     	MOV.L   	@(#09C,PC),R11	;
007978 C327     	TRAPA   	#39			;TRAP_39(0x0B070000);
00797A D425     	MOV.L   	@(#094,PC),R4	;
00797C 241E     	MULU.W  	R1,R4			;
00797E 011A     	STS     	MACL, R1		;
007980 D222     	MOV.L   	@(#088,PC),R2	;
007982 312C     	ADD     	R2,R1			;u8* sec_buf = cddata_dram_buf + (sec * 2352);
007984 841F     	MOV.B   	@(#0F,R1),R0	;sector_mode1* sec_ptr = sec_buf;
...
007990 0009     	NOP     				;
007992 7110     	ADD     	#10,R1		;u8* sec_data = sec_ptr->header.mode == 2 ? &sec_buf[24] : &sec_buf[16];
007994 D22B     	MOV.L   	@(#0AC,PC),R2	;0F00076C
007996 6020     	MOV.B   	@R2,R0		;
007998 600C     	EXTU.B   	R0,R0			;
00799A 8801     	CMP/EQ  	#01,R0		;
00799C 8B02     	BF      	L0079A4		;
00799E D096     	MOV.L   	@(#258,PC),R0	;
0079A0 402B     	JMP     	@R0			;
0079A2 0009     	NOP     				;
L0079A4:
0079A4 8814     	CMP/EQ  	#14,R0		;
0079A6 8B06     	BF      	L0079B6		;
...
0079D4 8902     	BT      	L0079DC		;
0079D6 6613     	MOV     	R1,R6			;
0079D8 A13A     	BRA     	L007C50		;return read_dirs_from_sector(sec_data);
0079DA 0009     	NOP     				;
L0079DC:
...
L0079E4:							;task7_func_03:
0079E4 60BD     	EXTU.W   	R11,R0		;
0079E6 8800     	CMP/EQ  	#00,R0		;
0079E8 8B01     	BF      	#002			;if (handle.arg == 0x0000)
0079EA AEE9     	BRA     	L0077C0		;  goto task7_thread_loop;
0079EC 0009     	NOP     				;
0079EE 8801     	CMP/EQ  	#01,R0		;
0079F0 8B01     	BF      	#002			;else if (handle.arg == 0x0001)
0079F2 A02E     	BRA     	L007A52		;  goto task7_func_03_0001;
0079F4 0009     	NOP     				;
0079F6 6103     	MOV     	R0,R1			;
0079F8 9006     	MOV.W   	@(#00C,PC),R0	;
0079FA 620D     	EXTU.W   	R0,R2			;
0079FC 3120     	CMP/EQ 	R2,R1			;
0079FE 8928     	BT      	L007A52		;
007A00 AEDE     	BRA     	L0077C0		;goto task7_thread_loop;
007A02 0009     	NOP     				;
007A04 000079E4
007A08 0000
007A0A FFFF
...
007A4C 0F00078B
007A50 0200
L007A52:							;task7_func_03_0001:
007A52 DB02     	MOV.L   	@(#008,PC),R11	;
007A54 C327     	TRAPA   	#39			;TRAP_39(0x03070000);
007A56 AEB3     	BRA     	L0077C0		;goto task7_thread_loop;
007A58 0009     	NOP     				;
007A5A 0009     	NOP     				;
007A5C 03070000

L007A60:							;void task7_tread_init()
007A60 255A     	XOR     	R5,R5			;
007A62 D32D     	MOV.L   	@(#0B4,PC),R3	;
007A64 200A     	XOR     	R0,R0			;
007A66 2302     	MOV.L   	R0,@R3		;*(u32*)0x0F000744 = 0x00000000;
007A68 1301     	MOV.L   	R0,@(#4,R3)		;*(u32*)0x0F000748 = 0x00000000;
007A6A 1302     	MOV.L   	R0,@(#8,R3)		;*(u32*)0x0F00074C = 0x00000000;
007A6C 1303     	MOV.L   	R0,@(#C,R3)		;*(u32*)0x0F000750 = 0x00000000;
007A6E 1304     	MOV.L   	R0,@(#10,R3)	;*(u32*)0x0F000754 = 0x00000000;
007A70 D3E6     	MOV.L   	@(#398,PC),R3	;
007A72 2302     	MOV.L   	R0,@R3		;*(u32*)0x0F00075C = 0x00000000;
007A74 1302     	MOV.L   	R0,@(#8,R3)		;*(u32*)0x0F000764 = 0x00000000;
007A76 1303     	MOV.L   	R0,@(#C,R3)		;*(u32*)0x0F000768 = 0x00000000;
007A78 1304     	MOV.L   	R0,@(#10,R3)	;*(u32*)0x0F00076C = 0x00000000;
007A7A 813A     	MOV.W   	R0,@(#14,R3)	;*(u16*)0x0F000770 = 0x0000;
007A7C D327     	MOV.L   	@(#09C,PC),R3	;
007A7E 2300     	MOV.B   	R0,@R3		;curr_buf_num = 0x00;
007A80 D128     	MOV.L   	@(#0A0,PC),R1	;
007A82 2102     	MOV.L   	R0,@R1		;auth_device_cmd = {0x0000,0x0000,0x0000,0x0000};
007A84 1101     	MOV.L   	R0,@(#4,R1)		;
007A86 D128     	MOV.L   	@(#0A0,PC),R1	;
007A88 2102     	MOV.L   	R0,@R1		;*(u32*)0x0907ADB8 = 0x00000000;
007A8A 1101     	MOV.L   	R0,@(#4,R1)		;*(u32*)0x0907ADBC = 0x00000000;
007A8C 1102     	MOV.L   	R0,@(#8,R1)		;*(u32*)0x0907ADC0 = 0x00000000;
007A8E D127     	MOV.L   	@(#09C,PC),R1	;
007A90 2102     	MOV.L   	R0,@R1		;
007A92 1101     	MOV.L   	R0,@(#4,R1)		;memset(ip_maker_id,0,8);
007A94 D126     	MOV.L   	@(#098,PC),R1	;
007A96 2102     	MOV.L   	R0,@R1		;
007A98 1101     	MOV.L   	R0,@(#4,R1)		;
007A9A 8114     	MOV.W   	R0,@(#08,R1)	;memset(ip_product_number,0,10);
007A9C D125     	MOV.L   	@(#094,PC),R1	;
007A9E 2101     	MOV.W   	R0,@R1		;*(u16*)0x0907ADC8 = 0x0000;
007AA0 D125     	MOV.L   	@(#094,PC),R1	;
007AA2 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCE = 0x00;
007AA4 D125     	MOV.L   	@(#094,PC),R1	;
007AA6 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCD = 0x00;
007AA8 D125     	MOV.L   	@(#094,PC),R1	;
007AAA 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCF = 0x00;
007AAC D125     	MOV.L   	@(#094,PC),R1	;
007AAE 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCA = 0x00;
007AB0 D125     	MOV.L   	@(#094,PC),R1	;
007AB2 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCC = 0x00;
007AB4 D125     	MOV.L   	@(#094,PC),R1	;
007AB6 2100     	MOV.B   	R0,@R1		;*(u8*)0x00F000789 = 0x00;
007AB8 A006     	BRA     	L007AC8		;return task7_init_common(0);
007ABA 0009     	NOP     				;

L007ABC:							;void task7_reinit()
007ABC E000     	MOV     	#00,R0		;
007ABE D127     	MOV.L   	@(#09C,PC),R1	;
007AC0 8011     	MOV.B   	R0,@(#01,R1)	;auth_status_cd = AUTH_STAT_NO_CD;
007AC2 D123     	MOV.L   	@(#08C,PC),R1	;
007AC4 2100     	MOV.B   	R0,@R1		;*(u8*)0x00F000788 = 0x00;
007AC6 E501     	MOV     	#01,R5		;return task7_init_common(1);

L007AC8:							;void task7_init_common(u8 efls_set)
007AC8 D3D3     	MOV.L   	@(#34C,PC),R3	;u32* ptr = 0x09074210;
007ACA 904D     	MOV.W   	@(#09A,PC),R0	;u16 len = 0x0C00;
007ACC 600D     	EXTU.W   	R0,R0			;
007ACE 222A     	XOR     	R2,R2			;
L007AD0:							;do {
007AD0 2322     	MOV.L   	R2,@R3		;  *ptr = 0x00000000;
007AD2 70FC     	ADD     	#FC,R0		;  len -= 4;
007AD4 8800     	CMP/EQ  	#00,R0		;
007AD6 8902     	BT      	L007ADE		;
007AD8 7304     	ADD     	#04,R3		;  ptr++;
007ADA AFF9     	BRA     	L007AD0		;
007ADC 0009     	NOP     				;} while (len > 0);
L007ADE:
007ADE D3D3     	MOV.L   	@(#34C,PC),R3	;
007AE0 200A     	XOR     	R0,R0			;
007AE2 2302     	MOV.L   	R0,@R3		;*(u32*)0x0F000758 = 0x00000000;
007AE4 1302     	MOV.L   	R0,@(#8,R3)		;*(u32*)0x0F000760 = 0x00000000;
007AE6 8137     	MOV.W   	R0,@(#0E,R3)	;*(u16*)0x0F000766 = 0x0000;
007AE8 D31E     	MOV.L   	@(#078,PC),R3	;
007AEA 2300     	MOV.B   	R0,@R3		;*(u8*)0x0F00076B = 0x00;
007AEC D11C     	MOV.L   	@(#070,PC),R1	;
007AEE 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F00078A = 0x00;
007AF0 D119     	MOV.L   	@(#064,PC),R1	;
007AF2 6010     	MOV.B   	@R1,R0		;
007AF4 600C     	EXTU.B   	R0,R0			;
007AF6 8800     	CMP/EQ  	#00,R0		;
007AF8 8902     	BT      	L007B00		;
007AFA 200A     	XOR     	R0,R0			;
007AFC D115     	MOV.L   	@(#054,PC),R1	;if (task7_state != 0)
007AFE 2100     	MOV.B   	R0,@R1		;  auth_device_flag = 0x00;
L007B00:
007B00 200A     	XOR     	R0,R0			;
007B02 D115     	MOV.L   	@(#054,PC),R1	;
007B04 2100     	MOV.B   	R0,@R1		;task7_state = 0x00;
007B06 6053     	MOV     	R5,R0			;
007B08 8800     	CMP/EQ  	#00,R0		;
007B0A 8903     	BT      	L007B14		;if (efls_set) {
007B0C 902D     	MOV.W   	@(#05A,PC),R0	;
007B0E 600D     	EXTU.W   	R0,R0			;
007B10 D303     	MOV.L   	@(#00C,PC),R3	;
007B12 2301     	MOV.W   	R0,@R3		;  YGR.HIRQ = IRQ_EFLS;
L007B14:							;}
007B14 000B     	RTS     				;
007B16 0009     	NOP     				;
007B18 0F000744
...
007BBE 2432     	MOV.L   	R3,@R4		;*(u32*)0x0F000760 = + 150;
...
007C08 6102     	MOV.L   	@R0,R1		;u32 temp = *(u32*)0x0F000760;
007C0A 6313     	MOV     	R1,R3			;
007C0C D00F     	MOV.L   	@(#03C,PC),R0	;
007C0E 2012     	MOV.L   	R1,@R0		;FAD_02BC = temp;
007C10 E102     	MOV     	#02,R1		;
007C12 611C     	EXTU.B   	R1,R1			;
007C14 D086     	MOV.L   	@(#218,PC),R0	;
007C16 2010     	MOV.B   	R1,@R0		;*(u8*)0x0F00076C = 0x02;
...
007C22 2021     	MOV.W   	R2,@R0		;*(u16*)0x0F000768 = 0x0000;
007C24 D07B     	MOV.L   	@(#1EC,PC),R0	;
007C26 2012     	MOV.L   	R1,@R0		;*(u32*)0x0F00074C = *(u16*)0x0F000766;
007C28 D076     	MOV.L   	@(#1D8,PC),R0	;
007C2A 2020     	MOV.B   	R2,@R0		;*(u8*)0x0F00076D = 0x00;
007C2C D106     	MOV.L   	@(#018,PC),R1	;
007C2E E040     	MOV     	#40,R0		;
007C30 600C     	EXTU.B   	R0,R0			;
007C32 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F000771 = 0x40;
007C34 D07D     	MOV.L   	@(#1F4,PC),R0	;
007C36 E202     	MOV     	#02,R2		;
007C38 4218     	SHLL8   	R2			;
007C3A 2022     	MOV.L   	R2,@R0		;*(u16*)0x0F000758 = 0x0200;
007C3C D2AD     	MOV.L   	@(#2B4,PC),R2	;
007C3E E001     	MOV     	#01,R0		;
007C40 600C     	EXTU.B   	R0,R0			;
007C42 2200     	MOV.B   	R0,@R2		;*(u8*)0x0F00076B = 0x01;
007C44 A38D     	BRA     	L008362		;goto L008362;
007C46 0009     	NOP     				;
007C48 0F000771
007C4C 0F0002BC

L007C50:							;void read_dirs_from_sector(u8* sec_data)//sec_data-R1
007C50 D06B     	MOV.L   	@(#1AC,PC),R0	;u8* start = sec_data;
007C52 6201     	MOV.W   	@R0,R2		;
007C54 622D     	EXTU.W   	R2,R2			;
007C56 D070     	MOV.L   	@(#1C0,PC),R0	;
007C58 320C     	ADD     	R0,R2			;file_info* fi = (u8*)file_info_table + *(u16*)0x0F000768;
007C5A D06A     	MOV.L   	@(#1A8,PC),R0	;
007C5C 6800     	MOV.B   	@R0,R8		;
007C5E 688C     	EXTU.B   	R8,R8			;u8 num = *(u8*)0x0F00076D;
007C60 D06C     	MOV.L   	@(#1B0,PC),R0	;0F00074C
007C62 6902     	MOV.L   	@R0,R9		;
L007C64:
007C64 6510     	MOV.B   	@R1,R5		;do {
007C66 655C     	EXTU.B   	R5,R5			;
007C68 6053     	MOV     	R5,R0			;  fs_dir *dir = sec_data;
007C6A 8800     	CMP/EQ  	#00,R0		;
007C6C 8942     	BT      	L007CF4		;  if (!dir->len) break;
007C6E 6313     	MOV     	R1,R3			;  
007C70 315C     	ADD     	R5,R1			;  sec_data += dir->len;
...
007C84 2202     	MOV.L   	R0,@R2		;  fi->fad = dir->extent + 150;
...
007C92 1201     	MOV.L   	R0,@(#4,R2)		;  fi->size = dir->size;
007C94 730B     	ADD     	#0B,R3		;
007C96 6530     	MOV.B   	@R3,R5		;
007C98 605C     	EXTU.B   	R5,R0			;
007C9A C902     	AND     	#02,R0		;
007C9C 6503     	MOV     	R0,R5			;  u8 dir_flag = dir->flags & 0x02;
007C9E 7301     	ADD     	#01,R3		;
007CA0 6031     	MOV.W   	@R3,R0		;
007CA2 600D     	EXTU.W   	R0,R0			;
007CA4 8124     	MOV.W   	R0,@(#08,R2)	;  fi->m8 = dir->file_unit_size;
007CA6 7306     	ADD     	#06,R3		;  fi->m9 = dir->interleave;
007CA8 6030     	MOV.B   	@R3,R0		;
007CAA 600C     	EXTU.B   	R0,R0			;
007CAC 330C     	ADD     	R0,R3			;
007CAE 7301     	ADD     	#01,R3		;
007CB0 C801     	TST     	#01,R0		;  u32 name_len = dir->name_len + 1 + (dir->name_len & 1 ? 0 : 1);
007CB2 8B00     	BF      	#000			;
007CB4 7301     	ADD     	#01,R3		;  dir = (fs_dir*)(sizeof(fs_dir) + name_len);
007CB6 3130     	CMP/EQ 	R3,R1			;
007CB8 8B05     	BF      	L007CC6		;  if (sec_data == dir) {
007CBA 200A     	XOR     	R0,R0			;
007CBC 802A     	MOV.B   	R0,@(#0A,R2)	;    fi->m10 = 0;
007CBE 6053     	MOV     	R5,R0			;
007CC0 802B     	MOV.B   	R0,@(#0B,R2)	;    fi->m11 = dir_flag;
007CC2 A00B     	BRA     	L007CDC		;  }
007CC4 0009     	NOP     				;  else {
L007CC6:
...
007D80 0009     	NOP     				;
L007D82:							;
007D82 78FF     	ADD     	#FF,R8		;num--;
007D84 6010     	MOV.B   	@R1,R0		;sec_data
...
007DD0 6A12     	MOV.L   	@R1,R10		;u32 temp = *(u32*)0x0F000758;
007DD2 4A19     	SHLR8   	R10			;
007DD4 4A18     	SHLL8   	R10			;temp &= 0xFFFFFF00;
007DD6 6083     	MOV     	R8,R0			;
007DD8 8800     	CMP/EQ  	#00,R0		;
007DDA 8B02     	BF      	L007DE2		;if (!num)
007DDC 2AAA     	XOR     	R10,R10		;  temp = 0;
007DDE A001     	BRA     	L007DE4		;
007DE0 0009     	NOP     				;else
007DE2 2A8B     	OR      	R8,R10		;  temp |= num;
007DE4 21A2     	MOV.L   	R10,@R1		;*(u32*)0x0F000758 = temp;
007DE6 D143     	MOV.L   	@(#10C,PC),R1	;
007DE8 E002     	MOV     	#02,R0		;
007DEA 600C     	EXTU.B   	R0,R0			;
007DEC 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F00076B = 0x02;
007DEE A266     	BRA     	L0082BE		;goto L0082BE;
007DF0 0009     	NOP     				;
007DF2 0009     	NOP     				;
007DF4 0000
007DF6 7C50
...
L008510:							;task7_func_81_0008:
008510 D131     	MOV.L   	@(#0C4,PC),R1	;
008512 D232     	MOV.L   	@(#0C8,PC),R2	;
008514 6020     	MOV.B   	@R2,R0		;
008516 2100     	MOV.B   	R0,@R1		;*(u8*)(0x0907ADD0+0x00) = init_cd_flags;
008518 E000     	MOV     	#00,R0		;
00851A 2200     	MOV.B   	R0,@R2		;init_cd_flags = 0x00;
00851C D230     	MOV.L   	@(#0C0,PC),R2	;
00851E 6020     	MOV.B   	@R2,R0		;
008520 8011     	MOV.B   	R0,@(#01,R1)	;*(u8*)(0x0907ADD0+0x01) = init_cd_ecc;
008522 E005     	MOV     	#05,R0		;
008524 2200     	MOV.B   	R0,@R2		;init_cd_ecc = 0x05;
008526 D22F     	MOV.L   	@(#0BC,PC),R2	;
008528 6020     	MOV.B   	@R2,R0		;
00852A 8012     	MOV.B   	R0,@(#02,R1)	;*(u8*)(0x0907ADD0+0x02) = init_cd_retry;
00852C E00F     	MOV     	#0F,R0		;
00852E 2200     	MOV.B   	R0,@R2		;init_cd_retry = 0x0F;
008530 D158     	MOV.L   	@(#160,PC),R1	;
008532 6010     	MOV.B   	@R1,R0		;
008534 600C     	EXTU.B   	R0,R0			;
008536 8800     	CMP/EQ  	#00,R0		;
008538 8B02     	BF      	L008540		;
00853A E000     	MOV     	#00,R0		;if (cd_status == 0x00)
00853C A348     	BRA     	L008BD0		;  goto L008BD0(0x00);
00853E 0009     	NOP     				;
L008540:
008540 8806     	CMP/EQ  	#06,R0		;
008542 8B02     	BF      	#004			;
008544 E000     	MOV     	#00,R0		;else if (cd_status == 0x06)
008546 A343     	BRA     	L008BD0		;  goto L008BD0(0x00);
008548 0009     	NOP     				;
00854A 8807     	CMP/EQ  	#07,R0		;
00854C 8B02     	BF      	#004			;
00854E E000     	MOV     	#00,R0		;else if (cd_status == 0x07)
008550 A33E     	BRA     	L008BD0		;  goto L008BD0(0x00);
008552 0009     	NOP     				;
...
00855C 8902     	BT      	#004			;
00855E E000     	MOV     	#00,R0		;if (*(u8*)0x0F00034B != 0)
008560 A336     	BRA     	L008BD0		;  goto L008BD0(0x00);
008562 0009     	NOP     				;
008564 200A     	XOR     	R0,R0			;
008566 D14F     	MOV.L   	@(#13C,PC),R1	;
008568 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCF = 0x00;
00856A D14F     	MOV.L   	@(#13C,PC),R1	;
00856C 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCA = 0x00;
00856E D14F     	MOV.L   	@(#13C,PC),R1	;
008570 2100     	MOV.B   	R0,@R1		;*(u8*)0x0907ADCC = 0x00;
008572 D11E     	MOV.L   	@(#078,PC),R1	;
008574 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F000789 = 0x00;
008576 D14A     	MOV.L   	@(#128,PC),R1	;
008578 E0FF     	MOV     	#FF,R0		;
00857A 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F000788 = 0xFF;
00857C D04C     	MOV.L   	@(#130,PC),R0	;
00857E 6106     	MOV.L   	@R0+,R1		;u32 temp1 = *(u32*)(0x0F0002E0+0x00);
008580 6206     	MOV.L   	@R0+,R2		;u32 temp2 = *(u32*)(0x0F0002E0+0x04);
008582 6302     	MOV.L   	@R0,R3		;u32 temp3 = *(u32*)(0x0F0002E0+0x08);
008584 4109     	SHLR2   	R1			;
008586 3212     	CMP/HS 	R1,R2			;
008588 8B12     	BF      	L0085B0		;
00858A 3312     	CMP/HS 	R1,R3			;
00858C 8B10     	BF      	L0085B0		;if (temp2 >= temp1>>2 && temp3 >= temp1>>2) {
00858E D116     	MOV.L   	@(#058,PC),R1	;
008590 E263     	MOV     	#63,R2		;
008592 4208     	SHLL2   	R2			;
008594 312C     	ADD     	R2,R1			;  info_track_t first_track,last_track;
008596 6216     	MOV.L   	@R1+,R2		;  first_track.v = toc_dram_buf[100-1];
008598 6012     	MOV.L   	@R1,R0		;  last_track.v = toc_dram_buf[101-1];
...
0085A8 8B02     	BF      	L0085B0		;
0085AA D13C     	MOV.L   	@(#0F0,PC),R1	;
0085AC E001     	MOV     	#01,R0		;  if (last_track.num - first_track.num + 1 == 30)
0085AE 2100     	MOV.B   	R0,@R1		;    *(u8*)0x0F00078A = 0x01;
L0085B0:							;}
...
0085C4 330C     	ADD     	R0,R3			;track_t track;
0085C6 6032     	MOV.L   	@R3,R0		;track.v = toc_dram_buf[first_track.num - 1];
0085C8 4029     	SHLR16  	R0			;
0085CA 4019     	SHLR8   	R0			;
0085CC C840     	TST     	#40,R0		;
0085CE 8B0F     	BF      	L0085F0		;
0085D0 E001     	MOV     	#01,R0		;if (track.ctrl_adr & 0x40 == 0)
0085D2 A2FD     	BRA     	L008BD0		;  goto L008BD0(0x01);
0085D4 0009     	NOP     				;
0085D6 0009     	NOP     				;
0085D8 0907ADD0
0085DC 0F00025C
...
0085F8 C324     	TRAPA   	#36			;TRAP_36(200000, 0x07070000);
0085FA D1FA     	MOV.L   	@(#3E8,PC),R1	;
0085FC 8414     	MOV.B   	@(#04,R1),R0	;
0085FE 600C     	EXTU.B   	R0,R0			;
008600 D1FB     	MOV.L   	@(#3EC,PC),R1	;
008602 2100     	MOV.B   	R0,@R1		;curr_buf_num = (u8)(auth_device_cmd[2] >> 8);//Authenticate Device(0xE0) high byte CR3
008604 4F22     	STS.L   	PR,@-R15		;
008606 DBF8     	MOV.L   	@(#3E0,PC),R11	;
008608 C32A     	TRAPA   	#42			;TRAP_42(0x0B070000);
...
00861C 400B     	JSR     	@R0			;L005510(curr_buf_num|0x40,curr_buf_num|0xA0);
00861E 0009     	NOP     				;
...
00862C 400B     	JSR     	@R0			;L0054F0(curr_buf_num|0x60);
00862E 0009     	NOP     				;
...
008640 341C     	ADD     	R1,R4			;u8* pd = &partition_data_array[curr_buf_num];
008642 8442     	MOV.B   	@(#02,R4),R0	;
008644 600C     	EXTU.B   	R0,R0			;
008646 D184     	MOV.L   	@(#210,PC),R1	;
008648 2100     	MOV.B   	R0,@R1		;*(u8*)0x0F00078B = pd[2];
00864A D1E7     	MOV.L   	@(#39C,PC),R1	;
00864C C327     	TRAPA   	#39			;TRAP_39(0x0B070000);
00864E 4F26     	LDS.L   	@R15+,PR		;
008650 D111     	MOV.L   	@(#044,PC),R1	;
008652 6010     	MOV.B   	@R1,R0		;
008654 600C     	EXTU.B   	R0,R0			;
008656 C880     	TST     	#80,R0		;u32 fad;
008658 8B02     	BF      	L008660		;if (*(u8*)0x0F00025F & 0x80 == 0) {
00865A D21C     	MOV.L   	@(#070,PC),R2	;  fad = 150;
00865C A00C     	BRA     	L008678		;
00865E 0009     	NOP     				;}
L008660:
008660 D0E5     	MOV.L   	@(#394,PC),R0	;else {
008662 6200     	MOV.B   	@R0,R2		;  u8 offs = *(u8*)0x09000000;
008664 622C     	EXTU.B   	R2,R2			;  u32* ptr = 0x09000000 + offs;
008666 032C     	MOV.B   	@(R0,R2),R3		;
008668 633C     	EXTU.B   	R3,R3			;  u8 temp = *ptr;
00866A 73FF     	ADD     	#FF,R3		;
00866C 4308     	SHLL2   	R3			;
00866E D1E3     	MOV.L   	@(#38C,PC),R1	;
008670 331C     	ADD     	R1,R3			;  track_t track;
008672 6232     	MOV.L   	@R3,R2		;  track.v = toc_dram_buf[temp-1];
008674 4218     	SHLL8   	R2			;
008676 4219     	SHLR8   	R2			;  fad = track.fad;
L008678:							;}
008678 D1E2     	MOV.L   	@(#388,PC),R1	;
00867A 2122     	MOV.L   	R2,@R1		;FAD_02BC = fad;
00867C D378     	MOV.L   	@(#1E0,PC),R3	;
00867E E40F     	MOV     	#0F,R4		;
008680 2340     	MOV.B   	R4,@R3		;*(u8*)0x0907ADCE = 0x0F;
008682 D1E1     	MOV.L   	@(#384,PC),R1	;
008684 E003     	MOV     	#03,R0		;
008686 600C     	EXTU.B   	R0,R0			;
008688 2100     	MOV.B   	R0,@R1		;task7_state = 0x03;
00868A A34B     	BRA     	L008D24		;goto L008D24;
00868C 0009     	NOP     				;
00868E 0009     	NOP     				;
008690 07070000
008694 0F00028A
...
L0086D2:							;task7_process_boot_sector:
0086D2 DBC5     	MOV.L   	@(#314,PC),R11	;do {
0086D4 C32A     	TRAPA   	#42			;  TRAP_42(0x0B070000);
...
0086E0 622C     	EXTU.B   	R2,R2			;  u8 spos = *(u8*)0x0F00078B;
0086E2 E301     	MOV     	#01,R3		;
0086E4 D05F     	MOV.L   	@(#17C,PC),R0	;
0086E6 400B     	JSR     	@R0			;  u8 block = get_abs_block_pos(curr_buf_num,spos);
0086E8 0009     	NOP     				;
0086EA DBBF     	MOV.L   	@(#2FC,PC),R11	;
0086EC C327     	TRAPA   	#39			;  TRAP_39(0x0B070000);
0086EE D4E7     	MOV.L   	@(#39C,PC),R4	;
0086F0 241E     	MULU.W  	R1,R4			;
0086F2 061A     	STS     	MACL, R6		;
0086F4 D2E6     	MOV.L   	@(#398,PC),R2	;
0086F6 362C     	ADD     	R2,R6			;  u8* sec_buf = cddata_dram_buf + (block * 2352);
0086F8 846F     	MOV.B   	@(#0F,R6),R0	;
0086FA 600C     	EXTU.B   	R0,R0			;
0086FC 8801     	CMP/EQ  	#01,R0		;  IP* ip = &sec_buf[16];
0086FE 8904     	BT      	L00870A		;  if (sec_buf[15] != 0x01) {//sector header mode
008700 D157     	MOV.L   	@(#15C,PC),R1	;
008702 E001     	MOV     	#01,R0		;
008704 2100     	MOV.B   	R0,@R1		;    *(u8*)0x0907ADCE = 0x01;
008706 A012     	BRA     	L00872E		;
008708 0009     	NOP     				;  }
L00870A:
...
00871A 8B08     	BF      	L00872E		;
00871C 6066     	MOV.L   	@R6+,R0		;
00871E 3200     	CMP/EQ 	R0,R2			;
008720 8B05     	BF      	L00872E		;
008722 6066     	MOV.L   	@R6+,R0		;
008724 3300     	CMP/EQ 	R0,R3			;
008726 8B02     	BF      	L00872E		;
008728 6066     	MOV.L   	@R6+,R0		;
00872A 3400     	CMP/EQ 	R0,R4			;  else if (strcmp(ip->sys_id.hw_id,"SEGA SEGASATURN "))
00872C 892B     	BT      	L008786		;    goto L008786;
L00872E:							
00872E 4F22     	STS.L   	PR,@-R15		;
008730 DBAD     	MOV.L   	@(#2B4,PC),R11	;
008732 C32A     	TRAPA   	#42			;  TRAPA_42(0x0B070000);
...
00875E C327     	TRAPA   	#39			;  TRAPA_39(0x0B070000);
008760 4F26     	LDS.L   	@R15+,PR		;
008762 D33F     	MOV.L   	@(#0FC,PC),R3	;
008764 6030     	MOV.B   	@R3,R0		;
008766 70FF     	ADD     	#FF,R0		;
008768 8800     	CMP/EQ  	#00,R0		;  *(u8*)0x0907ADCE--;
00876A 8909     	BT      	L008780		;  if (*(u8*)0x0907ADCE == 0) return L008BD0(2);
...
008776 8901     	BT      	#002			;
008778 AFAB     	BRA     	L0086D2		;} while (*(u8*)0x0F00078B != );
00877A 0009     	NOP     				;
00877C A820     	BRA     	L0077C0		;goto task7_thread_loop;
00877E 0009     	NOP     				;
L008780:
008780 E002     	MOV     	#02,R0		;
008782 A225     	BRA     	L008BD0		;
008784 0009     	NOP     				;
...
00878C 2100     	MOV.B   	R0,@R1		;task7_state = 0x04;
00878E 6166     	MOV.L   	@R6+,R1		;
008790 6266     	MOV.L   	@R6+,R2		;
008792 D02C     	MOV.L   	@(#0B0,PC),R0	;
008794 2012     	MOV.L   	R1,@R0		;memcpy(ip_maker_id,ip->sys_id.maker_id,8);
008796 1021     	MOV.L   	R2,@(#4,R0)		;
008798 7608     	ADD     	#08,R6		;
00879A D32B     	MOV.L   	@(#0AC,PC),R3	;
00879C 6066     	MOV.L   	@R6+,R0		;
00879E 2302     	MOV.L   	R0,@R3		;memcpy(ip_product_number,ip->sys_id.product,10);
...
0087B0 6066     	MOV.L   	@R6+,R0		;memcpy(0x0F00020C,ip->sys_id.reserved3,8);
...
008826 8B25     	BF      	L008874		;
008828 6032     	MOV.L   	@R3,R0		;
00882A 3200     	CMP/EQ 	R0,R2			;
00882C 8B22     	BF      	L008874		;      !memcmp(ip_maker_id,0x0F0002F0,8)) {
00882E E004     	MOV     	#04,R0		;
008830 D108     	MOV.L   	@(#020,PC),R1	;
008832 8011     	MOV.B   	R0,@(#01,R1)	;    auth_status_cd = AUTH_STAT_SATURN_DISK;
L008834:
008834 D00E     	MOV.L   	@(#038,PC),R0	;
008836 70FF     	ADD     	#FF,R0		;
008838 8800     	CMP/EQ  	#00,R0		;
00883A 8BFC     	BF      	L008836		;    for (int i = 0; i<14000000; i++);
00883C A260     	BRA     	L008D00		;    return L008D00();
00883E 0009     	NOP     				;  }
008840 000051BE						;}
008844 0F000774
008848 0F00077C
...
0088B6 2309     	AND     	R0,R3			;u8 temp2 = (timer>>4) & 0x7F;
0088B8 E046     	MOV     	#46,R0		;
0088BA 3302     	CMP/HS 	R0,R3			;
0088BC 8B00     	BF      	#000			;
0088BE 3308     	SUB     	R0,R3			;if (temp2 >= 70) temp2 -= 70;
0088C0 6063     	MOV     	R6,R0			;
0088C2 8800     	CMP/EQ  	#00,R0		;u32 val1,val2,val3;
0088C4 8B0B     	BF      	L0088DE		;if (temp == 0) {
0088C6 E002     	MOV     	#02,R0		;
0088C8 3036     	CMP/HI 	R3,R0			;
0088CA 8B1D     	BF      	L008908		;  if (temp2 > 2) goto L008908;
0088CC E015     	MOV     	#15,R0		;
0088CE 230E     	MULU.W  	R0,R3			;
0088D0 061A     	STS     	MACL, R6		;
0088D2 6763     	MOV     	R6,R7			;  val1 = val2 = temp2 * 21;
0088D4 E302     	MOV     	#02,R3		;
0088D6 230E     	MULU.W  	R0,R3			;
0088D8 031A     	STS     	MACL, R3		;  val3 = 2 * 21;
0088DA A01A     	BRA     	L008912		;
0088DC 0009     	NOP     				;
L0088DE:
0088DE 880C     	CMP/EQ  	#0C,R0		;}
0088E0 8B12     	BF      	L008908		;else if (temp == 12) {
0088E2 E013     	MOV     	#13,R0		;
0088E4 6733     	MOV     	R3,R7			;
0088E6 3708     	SUB     	R0,R7			;
0088E8 4711     	CMP/PZ  	R7			;
0088EA 89FC     	BT      	L0088E6		;
0088EC 370C     	ADD     	R0,R7			;  temp3 = temp2 % 19;
0088EE E027     	MOV     	#27,R0		;
0088F0 3308     	SUB     	R0,R3			;
0088F2 4311     	CMP/PZ  	R3			;
0088F4 89FC     	BT      	L0088F0		;
0088F6 330C     	ADD     	R0,R3			;  temp2 = temp2 % 39;
0088F8 E015     	MOV     	#15,R0		;
0088FA 230E     	MULU.W  	R0,R3			;
0088FC 031A     	STS     	MACL, R3		;
0088FE 6633     	MOV     	R3,R6			;  val1 = val3 = temp2 * 21;
008900 270E     	MULU.W  	R0,R7			;
008902 071A     	STS     	MACL, R7		;  val2 = temp3 * 21;
008904 A005     	BRA     	L008912		;
008906 0009     	NOP     				;}
L008908:
008908 E015     	MOV     	#15,R0		;else {
00890A 230E     	MULU.W  	R0,R3			;
00890C 031A     	STS     	MACL, R3		;
00890E 6633     	MOV     	R3,R6			;  val1 = val2 = val3 = temp2 * 21;
...
00891A 2012     	MOV.L   	R1,@R0		;*(u32*)0x0907ADB8 = (temp * 1470) + 299300 + val3;
00891C 1041     	MOV.L   	R4,@(#4,R0)		;*(u32*)0x0907ADBC = (temp * 1470) + 299300 + 1470 + val1;
00891E 1052     	MOV.L   	R5,@(#8,R0)		;*(u32*)0x0907ADC0 = (temp * 1470) + 299300 + 1470 + 1470 + val2;
008920 D13A     	MOV.L   	@(#0E8,PC),R1	;
008922 6010     	MOV.B   	@R1,R0		;u8 temp4 = *(u8*)0x0907ADCF;
008924 E302     	MOV     	#02,R3		;
008926 3306     	CMP/HI 	R0,R3			;
008928 8907     	BT      	L00893A		;
00892A D1E9     	MOV.L   	@(#3A4,PC),R1	;
00892C 6212     	MOV.L   	@R1,R2		;u32 fad = *(u32*)0x09079970;
00892E 8802     	CMP/EQ  	#02,R0		;
008930 8B06     	BF      	L008940		;
008932 9183     	MOV.W   	@(#106,PC),R1	;if (temp4 == 0x02)
008934 321C     	ADD     	R1,R2			;  fad += 3562;
008936 A003     	BRA     	L008940		;
008938 0009     	NOP     				;
L00893A:
00893A 4008     	SHLL2   	R0			;else if (temp4 < 0x02)
00893C D135     	MOV.L   	@(#0D4,PC),R1	;  fad = L008A24[temp4];
00893E 021E     	MOV.L   	@(R0,R1),R2		;
L008940:
008940 D130     	MOV.L   	@(#0C0,PC),R1	;
008942 2122     	MOV.L   	R2,@R1		;FAD_02BC = fad;
008944 EB04     	MOV     	#04,R11		;
008946 D029     	MOV.L   	@(#0A4,PC),R0	;
008948 2B0B     	OR      	R0,R11		;
00894A C321     	TRAPA   	#33			;add_task_to_queue(0x060700004);
00894C D0E8     	MOV.L   	@(#3A0,PC),R0	;
00894E 402B     	JMP     	@R0			;goto task7_thread_loop;//L0077C0
008950 0009     	NOP     				;
...
008A2C 53454741						;"SEGA SEGASATURN "
008A30 20534547
008A34 41534154
008A38 55524E20
008A3C 0DEA
...
008A62 C32A     	TRAPA   	#42			;TRAP_42(0x0B070000);
...
008A6E 622C     	EXTU.B   	R2,R2			;u8 temp = *(u8*)0x0F00078B;
008A70 E301     	MOV     	#01,R3		;
008A72 D0FB     	MOV.L   	@(#3EC,PC),R0	;
008A74 400B     	JSR     	@R0			;u8 block = get_abs_block_pos(curr_buf_num,temp);
008A76 0009     	NOP     				;
008A78 DBF1     	MOV.L   	@(#3C4,PC),R11	;
008A7A C327     	TRAPA   	#39			;TRAP_39(0x0B070000);
008A7C D403     	MOV.L   	@(#00C,PC),R4	;
008A7E 241E     	MULU.W  	R1,R4			;
008A80 061A     	STS     	MACL, R6		;
008A82 D203     	MOV.L   	@(#00C,PC),R2	;
008A84 362C     	ADD     	R2,R6			;u8* sec_buf = cddata_dram_buf + (block * 2352);
008A86 A005     	BRA     	L008A94		;
008A88 0009     	NOP     				;
008A8A 0009     	NOP     				;
008A8C 00000930
008A90 09000230
L008A94:
008A94 760C     	ADD     	#0C,R6		;12
008A96 D78F     	MOV.L   	@(#23C,PC),R7	;
008A98 770C     	ADD     	#0C,R7		;0x09077C00 + 12
008A9A B23F     	BRS     	L008F1C		;L008F1C();
008A9C 0009     	NOP     				;
008A9E 4F22     	STS.L   	PR,@-R15		;
008AA0 DBE7     	MOV.L   	@(#39C,PC),R11	;
008AA2 C32A     	TRAPA   	#42			;TRAP_42(0x0B070000);
008AA4 D0E9     	MOV.L   	@(#3A4,PC),R0	;
008AA6 6100     	MOV.B   	@R0,R1		;num = curr_buf_num;
008AA8 D4EE     	MOV.L   	@(#3B8,PC),R4	;
008AAA 6240     	MOV.B   	@R4,R2		;temp = *(u8*)0x0F00078B;
...
008C2E 313C     	ADD     	R3,R1			;  u8* filter_data = &filter_data_array[num];
008C30 200A     	XOR     	R0,R0			;
008C32 1102     	MOV.L   	R0,@(#8,R1)		;
008C34 1103     	MOV.L   	R0,@(#C,R1)		;  memset(filter_data[8],0,8);
008C36 8010     	MOV.B   	R0,@(#00,R1)	;  filter_data[0] = 0x00;
008C38 DB81     	MOV.L   	@(#204,PC),R11	;
008C3A C327     	TRAPA   	#39			;  TRAP_39(0x0B070000);
008C3C 4F26     	LDS.L   	@R15+,PR		;}
L008C3E:
008C3E EB03     	MOV     	#03,R11		;
008C40 D080     	MOV.L   	@(#200,PC),R0	;
008C42 2B0B     	OR      	R0,R11		;
008C44 C321     	TRAPA   	#33			;add_task_to_queue(0x06070003);
008C46 D126     	MOV.L   	@(#098,PC),R1	;
008C48 D226     	MOV.L   	@(#098,PC),R2	;
008C4A 6010     	MOV.B   	@R1,R0		;
008C4C 2200     	MOV.B   	R0,@R2		;init_cd_flags = *(u8*)(0x0907ADD0+0x00);
008C4E D226     	MOV.L   	@(#098,PC),R2	;
008C50 8411     	MOV.B   	@(#01,R1),R0	;
008C52 2200     	MOV.B   	R0,@R2		;init_cd_ecc = *(u8*)(0x0907ADD0+0x01);
008C54 D225     	MOV.L   	@(#094,PC),R2	;
008C56 8412     	MOV.B   	@(#02,R1),R0	;
008C58 2200     	MOV.B   	R0,@R2		;init_cd_retry = *(u8*)(0x0907ADD0+0x02);
008C5A D116     	MOV.L   	@(#058,PC),R1	;
008C5C 8411     	MOV.B   	@(#01,R1),R0	;
008C5E 600C     	EXTU.B   	R0,R0			;
008C60 8811     	CMP/EQ  	#11,R0		;
008C62 8B02     	BF      	L008C6A		;if (auth_status_cd == 0x0011) {	//????
008C64 D014     	MOV.L   	@(#050,PC),R0	;  task7_reinit();
008C66 402B     	JMP     	@R0			;  goto task7_thread_loop;
008C68 0009     	NOP     				;}
L008C6A:
008C6A D172     	MOV.L   	@(#1C8,PC),R1	;
008C6C E000     	MOV     	#00,R0		;
008C6E 2100     	MOV.B   	R0,@R1		;task7_state = 0x00;
008C70 D105     	MOV.L   	@(#014,PC),R1	;
008C72 200A     	XOR     	R0,R0			;
008C74 2100     	MOV.B   	R0,@R1		;auth_device_flag = 0x00;
008C76 9042     	MOV.W   	@(#084,PC),R0	;
008C78 600D     	EXTU.W   	R0,R0			;
008C7A D304     	MOV.L   	@(#010,PC),R3	;
008C7C 2301     	MOV.W   	R0,@R3		;YGR.HIRQ = HIRQ_EFLS;
008C7E D01C     	MOV.L   	@(#070,PC),R0	;
008C80 402B     	JMP     	@R0			;goto task7_thread_loop;
008C82 0009     	NOP     				;
008C84 07070000
008C88 0F0007B0
008C8C 0A00001E
...
008D28 C32A     	TRAPA   	#42			;TRAP_42(0x0B070000);
...
008D38 310C     	ADD     	R0,R1			;filter_data* fd = &filter_data_array[curr_buf_num];
008D3A D540     	MOV.L   	@(#100,PC),R5	;
008D3C 6052     	MOV.L   	@R5,R0		;
008D3E 1102     	MOV.L   	R0,@(#8,R1)		;fd->fad = FAD_02BC;
008D40 D23C     	MOV.L   	@(#0F0,PC),R2	;
008D42 6020     	MOV.B   	@R2,R0		;
008D44 600C     	EXTU.B   	R0,R0			;
008D46 6503     	MOV     	R0,R5			;
008D48 8803     	CMP/EQ  	#03,R0		;
008D4A 8B04     	BF      	L008D56		;
008D4C D241     	MOV.L   	@(#104,PC),R2	;
008D4E 6020     	MOV.B   	@R2,R0		;if (task7_state == 0x03) 
008D50 600C     	EXTU.B   	R0,R0			;  fd->range = (u32)*(u8*)0x0907ADCE;
008D52 A008     	BRA     	L008D66		;
008D54 0009     	NOP     				;
L008D56:
008D56 8806     	CMP/EQ  	#06,R0		;
008D58 8B02     	BF      	L008D60		;else if (task7_state == 0x06)
008D5A E003     	MOV     	#03,R0		;  fd->range = 0x00000003;
008D5C A003     	BRA     	L008D66		;
008D5E 0009     	NOP     				;
L008D60:
008D60 D230     	MOV.L   	@(#0C0,PC),R2	;else
008D62 6020     	MOV.B   	@R2,R0		;  fd->range = (u32)*(u8*)0x0F000208;
008D64 600C     	EXTU.B   	R0,R0			;
L008D66:
008D66 1103     	MOV.L   	R0,@(#C,R1)		;
008D68 E040     	MOV     	#40,R0		;
008D6A 600C     	EXTU.B   	R0,R0			;
008D6C 8010     	MOV.B   	R0,@(#00,R1)	;fd->mode = 0x40;
008D6E E406     	MOV     	#06,R4		;
008D70 644C     	EXTU.B   	R4,R4			;
008D72 234E     	MULU.W  	R4,R3			;
008D74 041A     	STS     	MACL, R4		;
008D76 D139     	MOV.L   	@(#0E4,PC),R1	;
008D78 341C     	ADD     	R1,R4			;u8* pd = &partition_data_array[curr_buf_num];
008D7A E001     	MOV     	#01,R0		;
008D7C 600C     	EXTU.B   	R0,R0			;
008D7E 8043     	MOV.B   	R0,@(#03,R4)	;pd[3] = 0x01;
...
008D90 400B     	JSR     	@R0			;L005510(0x80,curr_buf_num);
008D92 0009     	NOP     				;
008D94 D12A     	MOV.L   	@(#0A8,PC),R1	;
008D96 C327     	TRAPA   	#39			;TRAP_39(0x0B070000);
008D98 4F26     	LDS.L   	@R15+,PR		;
008D9A EB02     	MOV     	#02,R11		;
008D9C D029     	MOV.L   	@(#0A4,PC),R0	;
008D9E 2B0B     	OR      	R0,R11		;
008DA0 C321     	TRAPA   	#33			;add_task_to_queue(0x06070000);
008DA2 D031     	MOV.L   	@(#0C4,PC),R0	;
008DA4 402B     	JMP     	@R0			;goto task7_thread_loop;
008DA6 0009     	NOP     				;
...
L0091A4:							;void get_rr1_trns_status(u16* rr1)	//rr1-R12
0091A4 A001     	BRA     	L0091AA		;
0091A6 E240     	MOV     	#40,R2		;return get_rr1_status_ext(STAT_TRNS,rr1);

L0091A8:							;void get_rr1_status(u16* rr1)	//rr1-R12
0091A8 E200     	MOV     	#00,R2		;return get_rr1_status_ext(0x00,rr1);

L0091AA:							;void get_rr1_status_ext(u8 mask,u16* rr1) //mask-R2,rr1-R12
0091AA D00D     	MOV.L   	@(#034,PC),R0	;
0091AC 6000     	MOV.B   	@R0,R0		;
0091AE C828     	TST     	#28,R0		;u8 stat;
0091B0 8901     	BT      	L0091B6		;if (cd_flags & 0x28 != 0x00)
0091B2 A00D     	BRA     	L0091D0		;  stat = STAT_BUSY;
0091B4 E000     	MOV     	#00,R0		;
L0091B6:
0091B6 D00B     	MOV.L   	@(#02C,PC),R0	;
0091B8 6000     	MOV.B   	@R0,R0		;
0091BA C808     	TST     	#08,R0		;
0091BC 8901     	BT      	L0091C2		;else if (cd_flags2 & CD_FLAG2_ERROR != 0x00)
0091BE A007     	BRA     	L0091D0		;  stat = STAT_ERROR;
0091C0 E009     	MOV     	#09,R0		;
L0091C2:
...
0091CC D1A6     	MOV.L   	@(#298,PC),R1	;else
0091CE 6010     	MOV.B   	@R1,R0		;  stat = !cd_status_buf_sel ? cd_status_buf2[0] : cd_status_buf1[0];
L0091D0:
0091D0 202B     	OR      	R2,R0			;
0091D2 4028     	SHLL16  	R0			;
0091D4 4018     	SHLL8   	R0			;
0091D6 4C18     	SHLL8   	R12			;
0091D8 4C19     	SHLR8   	R12			;*rr1 = ((mask | stat) << 8) | (*rr1 & 0x00FF);
0091DA 000B     	RTS     				;
...
L0091E8:							;make_cd_status_FF(u16 *rr1,*rr2,*rr3,*rr4)//rr1,rr2-R12,rr3,rr4-R13
0091E8 A00A     	BRA     	L009200		;
0091EA E2FF     	MOV     	#FF,R2		;return make_cd_status_ext(0xFF,rr1,rr2,rr3,rr4);

L0091EC:							;make_cd_status_80(u16 *rr1,*rr2,*rr3,*rr4)	//rr1,rr2-R12,rr3,rr4-R13
...
L009200:							;void make_cd_status_ext(u8 stat,u16 *rr1,*rr2,*rr3,*rr4) //stat-R2,h-R11,rr1,rr2-R12,rr3,rr4-R13
009200 D018     	MOV.L   	@(#060,PC),R0	;
009202 6000     	MOV.B   	@R0,R0		;
009204 C801     	TST     	#01,R0		;
009206 8B29     	BF      	L00925C		;if (auth_device_flag & 0x01 != 0) {
009208 D195     	MOV.L   	@(#254,PC),R1	;  *rr1 = 0x00FF; *rr2 = 0xFFFF;
00920A 6010     	MOV.B   	@R1,R0		;  *rr3 = 0xFFFF; *rr4 = 0xFFFF;
00920C D195     	MOV.L   	@(#254,PC),R1	;}
00920E 8800     	CMP/EQ  	#00,R0		;else {
009210 8900     	BT      	L009214		;  u8* ptr = !cd_status_buf_sel ? cd_status_buf2 : cd_status_buf;
009212 D195     	MOV.L   	@(#254,PC),R1	;                                   
L009214:
...
009220 8B02     	BF      	L009228		;  cd_flags2 & 0x40 != 0
...
009248 8904     	BT      	L009254		;  if (cd_flags2 & 0x08 != 0x00) {
...
L009274:							;cmd_get_hw_info(u32 *h,u16 *rr1,*rr2,*rr3,*rr4) 
...
009280 DD02     	MOV.L   	@(#008,PC),R13	;*rr3 = *(u16*)0x0F0002FC;
009282 6DD2     	MOV.L   	@R13,R13		;*rr4 = *(u16*)0x0F0002FE; 
009284 AF90     	BRA     	L0091A8		;*h = 0x00000000;
...
00929A EB00     	MOV     	#00,R11		;*h = 0x00000000;
...
0092B4 EB00     	MOV     	#00,R11		;*h = 0x00000000;
...
00933E DB44     	MOV.L   	@(#110,PC),R11	;*h = 0x06810000;
L009340:
009340 AF59     	BRA     	L0091F6		;
009342 0009     	NOP     				;
L009344:
009344 DB42     	MOV.L   	@(#108,PC),R11	;*h = 0x06810008;
009346 AFFB     	BRA     	L009340		;
009348 7B08     	ADD     	#08,R11		;

								;cdb command 05 "Open Tray"
L00934A:							;(*cr1,*cr2,*cr3,*cr4,*rr1,*rr2,*rr3,*rr4) //
00934A DB41     	MOV.L   	@(#104,PC),R11	;*h = 0x06810002;
00934C AF53     	BRA     	L0091F6		;
00934E 7B02     	ADD     	#02,R11		;

;cdb command 10 "Play Disc"
L009350:						;void play_disc(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)//cr1:cr2-R1,cr3:cr4-R2,h-R11,rr1:rr2-R12,rr3:rr4-R13
009350 D042     	MOV.L   	@(#108,PC),R0	;
009352 401E     	LDC     	R0,GBR		;
009354 6023     	MOV     	R2,R0		;
009356 4029     	SHLR16  	R0		;
009358 4019     	SHLR8   	R0		;
00935A C001     	MOV.B   	R0,@(#001,GBR)	;play_mode = cr3>>24;
00935C D03D     	MOV.L   	@(#0F4,PC),R0	;
00935E 2109     	AND     	R0,R1		;u32 start_pos = (cr1 & 0x00FF)<<16 | cr2;
009360 2209     	AND     	R0,R2		;u32 end_pos = (cr3 & 0x00FF)<<16 | cr4;
009362 3210     	CMP/EQ 		R1,R2		;
009364 8B04     	BF      	L009370		;
009366 3100     	CMP/EQ 		R0,R1		;
009368 8B02     	BF      	L009370		;if (start_pos == end_pos && start_pos == 0xFFFFFF) {
00936A DB39     	MOV.L   	@(#0E4,PC),R11	;  *h = 0x06810005;
00936C AF43     	BRA     	L0091F6		;  return L0091F6();
00936E 7B05     	ADD     	#05,R11		;}
L009370:
009370 6303     	MOV     	R0,R3		;
009372 3310     	CMP/EQ 		R1,R3		;
009374 8B0B     	BF      	L00938E		;if (start_pos == 0xFFFFFF) {
...
009390 8B09     	BF      	L0093A6		;if (end_pos == 0xFFFFFF) {
...
0093A8 8B05     	BF      	L0093B6		;
0093AA 2228     	TST     	R2,R2		;
0093AC 8B0C     	BF      	L0093C8		;if (!start_pos && !end_pos) {
0093AE DB28     	MOV.L   	@(#0A0,PC),R11	;
0093B0 7B04     	ADD     	#04,R11		;
0093B2 6023     	MOV     	R2,R0		;
0093B4 8915     	BT      	L0093E2		;}
L0093B6:
0093B6 2228     	TST     	R2,R2		;else {
0093B8 8906     	BT      	L0093C8		;  if (start_pos && end_pos) {
0093BA 6013     	MOV     	R1,R0		;
0093BC 202A     	XOR     	R2,R0		;
0093BE 4018     	SHLL8   	R0		;
0093C0 4004     	ROTL    	R0		;
0093C2 8B01     	BF      	L0093C8		;    if ((start_pos & 0x800000) != (end_pos & 0x800000))
0093C4 AF10     	BRA     	L0091E8		;      return make_cd_status_FF();
0093C6 EB00     	MOV     	#00,R11		;  }
L0093C8:						;  //if (start_pos && !end_pos)
0093C8 DB21     	MOV.L   	@(#084,PC),R11	;
0093CA D023     	MOV.L   	@(#08C,PC),R0	;
0093CC 7B03     	ADD     	#03,R11		;  *h = 0x06810003;
0093CE 2018     	TST     	R1,R0		;
0093D0 8B05     	BF      	L0093DE		;
0093D2 2028     	TST     	R2,R0		;
0093D4 8B03     	BF      	L0093DE		;  if (!(start_pos & 0x800000) && !(end_pos & 0x800000)) {
0093D6 D005     	MOV.L   	@(#014,PC),R0	;
0093D8 2109     	AND     	R0,R1		;    start_pos & = 0x00FFFF;
0093DA A001     	BRA     	L0093E0		;    end_pos & = 0x00FFFF;
0093DC 2209     	AND     	R0,R2		;
L0093DE:						;  }
0093DE 7B01     	ADD     	#01,R11		;  else *h = 0x06810004;
L0093E0:
0093E0 6023     	MOV     	R2,R0		;} 
L0093E2:
0093E2 C203     	MOV.L   	R0,@(#00C,GBR)	;end_play_pos = end_pos;
0093E4 6013     	MOV     	R1,R0		;start_play_pos = start_pos;
0093E6 AF06     	BRA     	L0091F6		;
0093E8 C202     	MOV.L   	R0,@(#008,GBR)	;return L0091F6();
0093EA 0009     	NOP     			;
0093EC FF00FFFF

;cdb command 11 "Seek Disc"
L0093F0:						;void seek_disc(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)//cr1:cr2-R1,cr3:cr4-R2,h-R11,rr1:rr2-R12,rr3:rr4-R13
0093F0 D01A     	MOV.L   	@(#068,PC),R0	;
0093F2 401E     	LDC     	R0,GBR		;
0093F4 DB16     	MOV.L   	@(#058,PC),R11	;
0093F6 D017     	MOV.L   	@(#05C,PC),R0	;
0093F8 2109     	AND     	R0,R1		;u32 pos = (cr1 & 0x00FF)<<16 | cr2;
0093FA 3100     	CMP/EQ 		R0,R1		;
0093FC 7B08     	ADD     	#08,R11		;*h = 0x06810008;
0093FE 890A     	BT      	L009416		;if (pos != 0xFFFFFF) {
009400 2118     	TST     	R1,R1		;
009402 7B01     	ADD     	#01,R11		;  *h = 0x06810009;
009404 8907     	BT      	L009416		;  if (pos) {
009406 D014     	MOV.L   	@(#050,PC),R0	;
009408 7BFD     	ADD     	#FD,R11		;    *h = 0x06810006;
00940A 2018     	TST     	R1,R0		;
00940C 8900     	BT      	L009412		;    if (pos & 0x800000) 
00940E 7B01     	ADD     	#01,R11		;      *h = 0x06810007;
009410 6007     	NOT     	R0,R0		;
009412 2019     	AND     	R1,R0		;    pos &= ~0x800000;
009414 C202     	MOV.L   	R0,@(#008,GBR)	;    start_play_pos = pos;
L009416:						;  }
009416 AEEE     	BRA     	L0091F6		;}
009418 0009     	NOP     			;return L0091F6();

;cdb command 12 "Scan Disc"
L00941A:						;void scan_disc(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
...
;cdb command 70 "Change Directory"
L009478:							;(*cr1,*cr2,*cr3,*cr4,*rr1,*rr2,*rr3,*rr4) //cr1:cr2-R1,cr3:cr4-R2,rr1:rr2-R12,rr3:rr4-R13
...
;cdb command 72 "Get File System Scope"
L009566:							;(*cr1,*cr2,*cr3,*cr4,*rr1,*rr2,*rr3,*rr4) //cr1:cr2-R1,cr3:cr4-R2,rr1:rr2-R12,rr3:rr4-R13
009566 D04F     	MOV.L   	@(#13C,PC),R0	;
009568 2012     	MOV.L   	R1,@R0		;file_cr1 = *cr1; file_cr2 = *cr2;
00956A 1021     	MOV.L   	R2,@(#4,R0)		;file_cr3 = *cr3; file_cr4 = *cr4;
00956C D15B     	MOV.L   	@(#16C,PC),R1	;
00956E 6010     	MOV.B   	@R1,R0		;
009570 600C     	EXTU.B   	R0,R0			;
009572 8804     	CMP/EQ  	#04,R0		;
009574 8B01     	BF      	#002			;if (*(u8*)0x0F00076B == 0x04)
009576 A0C2     	BRA     	L0096FE		;  return file_error_80();
009578 0009     	NOP     				;
00957A 8802     	CMP/EQ  	#02,R0		;
00957C 8901     	BT      	#002			;if (*(u8*)0x0F00076B == 0x01) return file_error_80();
00957E A0B1     	BRA     	L0096E4		;if (*(u8*)0x0F00076B != 0x02) return file_error_FF();
009580 0009     	NOP     				;
009582 222A     	XOR     	R2,R2			;*rr3 = 0x0000;
009584 D10A     	MOV.L   	@(#028,PC),R1	;
009586 6012     	MOV.L   	@R1,R0		;
009588 8800     	CMP/EQ  	#00,R0		;
00958A 8B07     	BF      	L00959C		;if (*(u32*)0x0F00075C == 0) {
00958C D109     	MOV.L   	@(#024,PC),R1	;
00958E 6011     	MOV.W   	@R1,R0		;
009590 600D     	EXTU.W   	R0,R0			;
009592 8800     	CMP/EQ  	#00,R0		;
009594 8B02     	BF      	L00959C		;  if (*(u16*)0x0F000764 == 0) 
009596 E201     	MOV     	#01,R2		;    *rr3 = 0x0100;
009598 4228     	SHLL16  	R2			;
00959A 4218     	SHLL8   	R2			;}
L00959C:
00959C D165     	MOV.L   	@(#194,PC),R1	;u32 temp = *(u32*)0x0F000758;
00959E 6D12     	MOV.L   	@R1,R13		;
0095A0 4D19     	SHLR8   	R13			;*rr4 = temp >> 8;
0095A2 2D2B     	OR      	R2,R13		;*rr3 |= (temp >> 24) & 0xFF;
0095A4 8413     	MOV.B   	@(#03,R1),R0	;
0095A6 6C0C     	EXTU.B   	R0,R12		;*rr2 = temp & 0xFF;
0095A8 D05F     	MOV.L   	@(#17C,PC),R0	;
0095AA 2BBA     	XOR     	R11,R11		;*h = 0;
0095AC A0B2     	BRA     	L009714		;return get_rr1_status(rr1);
0095AE 0009     	NOP     				;
0095B0 0F00075C
0095B4 0F000764
...
;cdb command 74 "Read File"
L009618:							;(*cr1,*cr2,*cr3,*cr4,*rr1,*rr2,*rr3,*rr4) //cr1:cr2-R1,cr3:cr4-R2,rr1:rr2-R12,rr3:rr4-R13

009618 D022     	MOV.L   	@(#088,PC),R0	;
00961A 2012     	MOV.L   	R1,@R0		;file_cr1 = *cr1; file_cr2 = *cr2;
00961C 1021     	MOV.L   	R2,@(#4,R0)		;file_cr3 = *cr3; file_cr4 = *cr4;
00961E 4229     	SHLR16  	R2			;
009620 4219     	SHLR8   	R2			;u8 n = *cr3 >> 8;
009622 E018     	MOV     	#18,R0		;
009624 600C     	EXTU.B   	R0,R0			;
009626 3202     	CMP/HS 	R0,R2			;
009628 8965     	BT      	L0096F6		;if (n > 24) return file_error_FF();
00962A D12C     	MOV.L   	@(#0B0,PC),R1	;
00962C 6010     	MOV.B   	@R1,R0		;
00962E 600C     	EXTU.B   	R0,R0			;
009630 8804     	CMP/EQ  	#04,R0		;
009632 8B01     	BF      	#002			;if (*(u8*)0x0F00076B == 0x04)
009634 A063     	BRA     	L0096FE		;  return file_error_80();
009636 0009     	NOP     				;
009638 8802     	CMP/EQ  	#02,R0		;
00963A 8901     	BT      	#002			;if (*(u8*)0x0F00076B != 0x02)
00963C A052     	BRA     	L0096E4		;  if (*(u8*)0x0F00076B == 0x01) return file_error_80();
00963E 0009     	NOP     				;  else return file_error_FF();
009640 4F22     	STS.L   	PR,@-R15		;
009642 D019     	MOV.L   	@(#064,PC),R0	;
009644 400B     	JSR     	@R0			;L007E36();
009646 0009     	NOP     				;
009648 4F26     	LDS.L   	@R15+,PR		;
00964A D018     	MOV.L   	@(#060,PC),R0	;
00964C 2020     	MOV.B   	R2,@R0		;*(u8*)0x0F00076E = n;
00964E 6013     	MOV     	R1,R0			;
009650 8800     	CMP/EQ  	#00,R0		;
009652 8B50     	BF      	L0096F6		;if ( != 0) return file_error_FF();
009654 6323     	MOV     	R2,R3			;
009656 E10C     	MOV     	#0C,R1		;
009658 213E     	MULU.W  	R3,R1			;
00965A 011A     	STS     	MACL, R1		;
00965C D014     	MOV.L   	@(#050,PC),R0	;
00965E 310C     	ADD     	R0,R1			;u32* ptr = 0x09074210 + n * 12;
009660 5011     	MOV.L   	@(#04,R1),R0	;
009662 6203     	MOV     	R0,R2			;
009664 4019     	SHLR8   	R0			;
009666 4009     	SHLR2   	R0			;
009668 4001     	SHLR    	R0			;
00966A 6303     	MOV     	R0,R3			;u32 temp = ptr[1] >> 11;
00966C 9028     	MOV.W   	@(#050,PC),R0	;
00966E 600D     	EXTU.W   	R0,R0			;
009670 2029     	AND     	R2,R0			;
009672 8800     	CMP/EQ  	#00,R0		;
009674 8900     	BT      	L009678		;if (ptr[1] & 0x07FF != 0)
009676 7301     	ADD     	#01,R3		;  temp++;
009678 D00E     	MOV.L   	@(#038,PC),R0	;
00967A 2032     	MOV.L   	R3,@R0		;*(u32*)0x0F00074C = temp;
00967C D209     	MOV.L   	@(#024,PC),R2	;
00967E 6422     	MOV.L   	@R2,R4		;
009680 4418     	SHLL8   	R4			;
009682 4419     	SHLR8   	R4			;u32 fad = ((*cr1 & 0xFF) << 16) | cr2;
009684 3346     	CMP/HI 	R4,R3			;
009686 8901     	BT      	#002			;
009688 A035     	BRA     	L0096F6		;if (temp <= fad) return file_error_FF();
00968A 0009     	NOP     				;
00968C D305     	MOV.L   	@(#014,PC),R3	;
00968E 8434     	MOV.B   	@(#04,R3),R0	;
009690 600C     	EXTU.B   	R0,R0			;
009692 D109     	MOV.L   	@(#024,PC),R1	;
009694 2100     	MOV.B   	R0,@R1		;*cr4 & 0xFF
...
L0096C2:							;cmd_abort_file(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4)
...
0096E6 8B06     	BF      	L0096F6		;file_error_FF()
0096E8 A009     	BRA     	L0096FE		;file_error_80()
0096EA 0009     	NOP     				;

L0096EC:
0096EC DB12     	MOV.L   	@(#048,PC),R11	;
0096EE 2B0B     	OR      	R0,R11		;
0096F0 D00C     	MOV.L   	@(#030,PC),R0	;*h = 0x07810000|arg;
0096F2 A00F     	BRA     	L009714		;return make_cd_status_00(rr1,rr2,rr3,rr4);
0096F4 0009     	NOP     				;

L0096F6:							;void file_error_FF()
0096F6 D00A     	MOV.L   	@(#028,PC),R0	;
0096F8 2BBA     	XOR     	R11,R11		;*h = 0x00000000;
0096FA A00B     	BRA     	L009714		;return make_cd_status_FF(rr1,rr2,rr3,rr4);
0096FC 0009     	NOP     				;

L0096FE:							;void file_error_80()
0096FE D00B     	MOV.L   	@(#02C,PC),R0	;
009700 2BBA     	XOR     	R11,R11		;*h = 0x00000000;
...
00970E DB0A     	MOV.L   	@(#028,PC),R11	;
009710 2B0B     	OR      	R0,R11		;
009712 D007     	MOV.L   	@(#01C,PC),R0	;
L009714:
009714 4F22     	STS.L   	PR,@-R15		;*h = 0x07810000|arg;
009716 400B     	JSR     	@R0			;L0091A4(rr1,rr2,rr3,rr4);
009718 0009     	NOP     				;
...
0097EE 6CD2     	MOV.L   	@R13,R12		;task_entry* entry = current_task_entry;
...
0098A2 6CD2     	MOV.L   	@R13,R12		;task_entry* entry = current_task_entry;
...
0098B6 8B0A     	BF      	L0098CE		;
0098B8 803D     	MOV.B   	R0,@(#0D,R3)	;cdd_nb = rd == 0x00 ? 0x00 : 0x80;
L0098BA:
0098BA E002     	MOV     	#02,R0		;
0098BC CDBF     	AND.B   	#BF,@(R0,GBR)	;SH1.SCI.SCR0 &= ~0x40;	//clear RIE
...
00A440 2501     	MOV.W   	R0,@R5		;*(u16*)0x0F000892 = 0x0800;
00A442 422B     	JMP     	@R2			;
00A444 0009     	NOP     				;
00A446 0009     	NOP     				;
00A448 0F000892
...
00BA38 2101     	MOV.W   	R0,@R1		;auth_status_cd = AUTH_STAT_NO_CD;
00BA3A D186     	MOV.L   	@(#218,PC),R1	;
00BA3C 2102     	MOV.L   	R0,@R1		;auth_status2_mpeg = 0x0000;
00BA3E 7104     	ADD     	#04,R1		;
00BA40 2101     	MOV.W   	R0,@R1		;auth_device_flag = 0x00;//*(u16*)0x0F0007B0 = 0x0000;
00BA42 000B     	RTS     				;
00BA44 0009     	NOP     				;

L00BA46:							;task9_thread()
...
L00C2B6:							;cmd_authenticate_device(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) {
00C2B6 D057     	MOV.L   	@(#15C,PC),R0	;
00C2B8 6300     	MOV.B   	@R0,R3		;*h = 0;
00C2BA 4305     	ROTR    	R3			;
00C2BC 8933     	BT      	L00C326		;if (auth_device_flag)
00C2BE D358     	MOV.L   	@(#160,PC),R3	;  return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C2C0 6030     	MOV.B   	@R3,R0		;
00C2C2 C880     	TST     	#80,R0		;if (*(u8*)0x0F000892 & 0x80 != 0)
00C2C4 8B2F     	BF      	L00C326		;  return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C2C6 601C     	EXTU.B   	R1,R0			;
00C2C8 8800     	CMP/EQ  	#00,R0		;
00C2CA 8903     	BT      	L00C2D4		;
00C2CC 8801     	CMP/EQ  	#01,R0		;
00C2CE 8912     	BT      	L00C2F6		;
00C2D0 A029     	BRA     	L00C326		;
00C2D2 0009     	NOP     				;
L00C2D4:							;switch (cr2) {
00C2D4 D04D     	MOV.L   	@(#134,PC),R0	;case 0x0000:
00C2D6 2012     	MOV.L   	R1,@R0		;  auth_device_cmd[0] = cr1; auth_device_cmd[0] = cr2;
00C2D8 1021     	MOV.L   	R2,@(#4,R0)		;  auth_device_cmd[2] = cr3; auth_device_cmd[3] = cr4;
00C2DA 4229     	SHLR16  	R2			;
00C2DC 4219     	SHLR8   	R2			;
00C2DE E317     	MOV     	#17,R3		;
00C2E0 633C     	EXTU.B   	R3,R3			;
00C2E2 3236     	CMP/HI 	R3,R2			;  if () 
00C2E4 891F     	BT      	L00C326		;    return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C2E6 D34A     	MOV.L   	@(#128,PC),R3	;
00C2E8 E002     	MOV     	#02,R0		;
00C2EA 2300     	MOV.B   	R0,@R3		;  task7_state = 0x02;
00C2EC DB50     	MOV.L   	@(#140,PC),R11	;
00C2EE D045     	MOV.L   	@(#114,PC),R0	;
00C2F0 20B2     	MOV.L   	R11,@R0		;  *(u32*)0x09075384 = 0x07810008;
00C2F2 A00C     	BRA     	L00C30E		;  break;
00C2F4 0009     	NOP     				;
L00C2F6:
00C2F6 D342     	MOV.L   	@(#108,PC),R3	;case 0x0001:
00C2F8 6030     	MOV.B   	@R3,R0		;
00C2FA C802     	TST     	#02,R0		;
00C2FC 8913     	BT      	L00C326		;  if (hw_flags & 0x02 == 0)
00C2FE E101     	MOV     	#01,R1		;    return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C300 D348     	MOV.L   	@(#120,PC),R3	;
00C302 2310     	MOV.B   	R1,@R3		;  *(u8*)0x0907538A = 0x01;
00C304 DB4B     	MOV.L   	@(#12C,PC),R11	;
00C306 D03F     	MOV.L   	@(#0FC,PC),R0	;  *(u32*)0x09075384 = 0x09810002;
00C308 20B2     	MOV.L   	R11,@R0		;  break;
00C30A A000     	BRA     	#0000			;default:
00C30C 0009     	NOP     				;  return make_cd_status_FF(rr1,rr2,rr3,rr4);
L00C30E:							;}
...
00C31A 6B02     	MOV.L   	@R0,R11		;*h = *(u32*)0x09075384;
00C31C D13D     	MOV.L   	@(#0F4,PC),R1	;
00C31E E001     	MOV     	#01,R0		;
00C320 2100     	MOV.B   	R0,@R1		;auth_device_flag = 0x01;
00C322 000B     	RTS     				;
00C324 0009     	NOP     				;
L00C326:
...
;cdb command E1 "Is Device Authenticated"
L00C39A:							;void cmd_is_device_authenticated(u16 cr1,cr2,cr3,cr4,u32 *h,u16 *rr1,*rr2,*rr3,*rr4) {
00C39A D01E     	MOV.L   	@(#078,PC),R0	;
00C39C 6300     	MOV.B   	@R0,R3		;
00C39E 4305     	ROTR    	R3			;if (auth_device_flag)
00C3A0 8926     	BT      	L00C3F0		;  return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C3A2 601C     	EXTU.B   	R1,R0			;
00C3A4 8800     	CMP/EQ  	#00,R0		;
00C3A6 8903     	BT      	L00C3B0		;
00C3A8 8801     	CMP/EQ  	#01,R0		;
00C3AA 8905     	BT      	L00C3B8		;
00C3AC A020     	BRA     	L00C3F0		;
00C3AE 0009     	NOP     				;u16 temp2,temp4;
L00C3B0:							;switch (cr2) {
00C3B0 D41D     	MOV.L   	@(#074,PC),R4	;case 0x0000:
00C3B2 6341     	MOV.W   	@R4,R3		;  temp2 = auth_status_cd; temp4 = 0;
00C3B4 A00D     	BRA     	L00C3D2		;
00C3B6 4328     	SHLL16  	R3			;  break;
L00C3B8:
00C3B8 D319     	MOV.L   	@(#064,PC),R3	;case 0x0001:
00C3BA 6030     	MOV.B   	@R3,R0		;
00C3BC C880     	TST     	#80,R0		;  if (*(u8*)0x0F000892 & 0x80 != 0)
00C3BE 8B17     	BF      	L00C3F0		;    return make_cd_status_FF(rr1,rr2,rr3,rr4);
00C3C0 D416     	MOV.L   	@(#058,PC),R4	;
00C3C2 6041     	MOV.W   	@R4,R0		;
00C3C4 4028     	SHLL16  	R0			;  temp2 = auth_status_mpeg;
00C3C6 D419     	MOV.L   	@(#064,PC),R4	;
00C3C8 6341     	MOV.W   	@R4,R3		;
00C3CA 633D     	EXTU.W   	R3,R3			;  temp4 = auth_status2_mpeg;
00C3CC 203D     	XTRCT   	R3,R0			;  break;
00C3CE A000     	BRA     	#0000			;default:
00C3D0 6303     	MOV     	R0,R3			;  return make_cd_status_FF(rr1,rr2,rr3,rr4);
L00C3D2:							;}
00C3D2 2F36     	MOV.L   	R3,@-R15		;
00C3D4 D007     	MOV.L   	@(#01C,PC),R0	;
00C3D6 4F22     	STS.L   	PR,@-R15		;
00C3D8 400B     	JSR     	@R0			;get_rr1_status(rr1);//L000091A8
00C3DA 0009     	NOP     				;
00C3DC 4F26     	LDS.L   	@R15+,PR		;
00C3DE 63F6     	MOV.L   	@R15+,R3		;
00C3E0 6D3D     	EXTU.W   	R3,R13		;*rr3 = 0x0000;
00C3E2 4C29     	SHLR16  	R12			;*rr4 = temp4;
00C3E4 4C19     	SHLR8   	R12			;
00C3E6 4C18     	SHLL8   	R12			;
00C3E8 23CD     	XTRCT   	R12,R3		;
00C3EA 6C33     	MOV     	R3,R12		;*rr2 = temp2;
00C3EC 000B     	RTS     				;
00C3EE 2BBA     	XOR     	R11,R11		;*h = 0;
L00C3F0:
